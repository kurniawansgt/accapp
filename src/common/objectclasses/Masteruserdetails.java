 ...
 *    -  Masteruserdetails objs = new Masteruserdetails(0); // All Data
 *    or 
 *    - Masteruserdetails obj = new Masteruserdetails(Masteruserdetail.PROPERTY_<field>, <value>);
 *      Sample :
 *      Masteruserdetails obj = new Masteruserdetails(Masteruserdetail.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Masteruserdetails brs = new Masteruserdetails(0);

            for (Iterator<Masteruserdetail> it = brs.iterator(); it.hasNext(); ) {
                
                Masteruserdetail br = (Masteruserdetail) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaMasteruserdetail());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Masteruserdetail br = (Masteruserdetail) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaMasteruserdetail());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Masteruserdetail br = (Masteruserdetail) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaMasteruserdetail());
            }
 ...
 * @author windu
 */
public class Masteruserdetails  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Masteruserdetails";
    public static final String SQLNAME = Masteruserdetail.TABLE;
    public static String DEFAULTSORT = Masteruserdetail.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Masteruserdetail.PROPERTY_ID;
    ...
    List<Object> list;
    private Masteruserdetail parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Masteruserdetail.PRIMARYKEY, Masteruserdetail.PRIMARYKEY, "200"}, 
        {Masteruserdetail.PRIMARYKEY, Masteruserdetail.PRIMARYKEY, "200"} 
    };
    ...
    public Masteruserdetails() throws CodeException {
        this (new Masteruserdetail(NULLID));
        _isLoaded_ = true;
    }
    
    public Masteruserdetails(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Masteruserdetail(ID);
        ID_ = ID;
    }
    
    public Masteruserdetails(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Masteruserdetail(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Masteruserdetails(Masteruserdetail parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Masteruserdetails(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Masteruserdetails(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void recordLoad(ResultSet rs) throws CodeException {
           ...
           try {
               while (rs.next()) {
                   list.add(new Masteruserdetail(rs));
               }
               _isLoaded_ = true;
               _isDirty_ = false;
           }catch (SQLException e) {
    ...
    public void add(Masteruserdetail obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Masteruserdetails obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Masteruserdetail) it.next());
        }        
    ...
    public Masteruserdetail getParent() {
        return parentObj_;
    }
    
    public void setParent(Masteruserdetail obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Masteruserdetail obj = (Masteruserdetail) it.next();
    ...
    public String getDefaultSort() {
        return Masteruserdetails.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Masteruserdetails.SQLNAME;
    }
