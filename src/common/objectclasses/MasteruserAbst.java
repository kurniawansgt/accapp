...
public abstract class MasteruserAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Masteruser";

    public static final String TABLE = "masteruser";
    ...
    public static final String PROPERTY_USERID = "UserId";
     ...
     public static final String PRIMARYKEY = PROPERTY_USER;
    ...
    public MasteruserAbst() throws CodeException {
        loadNew();
    }
    
    public MasteruserAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public MasteruserAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public MasteruserAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public MasteruserAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create MasteruserAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           Password_ = rs.getString(PROPERTY_PASSWORD); 
           Nama_ = rs.getString(PROPERTY_NAMA); 
           ...
           UserId_ = rs.getString(PROPERTY_USERID); 
            ...
            throw new CodeException ("Error Loading MasteruserAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Masteruser obj = (Masteruser)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBeanCommon db = DbBeanCommon.connect();
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Masteruser " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from masteruser ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Masteruser " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    private void saveFields(ResultSet rs) throws CodeException {
        try {
            ...
            rs.updateString(PROPERTY_PASSWORD , Password_ ); 
            rs.updateString(PROPERTY_NAMA , Nama_ ); 
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        Masteruser obj = (Masteruser) jCob;
        id_ = obj.getID();

        
          User_ = obj.getUser();
          Password_ = obj.getPassword();
          Nama_ = obj.getNama();
    ...
    public long getID() throws CodeException {
      ...
      public void setPassword(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         Password_ = param; 
         _isDirty_ = true; 
      } 

      public String getPassword() throws CodeException {
         if (!_isLoaded_) { read();} 
         return Password_; 
      } 

      public void setNama(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         Nama_ = param; 
         _isDirty_ = true; 
      } 

      public String getNama() throws CodeException {
         if (!_isLoaded_) { read();} 
         return Nama_; 
      } 
    ...
    public String toString(String param) throws CodeException {
        if (param.equals(PROPERTY_ID)) { return String.valueOf(id_) ;}
           ...
           else if (param.equals(PROPERTY_PASSWORD)) return getPassword(); 
           else if (param.equals(PROPERTY_NAMA)) return getNama(); 
    ...
    public void fromString(String param, String value) throws CodeException {
        if (param.equals(PROPERTY_ID)) {
           ...
           else if (param.equals(PROPERTY_PASSWORD))  setPassword(value); 
           else if (param.equals(PROPERTY_NAMA))  setNama(value); 
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Masteruser : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            DbBeanCommon db = DbBeanCommon.connect();
            ResultSet rs = db.movePrevious(TABLEPROCESS, PRIMARYKEY, User_+"");
            if (rs.next()) {
                load(rs);
            }
            db.close();
        } catch (SQLException ex) {
             throw new CodeException("Masteruser : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            DbBeanCommon db = DbBeanCommon.connect();
            ResultSet rs = db.moveNext(TABLEPROCESS, PRIMARYKEY, User_+"");
            if (rs.next()) {
                load(rs);
            }
            db.close();
        } catch (SQLException ex) {
             throw new CodeException("Masteruser : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Masteruser : Cannot Move Last " + ex.getMessage());
       }
    }
