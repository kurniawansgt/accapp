 ...
 *    -  Mastergroupdetails objs = new Mastergroupdetails(0); // All Data
 *    or 
 *    - Mastergroupdetails obj = new Mastergroupdetails(Mastergroupdetail.PROPERTY_<field>, <value>);
 *      Sample :
 *      Mastergroupdetails obj = new Mastergroupdetails(Mastergroupdetail.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Mastergroupdetails brs = new Mastergroupdetails(0);

            for (Iterator<Mastergroupdetail> it = brs.iterator(); it.hasNext(); ) {
                
                Mastergroupdetail br = (Mastergroupdetail) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaMastergroupdetail());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Mastergroupdetail br = (Mastergroupdetail) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaMastergroupdetail());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Mastergroupdetail br = (Mastergroupdetail) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaMastergroupdetail());
            }
 ...
 * @author windu
 */
public class Mastergroupdetails  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Mastergroupdetails";
    public static final String SQLNAME = Mastergroupdetail.TABLE;
    public static String DEFAULTSORT = Mastergroupdetail.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Mastergroupdetail.PROPERTY_ID;
    ...
    List<Object> list;
    private Mastergroupdetail parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Mastergroupdetail.PRIMARYKEY, Mastergroupdetail.PRIMARYKEY, "200"}, 
        {Mastergroupdetail.PRIMARYKEY, Mastergroupdetail.PRIMARYKEY, "500"}
    };

    public String getCLASSNAME(){ return CLASSNAME; }
    
    public Mastergroupdetails() throws CodeException {
        this (new Mastergroupdetail(NULLID));
        _isLoaded_ = true;
    }
    
    public Mastergroupdetails(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Mastergroupdetail(ID);
        ID_ = ID;
    }
    
    public Mastergroupdetails(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Mastergroupdetail(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Mastergroupdetails(Mastergroupdetail parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Mastergroupdetails(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Mastergroupdetails(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void recordLoad(ResultSet rs) throws CodeException {
           ...
           try {
               while (rs.next()) {
                   list.add(new Mastergroupdetail(rs));
               }
               _isLoaded_ = true;
               _isDirty_ = false;
           }catch (SQLException e) {
    ...
    public void add(Mastergroupdetail obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Mastergroupdetails obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Mastergroupdetail) it.next());
        }        
    ...
    public Mastergroupdetail getParent() {
        return parentObj_;
    }
    
    public void setParent(Mastergroupdetail obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Mastergroupdetail obj = (Mastergroupdetail) it.next();
    ...
    public String getDefaultSort() {
        return Mastergroupdetails.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Mastergroupdetails.SQLNAME;
    }

    public String[] getSecurityTokens() throws CodeException {
        throw new UnsupportedOperationException("Not supported yet.");
    }
    public void loadData(String user, String company) throws CodeException {
        DbBeanCommon db = DbBeanCommon.connect();

        String sql = " select mgd.id, mgd.KodeGroup, mgd.Module, mgd.Company, "
                      + "\n   sum(mgd.`read`) `read`, "
                      ...
                      + "\n   mgd.TanggalEntry, mgd.TanggalUpdate, mgd.UserID "
                      + "\n from masteruserdetail mud "
                      + "\n       inner join mastergroupdetail mgd "
                      + "\n           on mud.KodeGroup = mgd.KodeGroup "
                      + "\n 		     and mud.User = '" + user + "' "
                      + "\n 		     and mgd.company = '" + company + "' "
                      + "\n group by mgd.Module "
                      + "\n order by mgd.module" ;
