...
public abstract class MastergroupAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Mastergroup";

    public static final String TABLE = "mastergroup";
    ...
    public static final String PROPERTY_USERID = "UserId";
     ...
     public static final String PRIMARYKEY = PROPERTY_KODEGROUP;
    ...
    public MastergroupAbst() throws CodeException {
        loadNew();
    }
    
    public MastergroupAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public MastergroupAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public MastergroupAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public MastergroupAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create MastergroupAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           UserId_ = rs.getString(PROPERTY_USERID); 
            ...
            throw new CodeException ("Error Loading MastergroupAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Mastergroup obj = (Mastergroup)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBeanCommon db = DbBeanCommon.connect();
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Mastergroup " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from mastergroup ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Mastergroup " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        Mastergroup obj = (Mastergroup) jCob;
        id_ = obj.getID();
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Mastergroup : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            DbBeanCommon db = DbBeanCommon.connect();
            ResultSet rs = db.movePrevious(TABLEPROCESS, PRIMARYKEY, KodeGroup_+"");
            if (rs.next()) {
                load(rs);
            }
            db.close();
        } catch (SQLException ex) {
             throw new CodeException("Mastergroup : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            DbBeanCommon db = DbBeanCommon.connect();
            ResultSet rs = db.moveNext(TABLEPROCESS, PRIMARYKEY, KodeGroup_+"");
            if (rs.next()) {
                load(rs);
            }
            db.close();
        } catch (SQLException ex) {
             throw new CodeException("Mastergroup : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Mastergroup : Cannot Move Last " + ex.getMessage());
       }
    }
