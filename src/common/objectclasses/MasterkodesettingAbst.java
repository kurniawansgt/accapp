...
public abstract class MasterkodesettingAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Masterkodesetting";

    public static final String TABLE = "masterkodesetting";
    ...
    public static final String PROPERTY_KODESETTING = "KodeSetting";
    ...
    public MasterkodesettingAbst() throws CodeException {
        loadNew();
    }
    
    public MasterkodesettingAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public MasterkodesettingAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public MasterkodesettingAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public MasterkodesettingAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create MasterkodesettingAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           Owner_ = rs.getString(PROPERTY_OWNER); 
           KodeSetting_ = rs.getString(PROPERTY_KODESETTING); 
           ...
           UserID_ = rs.getString(PROPERTY_USERID); 
            ...
            throw new CodeException ("Error Loading MasterkodesettingAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Masterkodesetting obj = (Masterkodesetting)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBeanCommon db = DbBeanCommon.connect();
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Masterkodesetting " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from masterkodesetting ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Masterkodesetting " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    private void saveFields(ResultSet rs) throws CodeException {
        try {
            ...
            rs.updateString(PROPERTY_OWNER , Owner_ ); 
            rs.updateString(PROPERTY_KODESETTING , KodeSetting_ ); 
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        Masterkodesetting obj = (Masterkodesetting) jCob;
        id_ = obj.getID();

        
          Owner_ = obj.getOwner();
          KodeSetting_ = obj.getKodeSetting();
    ...
    public long getID() throws CodeException {
      ...
      public void setOwner(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         Owner_ = param; 
         _isDirty_ = true; 
      } 

      public String getOwner() throws CodeException {
         if (!_isLoaded_) { read();} 
         return Owner_; 
      } 

      public void setKodeSetting(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         KodeSetting_ = param; 
         _isDirty_ = true; 
      } 

      public String getKodeSetting() throws CodeException {
         if (!_isLoaded_) { read();} 
         return KodeSetting_; 
      } 
    ...
    public String toString(String param) throws CodeException {
        if (param.equals(PROPERTY_ID)) { return String.valueOf(id_) ;}
           ...
           else if (param.equals(PROPERTY_OWNER)) return getOwner(); 
           else if (param.equals(PROPERTY_KODESETTING)) return getKodeSetting(); 
    ...
    public void fromString(String param, String value) throws CodeException {
        if (param.equals(PROPERTY_ID)) {
           ...
           else if (param.equals(PROPERTY_OWNER))  setOwner(value); 
           else if (param.equals(PROPERTY_KODESETTING))  setKodeSetting(value); 
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Masterkodesetting : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Masterkodesetting : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Masterkodesetting : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Masterkodesetting : Cannot Move Last " + ex.getMessage());
       }
    }
