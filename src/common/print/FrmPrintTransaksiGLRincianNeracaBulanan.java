 ...
 * @author  wgata
 */
public class FrmPrintTransaksiGLRincianNeracaBulanan extends javax.swing.JDialog {
    ...
    public FrmPrintTransaksiGLRincianNeracaBulanan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public FrmPrintTransaksiGLRincianNeracaBulanan() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jcmbjdllap = new javax.swing.JComboBox();
        ...
        jlblHeader.setText("GL - Rincian Neraca Bulanan");
        ...
        jbtnCetak.setBounds(150, 210, 70, 20);
        ...
        jbtnSelesai.setBounds(230, 210, 70, 20);
        ...
        jLabel5.setBounds(30, 140, 50, 20);

        jcmbjdllap.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        jcmbjdllap.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Penjualan Barang Jadi", "Beban Pokok Penjualan Barang Jadi", "Beban Marketing & Penjualan PuriI Ayu", "Beban Marketing & Penjualan - Overhead", "Beban Marketing & Penjualan - Comm Operating", "Beban Marketing & Penjualan - Above/Below The Line", "Beban Umum & Adm. Operating 2 (GAO - 2) ", "Beban Umum & Adm. Operating 1 (GAO - 1) ", "Beban Umum & Adm. Holding (GAH) " }));
        jcmbjdllap.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jcmbjdllap.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                jcmbjdllapItemStateChanged(evt);
            }
        });
        jcmbjdllap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jcmbjdllapActionPerformed(evt);
            }
        });
        getContentPane().add(jcmbjdllap);
        jcmbjdllap.setBounds(90, 140, 290, 20);
...
private void jbtnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCetakActionPerformed
    ...
    try{
       ...
       String hsfr="";
        ...
        if(jcmbjdllap.getSelectedIndex()==0 ){
              file = GlobalUtils.getCurrentDir() +"/Reports/TransaksiGLRincianNeracaPBJ.jrxml";
        }else if(jcmbjdllap.getSelectedIndex()==1 ){
              file = GlobalUtils.getCurrentDir() +"/Reports/TransaksiGLRincianNeracaBPPBJ.jrxml";
        }else if(jcmbjdllap.getSelectedIndex()==2){
             file = GlobalUtils.getCurrentDir() +"/Reports/TransaksiGLRincianNeracaMktPA.jrxml";
        }else if(jcmbjdllap.getSelectedIndex()==3){
            file = GlobalUtils.getCurrentDir() +"/Reports/TransaksiGLRincianNeracaMktOH.jrxml";
        }else if(jcmbjdllap.getSelectedIndex()==4){
            file = GlobalUtils.getCurrentDir() +"/Reports/TransaksiGLRincianNeracaCommOpr.jrxml";
        }else if(jcmbjdllap.getSelectedIndex()==5){
            file = GlobalUtils.getCurrentDir() +"/Reports/TransaksiGLRincianNeracaMktATLBTL.jrxml";
        }else if(jcmbjdllap.getSelectedIndex()==6){
            file = GlobalUtils.getCurrentDir() +"/Reports/TransaksiGLRincianNeracaBUAGA02.jrxml";
        }else if(jcmbjdllap.getSelectedIndex()==7){
           file = GlobalUtils.getCurrentDir() +"/Reports/TransaksiGLRincianNeracaBUAGA01.jrxml";
        }else{
           file = GlobalUtils.getCurrentDir() +"/Reports/TransaksiGLRincianNeracaBUAGAH.jrxml";
        }
...
private void jcmbjdllapItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jcmbjdllapItemStateChanged
    // TODO add your handling code here:
}//GEN-LAST:event_jcmbjdllapItemStateChanged

private void jcmbjdllapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcmbjdllapActionPerformed
    // TODO add your handling code here:
}//GEN-LAST:event_jcmbjdllapActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmPrintTransaksiGLRincianNeracaBulanan dialog = new FrmPrintTransaksiGLRincianNeracaBulanan(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JComboBox jcmbjdllap;
