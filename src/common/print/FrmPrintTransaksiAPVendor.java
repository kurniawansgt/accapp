 ...
 * @author  wgata
 */
public class FrmPrintTransaksiAPVendor extends javax.swing.JDialog {
    ...
    public FrmPrintTransaksiAPVendor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public FrmPrintTransaksiAPVendor() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jbtnCetak.setBounds(130, 360, 90, 24);
        ...
        jbtnSelesai.setBounds(240, 360, 90, 24);
        ...
        jLabel8.setBounds(280, 180, 20, 20);
        getContentPane().add(batchdatefr);
        batchdatefr.setBounds(140, 180, 130, 20);
        getContentPane().add(batchdateto);
        batchdateto.setBounds(310, 180, 110, 20);
        ...
        jchkopen.setBounds(60, 20, 150, 20);
        ...
        jchkdelete.setBounds(60, 50, 150, 20);
        ...
        jchkposted.setBounds(210, 20, 150, 20);
        ...
        jchkerror.setBounds(210, 50, 150, 20);

        getContentPane().add(jPanel2);
        jPanel2.setBounds(30, 240, 400, 90);

        jLabel2.setFont(new java.awt.Font("Dialog", 1, 10));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel2.setText("Account Set: ");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(30, 120, 100, 22);

        jtxtaccsetto.setFont(new java.awt.Font("Dialog", 0, 10));
        jtxtaccsetto.setNextFocusableComponent(jcmbCuttOf);
        getContentPane().add(jtxtaccsetto);
        jtxtaccsetto.setBounds(230, 120, 80, 22);
        ...
        jButton1.setBounds(250, 90, 20, 22);
        ...
        jtxtVendCodeTo.setNextFocusableComponent(jtxtaccsetfr);
        getContentPane().add(jtxtVendCodeTo);
        jtxtVendCodeTo.setBounds(310, 90, 90, 22);
        ...
        jButton2.setBounds(400, 90, 20, 22);
        ...
        jcmbBulan.setBounds(140, 210, 50, 22);
        ...
        jtxtyop.setBounds(210, 210, 60, 22);
...
private void jbtnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCetakActionPerformed
    ...
    try{
        ...
        String vendfr=jtxtVendCodeFr.getText();
        String vendto=jtxtVendCodeTo.getText();
        if(jtxtVendCodeFr.getText().isEmpty()){
            vendfr="0";
        }
        if(jtxtVendCodeTo.getText().isEmpty()){
            vendto="ZZZZZZZZZZZZZ";
        }
        parameter.put("vendorfr", vendfr);
        parameter.put("vendorto", vendto);
       ...
       if(jcmbCuttOf.getSelectedIndex()==1){
        ...
        parameter.put("accsetfr", jtxtaccsetfr.getText());
        parameter.put("accsetto", jtxtaccsetto.getText());

        System.out.println(parameter);

      if(jcmbCuttOf.getSelectedIndex()==1){
           file = GlobalUtils.getCurrentDir() +"/Reports/TransaksiAPVendorDocDate.jrxml";
        }else{
            if(jcmbCuttOf.getSelectedIndex()==2){
                   file = GlobalUtils.getCurrentDir() +"/Reports/TransaksiAPVendorYopMop.jrxml";
            }else{
                JOptionPane.showMessageDialog(this, "Anda Belum memilih CUT OFF BY nya. Silahkan pilih CUT OFF BY terlebih dahulu.");
            }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmPrintTransaksiAPVendor dialog = new FrmPrintTransaksiAPVendor(new javax.swing.JFrame(), true);
