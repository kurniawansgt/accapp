 ...
 * @author  wgata
 */
public class FrmPrintTransaksiGLNeracaBulanan extends javax.swing.JDialog {
    ...
    public FrmPrintTransaksiGLNeracaBulanan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public FrmPrintTransaksiGLNeracaBulanan() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("PRINT GL - Neraca Bulanan");
        ...
        jlblHeader.setText("GL - Neraca Bulanan");
        ...
        jbtnCetak.setBounds(120, 160, 70, 20);
        ...
        jbtnSelesai.setBounds(240, 160, 70, 20);
        ...
        jcmbHavingStatusto.setBounds(280, 110, 100, 20);

        java.awt.Dimension screenSize = java.awt.Toolkit.getDefaultToolkit().getScreenSize();
        setBounds((screenSize.width-448)/2, (screenSize.height-246)/2, 448, 246);
...
private void jbtnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCetakActionPerformed
    ...
    try{
        ...
        file = GlobalUtils.getCurrentDir() +"/Reports/TransaksiGLNeracaBulanan.jrxml";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmPrintTransaksiGLNeracaBulanan dialog = new FrmPrintTransaksiGLNeracaBulanan(new javax.swing.JFrame(), true);
