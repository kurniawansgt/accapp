 ...
 * @author  wgata
 */
public class FrmPrintTransaksiARVendorawal extends javax.swing.JDialog {
    ...
    public FrmPrintTransaksiARVendorawal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public FrmPrintTransaksiARVendorawal() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Custommer Code");
...
//                 String mope=(jcmbBulan.getSelectedIndex()+1 <10 ? "0"+(jcmbBulan.getSelectedIndex()+1)+"" : (jcmbBulan.getSelectedIndex()+1) +"");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmPrintTransaksiARVendorawal dialog = new FrmPrintTransaksiARVendorawal(new javax.swing.JFrame(), true);
