 ...
 * @author  wgata
 */
public class FrmPrintMasterARCustommerCode extends javax.swing.JDialog {
    
    

    /** Creates new form FrmPrintMasterBahanBaku */
    public FrmPrintMasterARCustommerCode(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public FrmPrintMasterARCustommerCode() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("PRINT AR - CUSTOMMER MASTER");
        getContentPane().setLayout(null);

        jtxtNoBatchFr.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        jlblHeader.setText("AR - CUSTOMMER MASTER REPORT");
        ...
        jtxtNoBatchTo.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        jLabel3.setText("Custommer Code");
        ...
        jcmbentrytypefr.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        jLabel5.setBounds(30, 140, 110, 20);
        ...
        jtxtyopto.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        jcmbjenislaporan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Address", "Optional" }));
...
//        parameter.put("kodeperusahaan", " ");
        ...
        file = GlobalUtils.getCurrentDir() +"/Reports/MasterARCustommerCode.jrxml";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmPrintMasterARCustommerCode dialog = new FrmPrintMasterARCustommerCode(new javax.swing.JFrame(), true);
