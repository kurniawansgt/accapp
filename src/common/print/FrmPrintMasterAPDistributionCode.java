 ...
 * @author  wgata
 */
public class FrmPrintMasterAPDistributionCode extends javax.swing.JDialog {
    
    

    /** Creates new form FrmPrintMasterBahanBaku */
    public FrmPrintMasterAPDistributionCode(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public FrmPrintMasterAPDistributionCode() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jtxtDistCode.setBounds(150, 90, 130, 19);
...
private void jbtnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCetakActionPerformed
    ...
    try{
        ...
        String file   = GlobalUtils.getCurrentDir() +"/Reports/MasterAPDistributionCode.jrxml";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmPrintMasterAPDistributionCode dialog = new FrmPrintMasterAPDistributionCode(new javax.swing.JFrame(), true);
