 ...
 * @author  wgata
 */
public class FrmPrintMasterAPAccountSet extends javax.swing.JDialog {
    
    

    /** Creates new form FrmPrintMasterBahanBaku */
    public FrmPrintMasterAPAccountSet(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public FrmPrintMasterAPAccountSet() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("PRINT AP - ACCOUNT SET MASTER");
        ...
        jlblHeader.setText("AP - ACCOUNT SET MASTER REPORT");
        getContentPane().add(jlblHeader);
        jlblHeader.setBounds(40, 20, 240, 30);
...
private void jbtnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCetakActionPerformed
    ...
    try{
        ...
        String file   = GlobalUtils.getCurrentDir() +"/Reports/MasterAPAccountSet.jrxml";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmPrintMasterAPAccountSet dialog = new FrmPrintMasterAPAccountSet(new javax.swing.JFrame(), true);
