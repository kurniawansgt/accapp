 ...
 * @author  wgata
 */
public class FrmPrintTransaksiAPBatchListStatus extends javax.swing.JDialog {



    /** Creates new form FrmPrintMasterBahanBaku */
    public FrmPrintTransaksiAPBatchListStatus(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public FrmPrintTransaksiAPBatchListStatus() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("PRINT AP - BATCH STATUS ");
        getContentPane().setLayout(null);

        jtxtNoBatchFr.setFont(new java.awt.Font("Liberation Sans", 1, 10));
        getContentPane().add(jtxtNoBatchFr);
        jtxtNoBatchFr.setBounds(140, 110, 100, 20);

        jlblHeader.setFont(new java.awt.Font("Liberation Sans", 1, 12));
        jlblHeader.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlblHeader.setText("AP - Batch Status Report");
        ...
        jtxtNoBatchTo.setFont(new java.awt.Font("Liberation Sans", 1, 10));
        ...
        jLabel3.setFont(new java.awt.Font("Liberation Sans", 1, 12));
        jLabel3.setText("Date");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(30, 150, 100, 20);

        jcmblistingfor.setFont(new java.awt.Font("Liberation Sans", 1, 10));
        jcmblistingfor.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Invoice Batches", "Payment Batches" }));
        ...
        jLabel4.setFont(new java.awt.Font("Liberation Sans", 1, 12));
        ...
        jchkenter.setFont(new java.awt.Font("Liberation Sans", 1, 12));
        jchkenter.setSelected(true);
        jchkenter.setText("Entered");
        jPanel1.add(jchkenter);
        jchkenter.setBounds(10, 20, 150, 23);

        jchkimport.setFont(new java.awt.Font("Liberation Sans", 1, 12));
        jchkimport.setSelected(true);
        jchkimport.setText("Imported");
        jPanel1.add(jchkimport);
        jchkimport.setBounds(10, 50, 150, 23);

        jchktransfer.setFont(new java.awt.Font("Liberation Sans", 1, 12)); // NOI18N
        jchktransfer.setSelected(true);
        jchktransfer.setText("Generated");
        jPanel1.add(jchktransfer);
        jchktransfer.setBounds(10, 80, 150, 23);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(40, 240, 190, 130);

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Having Status Of"));
        jPanel2.setLayout(null);

        jchkopen.setFont(new java.awt.Font("Liberation Sans", 1, 12)); // NOI18N
        ...
        jchkopen.setBounds(10, 20, 160, 20);

        jchkdelete.setFont(new java.awt.Font("Liberation Sans", 1, 12));
        jchkdelete.setSelected(true);
        jchkdelete.setText("Deleted");
        jPanel2.add(jchkdelete);
        jchkdelete.setBounds(10, 100, 160, 20);

        jchkposted.setFont(new java.awt.Font("Liberation Sans", 1, 12));
        jchkposted.setSelected(true);
        jchkposted.setText("Posted");
        jPanel2.add(jchkposted);
        jchkposted.setBounds(10, 43, 160, 20);

        jchkerror.setFont(new java.awt.Font("Liberation Sans", 1, 12));
        jchkerror.setSelected(true);
        jchkerror.setText("Error");
        jPanel2.add(jchkerror);
        jchkerror.setBounds(10, 70, 160, 23);

        getContentPane().add(jPanel2);
        jPanel2.setBounds(250, 240, 180, 130);

        jchkinclude.setFont(new java.awt.Font("Liberation Sans", 1, 12));
        jchkinclude.setSelected(true);
        jchkinclude.setText("Including Previously Printed Batches");
        getContentPane().add(jchkinclude);
        jchkinclude.setBounds(30, 210, 390, 23);

        jtxtbatchdatefr.setEditable(false);
        jtxtbatchdatefr.setFont(new java.awt.Font("Liberation Sans", 1, 10)); // NOI18N
        getContentPane().add(jtxtbatchdatefr);
        jtxtbatchdatefr.setBounds(140, 150, 120, 20);

        jtxtbatchdateto.setEditable(false);
        jtxtbatchdateto.setFont(new java.awt.Font("Liberation Sans", 1, 10)); // NOI18N
    ...
    try{
       ...
       parameter.put("batchdatetoo",tgl2);
        ...
        if(jcmblistingfor.getSelectedIndex()==0 ){
           file = GlobalUtils.getCurrentDir() +"/Reports/TransaksiAPIBatchListStatusInvoice.jrxml";
        }else {
           file = GlobalUtils.getCurrentDir() +"/Reports/TransaksiAPPBatchListStatusPayment.jrxml";
        }
...
private void jbtnBatchFrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBatchFrActionPerformed
    try {
	    ...
	    FrmBrowse bd = new FrmBrowse(brs);
            ...
            bd.setSecondValue(jtxtbatchdatefr);
            bd.setModal(true);
            bd.setVisible(true);
        }else{
...
try {
	  if(jcmblistingfor.getSelectedIndex()==0){
	    ...
	    FrmBrowse bd = new FrmBrowse(brs);
            ...
            bd.setSecondValue(jtxtbatchdateto);
            bd.setModal(true);
            bd.setVisible(true);
        }else{
             Ap_paybatchlists brs = new Ap_paybatchlists();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmPrintTransaksiAPBatchListStatus dialog = new FrmPrintTransaksiAPBatchListStatus(new javax.swing.JFrame(), true);
