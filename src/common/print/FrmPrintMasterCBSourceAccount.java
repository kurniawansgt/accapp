 ...
 * @author  wgata
 */
public class FrmPrintMasterCBSourceAccount extends javax.swing.JDialog {
    
    

    /** Creates new form FrmPrintMasterBahanBaku */
    public FrmPrintMasterCBSourceAccount(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public FrmPrintMasterCBSourceAccount() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jlblHeader.setText("CB - SOURCE ACCOUNT MASTER");
        getContentPane().add(jlblHeader);
        jlblHeader.setBounds(40, 20, 360, 30);
        ...
        jButton2.setBounds(370, 110, 20, 20);

        jLabel8.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
        jLabel8.setText("To Code");
...
private void jbtnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCetakActionPerformed
    ...
    try{
        ...
        parameter.put("srccodefr", jtxtNoBatchFr.getText());
        parameter.put("srccodeto", jtxtNoBatchTo.getText());
        String file   = "";
        System.out.println(parameter);
        file = GlobalUtils.getCurrentDir() +"/Reports/MasterCBSourceAccount.jrxml";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmPrintMasterCBSourceAccount dialog = new FrmPrintMasterCBSourceAccount(new javax.swing.JFrame(), true);
