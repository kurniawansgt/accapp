 ...
 * @author  wgata
 */
public class FrmPrintMasterARCustommerGroup extends javax.swing.JDialog {
    
    

    /** Creates new form FrmPrintMasterBahanBaku */
    public FrmPrintMasterARCustommerGroup(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public FrmPrintMasterARCustommerGroup() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("PRINT AR - CUSTOMMER GROUP MASTER");
        ...
        jlblHeader.setText("AR - CUSTOMMER GROUP MASTER REPORT");
        ...
        jtxtyopto.setBounds(300, 140, 50, 18);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmPrintMasterARCustommerGroup dialog = new FrmPrintMasterARCustommerGroup(new javax.swing.JFrame(), true);
