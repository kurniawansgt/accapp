 ...
 * @author  wgata
 */
public class FrmPrintMasterAPDistributionSetCodeLap extends javax.swing.JDialog {
    
    

    /** Creates new form FrmPrintMasterBahanBaku */
    public FrmPrintMasterAPDistributionSetCodeLap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public FrmPrintMasterAPDistributionSetCodeLap() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("PRINT AP - DISTRIBUTION SET CODE");
        ...
        jbtnCetak.setBounds(140, 170, 90, 23);
...
private void jbtnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCetakActionPerformed
    ...
    try{
        ...
        parameter.put("status", EntryTypefr);

        String file   = "";
        System.out.println(parameter);
        file = GlobalUtils.getCurrentDir() +"/Reports/MasterAPDistributionSetReport.jrxml";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmPrintMasterAPDistributionSetCodeLap dialog = new FrmPrintMasterAPDistributionSetCodeLap(new javax.swing.JFrame(), true);
