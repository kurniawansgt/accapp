 ...
 * @author  wgata
 */
public class FrmPrintMasterARDistributionCode extends javax.swing.JDialog {
    
    

    /** Creates new form FrmPrintMasterBahanBaku */
    public FrmPrintMasterARDistributionCode(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public FrmPrintMasterARDistributionCode() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("PRINT AR - DISTRIBUTOR MASTER");
        ...
        jtxtDistCode.setBounds(150, 90, 130, 20);

        jcmbModel.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        jcmbModel.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Distribution Code", "Daftar Distribution" }));
        ...
        jLabel2.setText("Distribution Code");
        ...
        jlblHeader.setText("AR - DISTRIBUTOR MASTER REPORT");
...
private void jbtnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCetakActionPerformed
    ...
    try{
        ...
        String file   = GlobalUtils.getCurrentDir() +"/Reports/MasterARDistributionCode.jrxml";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmPrintMasterARDistributionCode dialog = new FrmPrintMasterARDistributionCode(new javax.swing.JFrame(), true);
