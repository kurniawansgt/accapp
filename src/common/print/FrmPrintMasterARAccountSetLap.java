 ...
 * @author  wgata
 */
public class FrmPrintMasterARAccountSetLap extends javax.swing.JDialog {
    
    

    /** Creates new form FrmPrintMasterBahanBaku */
    public FrmPrintMasterARAccountSetLap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public FrmPrintMasterARAccountSetLap() {
        initComponents();
...
private void jbtnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCetakActionPerformed
    ...
    try{
        ...
        parameter.put("accsetcodefr", jtxtNoBatchFr.getText());
        parameter.put("accsetcodeto", jtxtNoBatchTo.getText());
         String EntryTypefr="";
        ...
        file = GlobalUtils.getCurrentDir() +"/Reports/MasterARAccountSetReport.jrxml";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmPrintMasterARAccountSetLap dialog = new FrmPrintMasterARAccountSetLap(new javax.swing.JFrame(), true);
