 ...
 * @author  wgata
 */
public class FrmPrintMasterAPAccountSetLap extends javax.swing.JDialog {
    
    

    /** Creates new form FrmPrintMasterBahanBaku */
    public FrmPrintMasterAPAccountSetLap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public FrmPrintMasterAPAccountSetLap() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jlblHeader.setText("AP - ACCOUNT SET CODE MASTER REPORT");
        getContentPane().add(jlblHeader);
        jlblHeader.setBounds(70, 20, 300, 30);
...
private void jbtnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCetakActionPerformed
    ...
    try{
        ...
        file = GlobalUtils.getCurrentDir() +"/Reports/MasterAPAccountSetReport.jrxml";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmPrintMasterAPAccountSetLap dialog = new FrmPrintMasterAPAccountSetLap(new javax.swing.JFrame(), true);
