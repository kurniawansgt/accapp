 ...
 * @author  wgata
 */
public class FrmPrintMasterARCustommer extends javax.swing.JDialog {
    
    

    /** Creates new form FrmPrintMasterBahanBaku */
    public FrmPrintMasterARCustommer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public FrmPrintMasterARCustommer() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jtxtNoBatchTo.setBounds(300, 80, 100, 18);
        ...
        jcmbjenislaporan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Address", "Form" }));
        ...
        jcmbmopfr.setBounds(300, 140, 37, 20);
...
//        parameter.put("kodeperusahaan", " ");
        ...
        parameter.put("custcodefr", jtxtNoBatchFr.getText());
        parameter.put("custcodeto", jtxtNoBatchTo.getText());
        parameter.put("yon", jtxtyopfr.getText());
        parameter.put("mon", jcmbmopfr.getSelectedIndex() );
        ...
        file = GlobalUtils.getCurrentDir() +"/Reports/MasterARCustommer.jrxml";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmPrintMasterARCustommer dialog = new FrmPrintMasterARCustommer(new javax.swing.JFrame(), true);
