 ...
 *    -  Masterrekanans objs = new Masterrekanans(0); // All Data
 *    or 
 *    - Masterrekanans obj = new Masterrekanans(Masterrekanan.PROPERTY_<field>, <value>);
 *      Sample :
 *      Masterrekanans obj = new Masterrekanans(Masterrekanan.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Masterrekanans brs = new Masterrekanans(0);

            for (Iterator<Masterrekanan> it = brs.iterator(); it.hasNext(); ) {
                
                Masterrekanan br = (Masterrekanan) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaMasterrekanan());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Masterrekanan br = (Masterrekanan) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaMasterrekanan());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Masterrekanan br = (Masterrekanan) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaMasterrekanan());
            }
 ...
 * @author windu
 */
public class Masterrekanans  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Masterrekanans";
    public static final String SQLNAME = Masterrekanan.TABLE;
    public static String DEFAULTSORT = Masterrekanan.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Masterrekanan.PROPERTY_ID;
    ...
    List<Object> list;
    private Masterrekanan parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Masterrekanan.PRIMARYKEY, Masterrekanan.PRIMARYKEY, "200"}, 
        {Masterrekanan.PROPERTY_NAMAREKANAN, Masterrekanan.PROPERTY_NAMAREKANAN, "200"} 
    };
    
    
    public String getCLASSNAME(){ return CLASSNAME; }
    
    public Masterrekanans() throws CodeException {
        this (new Masterrekanan(NULLID));
        _isLoaded_ = true;
    }
    
    public Masterrekanans(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Masterrekanan(ID);
        ID_ = ID;
    }
    
    public Masterrekanans(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Masterrekanan(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Masterrekanans(Masterrekanan parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Masterrekanans(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Masterrekanans(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void add(Masterrekanan obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Masterrekanans obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Masterrekanan) it.next());
        }        
    ...
    public Masterrekanan getParent() {
        return parentObj_;
    }
    
    public void setParent(Masterrekanan obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Masterrekanan obj = (Masterrekanan) it.next();
    ...
    public String getDefaultSort() {
        return Masterrekanans.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Masterrekanans.SQLNAME;
    }
