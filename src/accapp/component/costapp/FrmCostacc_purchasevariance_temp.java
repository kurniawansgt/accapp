 ...
 * Sample : 
 *    
 * import accapp.component.costapp.FrmCostacc_purchasevariance_temp;
 * 
 * .......
 * 
 * 
 * FrmCostacc_purchasevariance_temp frmCostacc_purchasevariance_temp;
 * 
 * .......
 * 
 try {
        if (frmCostacc_purchasevariance_temp == null) {
            frmmCostacc_purchasevariance_temp = new FrmCostacc_purchasevariance_temp(this);
        }
        
        showForm(frmCostacc_purchasevariance_temp);
...
public class FrmCostacc_purchasevariance_temp extends javax.swing.JInternalFrame implements NavigatorFormInt {

    private static int istatus = 0;
    private static int iformtype = 0;
    public static String CLASSNAME="FrmCostacc_purchasevariance_temp";
    
    FrmMainFrame mf ;
    
    
    public Costacc_purchasevariance_temp obj = new Costacc_purchasevariance_temp();
    
   
    /** Creates new form Area */
    public FrmCostacc_purchasevariance_temp() throws CodeException {
        initComponents();
    }
    
    public FrmCostacc_purchasevariance_temp(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jbtnBrowse = new javax.swing.JButton();
         ...
         jlbliscomplated = new javax.swing.JLabel(); 
         jtxtiscomplated = new javax.swing.JTextField(); 
        ...
        setTitle("Costacc_purchasevariance_temp");
        ...
        jHeader.setText(" : : Costacc_purchasevariance_temp");
        ...
        jbtnBrowse.setBounds(350, 100, 30, 20);
         ...
         jlbliscomplated.setText("iscomplated"); 
         getContentPane().add(jlbliscomplated); 
         jlbliscomplated.setBounds(70, 260, 140, 15); 
         jtxtiscomplated.setText("jtxtiscomplated"); 
         getContentPane().add(jtxtiscomplated); 
         jtxtiscomplated.setBounds(260, 260, 80, 19); 
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
      try {
	      Costacc_purchasevariance_temps brs = new Costacc_purchasevariance_temps();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new FrmCostacc_purchasevariance_temp().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    private javax.swing.JButton jbtnBrowse;
      ...
      private javax.swing.JLabel jlbliscomplated;  
      private javax.swing.JTextField jtxtiscomplated; 
    ...
    public void searchData() throws CodeException {
        obj = new Costacc_purchasevariance_temp(this.jtxtid.getText());
        showData();
        mf.setIcon(CLASSNAME);

    }
    public void newData() throws CodeException {
        obj = new Costacc_purchasevariance_temp();
        istatus=1;
        showData();
        setToolBar(iformtype,istatus);
    }
    ...
    public void showData() throws CodeException {
        setCursor(GlobalUtils.HOURGLASSCURSOR);
             ...
             jtxtid.setText(obj.toString(Costacc_purchasevariance_temp.PROPERTY_ID));
             jtxtyop.setText(obj.toString(Costacc_purchasevariance_temp.PROPERTY_YOP));
             jtxtmop.setText(obj.toString(Costacc_purchasevariance_temp.PROPERTY_MOP));
             jtxtcost_detail_id.setText(obj.toString(Costacc_purchasevariance_temp.PROPERTY_COST_DETAIL_ID));
             jtxtcost_detail.setText(obj.toString(Costacc_purchasevariance_temp.PROPERTY_COST_DETAIL));
             jtxtstandard.setText(obj.toString(Costacc_purchasevariance_temp.PROPERTY_STANDARD));
             jtxtactual.setText(obj.toString(Costacc_purchasevariance_temp.PROPERTY_ACTUAL));
             jtxtvariance.setText(obj.toString(Costacc_purchasevariance_temp.PROPERTY_VARIANCE));
             jtxtpercenttostd.setText(obj.toString(Costacc_purchasevariance_temp.PROPERTY_PERCENTTOSTD));
             jtxtiscomplated.setText(obj.toString(Costacc_purchasevariance_temp.PROPERTY_ISCOMPLATED));
             if (obj.getcreatedate() != null) {
                kdatecreatedate.setDate(obj.getcreatedate());  
             } 
             jtxtcreateuser.setText(obj.toString(Costacc_purchasevariance_temp.PROPERTY_CREATEUSER));
             if (obj.getauditdate() != null) {
                kdateauditdate.setDate(obj.getauditdate());  
             } 
             jtxtaudituser.setText(obj.toString(Costacc_purchasevariance_temp.PROPERTY_AUDITUSER));
    ...
    public void setData() throws CodeException {
          ...
          obj.fromString(Costacc_purchasevariance_temp.PROPERTY_ID, jtxtid.getText()) ;
          obj.fromString(Costacc_purchasevariance_temp.PROPERTY_YOP, jtxtyop.getText()) ;
          obj.fromString(Costacc_purchasevariance_temp.PROPERTY_MOP, jtxtmop.getText()) ;
          obj.fromString(Costacc_purchasevariance_temp.PROPERTY_COST_DETAIL_ID, jtxtcost_detail_id.getText()) ;
          obj.fromString(Costacc_purchasevariance_temp.PROPERTY_COST_DETAIL, jtxtcost_detail.getText()) ;
          obj.fromString(Costacc_purchasevariance_temp.PROPERTY_STANDARD, jtxtstandard.getText()) ;
          obj.fromString(Costacc_purchasevariance_temp.PROPERTY_ACTUAL, jtxtactual.getText()) ;
          obj.fromString(Costacc_purchasevariance_temp.PROPERTY_VARIANCE, jtxtvariance.getText()) ;
          obj.fromString(Costacc_purchasevariance_temp.PROPERTY_PERCENTTOSTD, jtxtpercenttostd.getText()) ;
          obj.fromString(Costacc_purchasevariance_temp.PROPERTY_ISCOMPLATED, jtxtiscomplated.getText()) ;
          obj.fromString(Costacc_purchasevariance_temp.PROPERTY_CREATEDATE, kdatecreatedate.getDate()); 
          obj.fromString(Costacc_purchasevariance_temp.PROPERTY_CREATEUSER, jtxtcreateuser.getText()) ;
          obj.fromString(Costacc_purchasevariance_temp.PROPERTY_AUDITDATE, kdateauditdate.getDate()); 
          obj.fromString(Costacc_purchasevariance_temp.PROPERTY_AUDITUSER, jtxtaudituser.getText()) ;
