 ...
 * Sample : 
 *    
 * import accapp.component.costapp.FrmCostacc_glwip_temp;
 * 
 * .......
 * 
 * 
 * FrmCostacc_glwip_temp frmCostacc_glwip_temp;
 * 
 * .......
 * 
 try {
        if (frmCostacc_glwip_temp == null) {
            frmmCostacc_glwip_temp = new FrmCostacc_glwip_temp(this);
        }
        
        showForm(frmCostacc_glwip_temp);
...
public class FrmCostacc_glwip_temp extends javax.swing.JInternalFrame implements NavigatorFormInt {

    private static int istatus = 0;
    private static int iformtype = 0;
    public static String CLASSNAME="FrmCostacc_glwip_temp";
    
    FrmMainFrame mf ;
    
    
    public Costacc_glwip_temp obj = new Costacc_glwip_temp();
    
   
    /** Creates new form Area */
    public FrmCostacc_glwip_temp() throws CodeException {
        initComponents();
    }
    
    public FrmCostacc_glwip_temp(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jHeader.setText(" : : Costacc_glwip_temp");
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
      try {
	      Costacc_glwip_temps brs = new Costacc_glwip_temps();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new FrmCostacc_glwip_temp().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    public void searchData() throws CodeException {
        obj = new Costacc_glwip_temp(this.jtxtid.getText());
        showData();
        mf.setIcon(CLASSNAME);

    }
    public void newData() throws CodeException {
        obj = new Costacc_glwip_temp();
        istatus=1;
        showData();
        setToolBar(iformtype,istatus);
    }
    ...
    public void showData() throws CodeException {
        setCursor(GlobalUtils.HOURGLASSCURSOR);
             ...
             jtxtid.setText(obj.toString(Costacc_glwip_temp.PROPERTY_ID));
             jtxtyop.setText(obj.toString(Costacc_glwip_temp.PROPERTY_YOP));
             jtxtmop.setText(obj.toString(Costacc_glwip_temp.PROPERTY_MOP));
             jtxtcost_detail_id.setText(obj.toString(Costacc_glwip_temp.PROPERTY_COST_DETAIL_ID));
             jtxtcost_detail.setText(obj.toString(Costacc_glwip_temp.PROPERTY_COST_DETAIL));
             jtxtstandard.setText(obj.toString(Costacc_glwip_temp.PROPERTY_STANDARD));
             jtxtactual.setText(obj.toString(Costacc_glwip_temp.PROPERTY_ACTUAL));
             jtxtvariance.setText(obj.toString(Costacc_glwip_temp.PROPERTY_VARIANCE));
             jtxtpercenttostd.setText(obj.toString(Costacc_glwip_temp.PROPERTY_PERCENTTOSTD));
             jtxtiscompleted.setText(obj.toString(Costacc_glwip_temp.PROPERTY_ISCOMPLETED));
             if (obj.getcreatedate() != null) {
                kdatecreatedate.setDate(obj.getcreatedate());  
             } 
             jtxtcreateuser.setText(obj.toString(Costacc_glwip_temp.PROPERTY_CREATEUSER));
             if (obj.getauditdate() != null) {
                kdateauditdate.setDate(obj.getauditdate());  
             } 
             jtxtaudituser.setText(obj.toString(Costacc_glwip_temp.PROPERTY_AUDITUSER));
    ...
    public void setData() throws CodeException {
          ...
          obj.fromString(Costacc_glwip_temp.PROPERTY_ID, jtxtid.getText()) ;
          obj.fromString(Costacc_glwip_temp.PROPERTY_YOP, jtxtyop.getText()) ;
          obj.fromString(Costacc_glwip_temp.PROPERTY_MOP, jtxtmop.getText()) ;
          obj.fromString(Costacc_glwip_temp.PROPERTY_COST_DETAIL_ID, jtxtcost_detail_id.getText()) ;
          obj.fromString(Costacc_glwip_temp.PROPERTY_COST_DETAIL, jtxtcost_detail.getText()) ;
          obj.fromString(Costacc_glwip_temp.PROPERTY_STANDARD, jtxtstandard.getText()) ;
          obj.fromString(Costacc_glwip_temp.PROPERTY_ACTUAL, jtxtactual.getText()) ;
          obj.fromString(Costacc_glwip_temp.PROPERTY_VARIANCE, jtxtvariance.getText()) ;
          obj.fromString(Costacc_glwip_temp.PROPERTY_PERCENTTOSTD, jtxtpercenttostd.getText()) ;
          obj.fromString(Costacc_glwip_temp.PROPERTY_ISCOMPLETED, jtxtiscompleted.getText()) ;
          obj.fromString(Costacc_glwip_temp.PROPERTY_CREATEDATE, kdatecreatedate.getDate()); 
          obj.fromString(Costacc_glwip_temp.PROPERTY_CREATEUSER, jtxtcreateuser.getText()) ;
          obj.fromString(Costacc_glwip_temp.PROPERTY_AUDITDATE, kdateauditdate.getDate()); 
          obj.fromString(Costacc_glwip_temp.PROPERTY_AUDITUSER, jtxtaudituser.getText()) ;
