 ...
 * @author wgata
 */
public class FrmAR_PostInvoiceBatches extends javax.swing.JInternalFrame implements NavigatorFormInt {
    FrmMainFrame mf ;
    ...
    public FrmAR_PostInvoiceBatches (FrmMainFrame mf) {
        this.mf = mf;
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("A/R Post Invoice  Batches");
        ...
        jLabel3.setText("To");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(220, 90, 50, 14);
        ...
        jPanel1.setBounds(50, 70, 530, 130);

        jHeader.setBackground(new java.awt.Color(102, 102, 102));
        jHeader.setFont(new java.awt.Font("Dialog", 1, 10));
        jHeader.setForeground(new java.awt.Color(255, 255, 255));
        jHeader.setText(" : : A/P Post Invoice  Batches");
    ...
    public void execute() throws CodeException {
        Ar_invbatchlist apbatchlist=new Ar_invbatchlist();

        int frombatchno=0;
        int tobatchno=0;

        if (jRadioButton1.isSelected()){
            if(apbatchlist.checkARInvoicePosting()) {
                apbatchlist.runARInvoicePosting(frombatchno,tobatchno);
