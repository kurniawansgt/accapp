 ...
 * @author wgata
 */
public class FrmAR_PostAdjustmentBatches extends javax.swing.JInternalFrame implements NavigatorFormInt {
    FrmMainFrame mf ;
    ...
    public FrmAR_PostAdjustmentBatches (FrmMainFrame mf) {
        this.mf = mf;
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("A/R Post Adjustment  Batches");
        ...
        jHeader.setText(" : : A/R Post Adjustment  Batches");
    ...
    public void execute() throws CodeException {
        Ar_adjbatchlist apbatchlist=new Ar_adjbatchlist();

        int frombatchno=0;
        int tobatchno=0;

        if (jRadioButton1.isSelected()){
            if(apbatchlist.checkARAdjustmentPosting()) {
                apbatchlist.runARAdjustmentPosting(frombatchno,tobatchno);
