 ...
 * @author  windu
 */
public class FrmAr_invpopaddress extends javax.swing.JDialog {
    ...
    Ar_invh oar_invh=null;
    
    /** Creates new form frmBrowse */
    public FrmAr_invpopaddress() {
        initComponents();
        this.setLocationRelativeTo(null);
    }

    public FrmAr_invpopaddress(Ar_invh oar_invh) throws CodeException{
        initComponents();
        this.setLocationRelativeTo(null);
    ...
    public FrmAr_invpopaddress(JInternalFrame jf,Object obj) throws CodeException {
    ...
    public FrmAr_invpopaddress(Object obj) throws CodeException {
        initComponents();
        this.setLocationRelativeTo(null);
        nbd = (NavigatorBrowseDataInt) obj;
        setFieldInCombo();
    ...
    public FrmAr_invpopaddress(JInternalFrame jf, Object obj, String filterfield) throws CodeException {
        this.nfi = (NavigatorFormInt)jf;
        initComponents();
        this.setLocationRelativeTo(null);
        nbd = (NavigatorBrowseDataInt) obj;
    ...
    public FrmAr_invpopaddress(Object obj, String filterfield) {
        initComponents();
        this.setLocationRelativeTo(null);
        nbd = (NavigatorBrowseDataInt) obj;
        setFieldInCombo();
    ...
    public FrmAr_invpopaddress(JTable jtable, Object obj, int row, int col) {
        initComponents();
        this.setLocationRelativeTo(null);
        nbd = (NavigatorBrowseDataInt) obj;
        setFieldInCombo();
     ...
     public FrmAr_invpopaddress(TableModel tmodel, Object obj, int row, int col) {
        initComponents();
        this.setLocationRelativeTo(null);
        nbd = (NavigatorBrowseDataInt) obj;
        setFieldInCombo();
...
private void jbtnSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnSelectActionPerformed
        try {
            ...
            Logger.getLogger(FrmAr_invpopaddress.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAr_invpopaddress().setVisible(true);
            }
        });
    }
