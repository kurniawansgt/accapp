 ...
 * 
 * 
 * FrmOp_addrtype frmOp_addrtype;
 * 
 * .......
 * 
 try {
        if (frmOp_addrtype == null) {
            frmmOp_addrtype = new FrmOp_addrtype(this);
        }
        
        showForm(frmOp_addrtype);
...
public class FrmOp_addrtype extends javax.swing.JInternalFrame implements NavigatorFormInt {

    private static int istatus = 0;
    private static int iformtype = 0;
    public static String CLASSNAME="FrmOp_addrtype";
    
    FrmMainFrame mf ;
    
    
    public Op_addrtype obj = new Op_addrtype();
    
   
    /** Creates new form Area */
    public FrmOp_addrtype() throws CodeException {
        initComponents();
    }
    
    public FrmOp_addrtype(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Optional: Address Type");
        ...
        jtxtdscription.setBounds(260, 120, 440, 20);
        ...
        jtxtentrydate.setBounds(240, 30, 120, 19);
        ...
        jtxtauditdate.setBounds(370, 30, 110, 19);
        ...
        jtxtaudituser.setBounds(490, 30, 130, 19);
        ...
        jtxtcmpnyid.setBounds(630, 30, 150, 19);
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
      try {
	      Op_addrtypes brs = new Op_addrtypes();
	      FrmBrowse bd = new FrmBrowse(this, brs);
	      bd.setFirstValue(jtxtaddrtypecode);
	      bd.setModal(true);
	      bd.setVisible(true);            
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new FrmOp_addrtype().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    public void searchData() throws CodeException {
        obj = new Op_addrtype(this.jtxtaddrtypecode.getText());
        showData();
        mf.setIcon(CLASSNAME);
    ...
    public void showData() throws CodeException {
        setCursor(GlobalUtils.HOURGLASSCURSOR);
             ...
             jtxtid.setText(obj.toString(Op_addrtype.PROPERTY_ID));
             jtxtaddrtypecode.setText(obj.toString(Op_addrtype.PROPERTY_ADDRTYPECODE));
             jtxtdscription.setText(obj.toString(Op_addrtype.PROPERTY_DSCRIPTION));
             jtxtentrydate.setText(obj.toString(Op_addrtype.PROPERTY_ENTRYDATE));
             jtxtauditdate.setText(obj.toString(Op_addrtype.PROPERTY_AUDITDATE));
             jtxtaudituser.setText(obj.toString(Op_addrtype.PROPERTY_AUDITUSER));
             jtxtcmpnyid.setText(obj.toString(Op_addrtype.PROPERTY_CMPNYID));
    ...
    public void setData() throws CodeException {
          ...
          obj.fromString(Op_addrtype.PROPERTY_ID, jtxtid.getText()) ;
          obj.fromString(Op_addrtype.PROPERTY_ADDRTYPECODE, jtxtaddrtypecode.getText()) ;
          obj.fromString(Op_addrtype.PROPERTY_DSCRIPTION, jtxtdscription.getText()) ;
          obj.fromString(Op_addrtype.PROPERTY_ENTRYDATE, jtxtentrydate.getText()) ;
          obj.fromString(Op_addrtype.PROPERTY_AUDITDATE, jtxtauditdate.getText()) ;
          obj.fromString(Op_addrtype.PROPERTY_AUDITUSER, jtxtaudituser.getText()) ;
          obj.fromString(Op_addrtype.PROPERTY_CMPNYID, jtxtcmpnyid.getText()) ;
