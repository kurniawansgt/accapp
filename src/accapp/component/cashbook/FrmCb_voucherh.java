...
public class FrmCb_voucherh extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    Cb_voucher cbhh = new Cb_voucher();
    ...
    public FrmCb_voucherh() throws CodeException {
        initComponents();
    }
    
    public FrmCb_voucherh(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    ...
    private void initComponents() {
        ...
        jtxtdocstatus = new javax.swing.JTextField();
        ...
        jopt_doctype_P = new javax.swing.JRadioButton();
        jopt_doctype_R = new javax.swing.JRadioButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("C/B Payment Voucher");
        ...
        jtxtReference.setBounds(140, 100, 100, 20);
        ...
        jlblMisc.setFont(new java.awt.Font("Dialog", 1, 10));
        jlblMisc.setText("Misc. Code");
        getContentPane().add(jlblMisc);
        jlblMisc.setBounds(20, 120, 100, 13);

        jtxtmisccode.setFont(new java.awt.Font("Dialog", 0, 10));
        ...
        getContentPane().add(jtxtmisccode);
        jtxtmisccode.setBounds(140, 120, 100, 23);

        jLabel7.setFont(new java.awt.Font("Dialog", 1, 10));
        jLabel7.setText("Description");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(20, 160, 100, 13);
        ...
        jtxtdscription.setBounds(140, 160, 520, 23);

        jTab.setTabPlacement(javax.swing.JTabbedPane.BOTTOM);
        jTab.setFont(new java.awt.Font("Dialog", 0, 10));
        ...
        jlblTotalEntry.setFont(new java.awt.Font("Dialog", 1, 10));
        ...
        jPanel7.add(jLabel8);
        jLabel8.setBounds(10, 10, 70, 13);

        jtxtApplied.setEditable(false);
        jtxtApplied.setFont(new java.awt.Font("Dialog", 0, 10));
        ...
        jtxtSearchInvoice.setFont(new java.awt.Font("Dialog", 0, 10));
        jPanel8.add(jtxtSearchInvoice);
        jtxtSearchInvoice.setBounds(100, 10, 220, 25);

        jbtnSearch.setFont(new java.awt.Font("Dialog", 1, 10));
        ...
        jbtnSearch.setBounds(10, 10, 80, 25);

        jPanel3.add(jPanel8);
        jPanel8.setBounds(580, 200, 320, 40);

        jtblDetailAllocate.setFont(new java.awt.Font("Dialog", 0, 10));
        ...
        jtxtstartpono.setFont(new java.awt.Font("Dialog", 0, 10));
        ...
        jtxtstartpono.setBounds(340, 10, 193, 23);
        ...
        jLabel17.setBounds(10, 10, 60, 13);
        ...
        jcmbDocType.setBounds(80, 10, 130, 23);

        jbtnShowInvoice.setFont(new java.awt.Font("Dialog", 1, 10));
        ...
        jbtnShowInvoice.setBounds(570, 10, 120, 25);
        ...
        jlblcustcheqno.setFont(new java.awt.Font("Dialog", 1, 10));
        jlblcustcheqno.setText("Cust Cheque");
        getContentPane().add(jlblcustcheqno);
        ...
        getContentPane().add(jbtnBrowseMiscode);
        jbtnBrowseMiscode.setBounds(240, 120, 30, 20);

        jtxtmiscdscription.setEditable(false);
        jtxtmiscdscription.setFont(new java.awt.Font("Dialog", 0, 10));
        jtxtmiscdscription.setText("Misc. Name");
        getContentPane().add(jtxtmiscdscription);
        jtxtmiscdscription.setBounds(280, 120, 380, 23);

        jtxtcustcheqno.setFont(new java.awt.Font("Dialog", 0, 10));
        ...
        jtxtdistcode.setBounds(140, 180, 100, 23);
        ...
        getContentPane().add(jbtnBrowsedistcode);
        jbtnBrowsedistcode.setBounds(240, 180, 30, 17);

        jtxtdistdesc.setEditable(false);
        jtxtdistdesc.setFont(new java.awt.Font("Dialog", 0, 10));
        jtxtdistdesc.setText("Distribution Name");
        getContentPane().add(jtxtdistdesc);
        jtxtdistdesc.setBounds(280, 180, 260, 23);

        jbtnDistributed.setFont(new java.awt.Font("Dialog", 0, 10));
        ...
        jtxtType.setBounds(330, 140, 80, 23);

        jLabel15.setFont(new java.awt.Font("Dialog", 1, 10));
        jLabel15.setText("Type");
        getContentPane().add(jLabel15);
        jLabel15.setBounds(280, 140, 40, 13);
        ...
        jtxtRate.setBounds(550, 140, 70, 23);
        ...
        getContentPane().add(jbtnBrowserate);
        ...
        jtxtEntryno.setFont(new java.awt.Font("Dialog", 0, 10));
        jtxtEntryno.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        getContentPane().add(jtxtEntryno);
        jtxtEntryno.setBounds(140, 60, 50, 23);
        ...
        getContentPane().add(jcbMOP);
        jcbMOP.setBounds(560, 60, 50, 20);
        ...
        jlbldebittot.setBounds(10, 70, 50, 13);
        ...
        jlblcredittot.setBounds(10, 100, 50, 13);
        ...
        jlblentrycnt.setText("Status");
        jPanel6.add(jlblentrycnt);
        jlblentrycnt.setBounds(10, 30, 40, 13);

        jtxtdocstatus.setEditable(false);
        jtxtdocstatus.setFont(new java.awt.Font("Dialog", 0, 10));
        jtxtdocstatus.setText("docstatus");
        jPanel6.add(jtxtdocstatus);
        jtxtdocstatus.setBounds(60, 30, 70, 23);

        getContentPane().add(jPanel6);
        jPanel6.setBounds(680, 60, 240, 140);
        ...
        kdateentrydate.setBounds(260, 60, 100, 20);
        ...
        getContentPane().add(jcbYOP);
        jcbYOP.setBounds(430, 60, 70, 20);
        ...
        jbtnBrowseBank.setBounds(240, 80, 30, 17);

        jtxtbankcurnccode.setEditable(false);
        jtxtbankcurnccode.setFont(new java.awt.Font("Dialog", 0, 10));
        jtxtbankcurnccode.setText("curnccode");
        getContentPane().add(jtxtbankcurnccode);
        jtxtbankcurnccode.setBounds(280, 80, 40, 23);
        ...
        jtxtbankcode.setBounds(140, 80, 90, 23);

        jlblbankcode.setFont(new java.awt.Font("Dialog", 1, 10));
        jlblbankcode.setText("Bank Code");
        getContentPane().add(jlblbankcode);
        jlblbankcode.setBounds(20, 80, 70, 20);

        jHeader.setBackground(new java.awt.Color(102, 102, 102));
        jHeader.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
        jHeader.setForeground(new java.awt.Color(255, 255, 255));
        jHeader.setText(" : : C/B Payment Voucher");
        jHeader.setAlignmentY(0.0F);
        jHeader.setOpaque(true);
        getContentPane().add(jHeader);
        jHeader.setBounds(20, 30, 160, 20);

        buttonGroup1.add(jopt_doctype_P);
        jopt_doctype_P.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
        jopt_doctype_P.setText("Payment Voucher");
        getContentPane().add(jopt_doctype_P);
        jopt_doctype_P.setBounds(500, 100, 140, 20);

        buttonGroup1.add(jopt_doctype_R);
        jopt_doctype_R.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
        jopt_doctype_R.setSelected(true);
        jopt_doctype_R.setText("Receive");
        getContentPane().add(jopt_doctype_R);
        jopt_doctype_R.setBounds(420, 100, 80, 20);
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        try {
            ...
            Logger.getLogger(FrmCb_voucherh.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//F                    jtxtdocstatus.setText(cbhh.getdocstatus()+"");
...
private void jbtnBrowseEntryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowseEntryActionPerformed
    try {
        ...
        FrmBrowseCb_voucherAll bd = new FrmBrowseCb_voucherAll(this,brs);
...
private void caltotal() throws CodeException{
    ...
    jtxtdebittot.setText(GlobalUtils.formatnumber(cbhh.getTotalDebit()));

    jtxtcredittot.setText(GlobalUtils.formatnumber( cbhh.getTotalCredit()));
    ...
    try{
        if (row>-1){
            if (cbhh.getCbhds().size()>0){
                cekCbhdAllocate((Cb_voucherd) cbhh.getCbhds().list().get(0));
            }
            posttable = row;
...
private void jtblDetailMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtblDetailMouseClicked
    ...
    if (row==0 ){
        if ( !jtxtdocstatus.getText().equals("O")&&jcmbentrytypeH.getSelectedIndex()>0 && jtblDetail.getValueAt(row, 1) != null) {
            jTab.setEnabledAt(1, true);
        }else{
            jTab.setEnabledAt(1, false);
...
public void showdatainvoice(Cb_invoblcbhsd invcbsd) throws CodeException  {
        ...
        Integer irow=jtblDetail.getSelectedRow();
        if (irow>-1){
            cekCbhdAllocate((Cb_voucherd) cbhh.getCbhds().list().get(irow));
        }
...
private void cekCbhd() throws CodeException {
    ...
    Cb_voucherd cbhd;
    if (row > cbhds.size() - 1) {
        cbhd = new Cb_voucherd();
        cbhds.add(cbhd);
    }else{
        cbhd = (Cb_voucherd) cbhds.list().get(row);
    }
...
private void cekCbhdAllocate(Cb_voucherd cbhd) throws CodeException {

    int row = jtblDetailAllocate.getSelectedRow();
    int col = jtblDetailAllocate.getSelectedColumn();


    Cb_vouchersds cbhsds=cbhd.getCbhds();
    Cb_vouchersd cbhsd;

    if (row > cbhsds.size() - 1) {
        cbhsd = new Cb_vouchersd();
        cbhsds.add(cbhsd);
    }else{
        cbhsd = (Cb_vouchersd) cbhsds.list().get(row);
    }
...
private void formInternalFrameActivated(javax.swing.event.InternalFrameEvent evt) {                                            
    ...
    lockedData(!jtxtdocstatus.getText().equals("C"));
    ...
    private javax.swing.JRadioButton jopt_doctype_P;
    private javax.swing.JRadioButton jopt_doctype_R;
    ...
    private javax.swing.JTextField jtxtdocstatus;
    ...
    public void moveFirst() throws CodeException {
        ...
        showData();
        mf.setIcon(CLASSNAME);
        lockedData(!jtxtdocstatus.getText().equals("P"));
    }
    ...
    public void searchData() throws CodeException {
        cbhh = new Cb_voucher(Cb_voucher.PROPERTY_ENTRYNO,this.jtxtEntryno.getText());
        showData();
        mf.setIcon(CLASSNAME);
        lockedData(!jtxtdocstatus.getText().equals("P"));
    ...
    public void saveData() throws CodeException {
        if (GlobalUtils.toDbl(jtxtUnApplied.getText())>0){
            ...
            if (cbb.getID()>0){
                ...
                cbhh=new Cb_voucher(cbhh.getID());


                showData();


                jtxtid.setText(cbhh.toString(Cb_voucher.PROPERTY_ID));
                ...
                for(int i = 0; i < jtblDetail.getRowCount(); i++) {
                    ...
                    try {
                        Cb_voucherd cbhd = (Cb_voucherd) cbhh.getCbhds().list().get(i);
    ...
    public void showData() throws CodeException {
        setCursor(GlobalUtils.HOURGLASSCURSOR);
             ...
             jtxtdocstatus.setText(cbhh.toString(Cb_voucher.PROPERTY_DOCSTATUS));
             jtxtentrydate.setText(cbhh.toString(Cb_voucher.PROPERTY_ENTRYDATE));
             jtxtauditdate.setText(cbhh.toString(Cb_voucher.PROPERTY_AUDITDATE));
             jtxtaudituser.setText(cbhh.toString(Cb_voucher.PROPERTY_AUDITUSER));
             jtxtcmpnyid.setText(cbhh.toString(Cb_voucher.PROPERTY_CMPNYID));

             jtxtdebittot.setText(GlobalUtils.formatnumber(cbhh.getTotalDebit()));
             jtxtcredittot.setText(GlobalUtils.formatnumber(cbhh.getTotalCredit()));

            jtxtbankcode.setText(cbhh.getbankcode());
            Cb_bank cbbank=new Cb_bank(jtxtbankcode.getText());
            jtxtbankcurnccode.setText(cbbank.getcurnccode());
            ...
            if (cbhh.getdoctype().equalsIgnoreCase("P")){
                jopt_doctype_P.setSelected(true);
            } else {
                jopt_doctype_R.setSelected(true);
            }
    ...
    public void printData() throws CodeException {
        ...
        NavigatorObjectInt noi = (NavigatorObjectInt) cbhh;
    ...
    public void importCsv() throws CodeException {
        ...
        String file1 = "";
        String file2 = GlobalUtils.getCurrentDir() + GlobalUtils.temp + cbhh.TABLEPROCESS + ".csv";
    ...
    public void exportCsv() throws CodeException {
        ...
        if (cbhh.exportCsv()) {
            ...
            String file1 = GlobalUtils.getCurrentDir() + GlobalUtils.temp + cbhh.TABLEPROCESS + ".csv";
            String file2 = "";
    ...
    public void importText() throws CodeException {
        String file1 = "";
        String file2 = GlobalUtils.getCurrentDir() + GlobalUtils.temp + cbhh.TABLEPROCESS + ".txt";
    ...
    public void exportText() throws CodeException {
        if (cbhh.exportText()) {
            ...
            String file1 = GlobalUtils.getCurrentDir() + GlobalUtils.temp + cbhh.TABLEPROCESS + ".txt";
            String file2 = "";
    ...
    private void changeLabel() {
        ...
        if (jcmbentrytypeH.getSelectedIndex() == 0 ) {
            ...
            jopt_doctype_P.setEnabled(true);
            jopt_doctype_R.setEnabled(true);
            jopt_doctype_R.setSelected(true);
            ...
            jopt_doctype_P.setEnabled(true);
            jopt_doctype_R.setEnabled(false);
            jopt_doctype_P.setSelected(true);
            ...
            jopt_doctype_P.setEnabled(false);
            jopt_doctype_R.setEnabled(true);
            jopt_doctype_R.setSelected(true);
    ...
    public void setData() throws CodeException {
        ...
        cbhh.fromString(Cb_voucher.PROPERTY_BATCHDATE, GlobalUtils.formatDate(kdateentrydate.getDate(),"yyyy-MM-dd"));
        cbhh.fromString(Cb_voucher.PROPERTY_CURNCCODE, jtxtbankcurnccode.getText());
        cbhh.fromString(Cb_voucher.PROPERTY_SRCECURNCCODE, jtxtcurnccode.getText());
        cbhh.fromString(Cb_voucher.PROPERTY_ENTRYNO, jtxtEntryno.getText());
        cbhh.fromString(Cb_voucher.PROPERTY_ENTRYDATE, kdateentrydate.getDate());
        cbhh.fromString(Cb_voucher.PROPERTY_MISCCODE, jtxtmisccode.getText()) ;
        cbhh.fromString(Cb_voucher.PROPERTY_DSCRIPTION, jtxtdscription.getText()) ;
        cbhh.fromString(Cb_voucher.PROPERTY_REFERENCE, jtxtReference.getText()) ;
        cbhh.fromString(Cb_voucher.PROPERTY_CUSTCHEQNO, jtxtcustcheqno.getText());
        cbhh.fromString(Cb_voucher.PROPERTY_DISTCODE, jtxtdistcode.getText());

        cbhh.fromString(Cb_voucher.PROPERTY_RATETYPE, jtxtType.getText());
        cbhh.fromString(Cb_voucher.PROPERTY_RATEAMOUNT, jtxtRate.getText());

        cbhh.fromString(Cb_voucher.PROPERTY_MOP, jcbMOP.getSelectedItem().toString()) ;
        cbhh.fromString(Cb_voucher.PROPERTY_YOP, jcbYOP.getSelectedItem().toString()) ;


        cbhh.fromString(Cb_voucher.PROPERTY_BANKCODE, jtxtbankcode.getText());
        if (jopt_doctype_R.isSelected()){
            cbhh.setdoctype("R");
        } else {
            cbhh.setdoctype("P");
        }
    ...
    public void showDataCbhd() throws CodeException  {
        ...
        if (cbhds.size()>0){
            ...
            showDataCbhsd((Cb_voucherd) cbhds.list().get(0));


        } else {
            Cb_voucherd cbbatchd=new Cb_voucherd();
    ...
    public void showDataCbhsd(Cb_voucherd cbhd) throws CodeException  {
        ...
        for(Object  o : cbhsds.list()){
            Cb_vouchersd cbhsd = (Cb_vouchersd) o;
            tmodeldetailalloacte.addRow(datadetail);
