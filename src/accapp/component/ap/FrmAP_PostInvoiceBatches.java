 ...
 * @author wgata
 */
public class FrmAP_PostInvoiceBatches extends javax.swing.JInternalFrame implements NavigatorFormInt {
    FrmMainFrame mf ;
    ...
    public FrmAP_PostInvoiceBatches (FrmMainFrame mf) {
        this.mf = mf;
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("A/P Post Invoice  Batches");
    ...
    public void execute() throws CodeException {
        Ap_invbatchlist apbatchlist=new Ap_invbatchlist();

        int frombatchno=0;
        int tobatchno=0;

        if (jRadioButton1.isSelected()){
            if(apbatchlist.checkAPInvoicePosting()) {
                apbatchlist.runAPInvoicePosting(frombatchno,tobatchno);
