 ...
 * @author  windu
 */
public class FrmAp_paypopsearchdata extends javax.swing.JDialog {
    private String mode="Select";
    private String startpono = "";
    private String type = "";
    private String sortby = "";

    Ap_payh oAp_payh=null;
    
    /** Creates new form frmBrowse */
    public FrmAp_paypopsearchdata(Ap_payh obj) {
        this.oAp_payh=obj;
        initComponents();
...
private void jbtnSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnSelectActionPerformed
        try {
            ...
            Logger.getLogger(FrmAp_paypopsearchdata.class.getName()).log(Level.SEVERE, null, ex);
        }
