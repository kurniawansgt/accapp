...
import accapp.objectclasses.ap.adjustment.Ap_adjhs;
...
public class FrmAp_adjh extends javax.swing.JInternalFrame implements NavigatorFormInt {

    private static int istatus = 0;
    private static int iformtype = 0;
    public static String CLASSNAME="Frmapadjustmentbatchlist";
    ...
    public Ap_adjbatchlists obj = new Ap_adjbatchlists();

    
   
    /** Creates new form Area */
    public FrmAp_adjh() throws CodeException {
        initComponents();
    }
    
    public FrmAp_adjh(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("AP Adjustment Batch List");
        ...
        jHeader.setText(" : : AP Adjustment Batch List");
...
private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try {
            ...
            Logger.getLogger(FrmAp_adjh.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    if (irow>-1){
        if (jtblDetail.getValueAt(irow, 7).toString().equalsIgnoreCase("Posted")||jtblDetail.getValueAt(irow, 7).toString().equalsIgnoreCase("Deleted")){
            ...
            jtblDetail.setValueAt(true, irow, 5);
                ...
                try {
                    Ap_adjbatchlist apinvb = (Ap_adjbatchlist) obj.list().get(irow);
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    ...
    if (row>-1){
        try {
            this.mf.showAP_AdjustEntry((Ap_adjbatchlist) obj.list().get(row),0);
        } catch (CodeException ex) {
            Logger.getLogger(FrmAp_adjh.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
    ...
    try {
        this.mf.showAP_AdjustEntry((Ap_adjbatchlist) obj.list().get(0),1);
    } catch (CodeException ex) {
        Logger.getLogger(FrmAp_adjh.class.getName()).log(Level.SEVERE, null, ex);
    }
...
private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
    ...
    if (row>-1){
        try {
            Ap_adjbatchlist arinvb=(Ap_adjbatchlist) obj.list().get(row);
    ...
    if (row>-1){
        try {
            if (Boolean.parseBoolean(jtblDetail.getValueAt(row, 5).toString())){
                Ap_adjbatchlist apadjbat=(Ap_adjbatchlist) obj.list().get(row);
...
private Boolean deletedata(Ap_adjbatchlist arinvb,int row){
    int idelete;
        try {
...
private Boolean postingdata(Ap_adjbatchlist apadjb,int row){
    int idelete;
        try {
            idelete = JOptionPane.showConfirmDialog(null, "Do you want to Post entry# " + apadjb.getbatchno(), "Delete", JOptionPane.YES_NO_OPTION);
            if (idelete == JOptionPane.YES_OPTION) {
                if (apadjb.runAPAdjustmentPosting(apadjb.getbatchno(),apadjb.getbatchno())){
                    return true;
                }
            }
        } catch (CodeException ex) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new FrmAp_adjh().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    public void showData() throws CodeException {
        try {
            ...
            for (Object o:obj.list()){
                Ap_adjbatchlist apadjbat=(Ap_adjbatchlist) o;
                ...
                if (GlobalUtils.churuf(apadjbat.getreadytpost()).equalsIgnoreCase("1")){
                    readytopost=true;
                }
