 ...
 * @author wgata
 */
public class FrmAP_PostAdjustmentBatches extends javax.swing.JInternalFrame implements NavigatorFormInt {
    FrmMainFrame mf ;
    ...
    public FrmAP_PostAdjustmentBatches (FrmMainFrame mf) {
        this.mf = mf;
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("A/P Post Adjustment  Batches");
        ...
        jPanel1.setBounds(70, 80, 530, 130);

        jHeader.setBackground(new java.awt.Color(102, 102, 102));
        jHeader.setFont(new java.awt.Font("Dialog", 1, 10));
        jHeader.setForeground(new java.awt.Color(255, 255, 255));
        jHeader.setText(" : : A/P Post Adjustment  Batches");
        jHeader.setAlignmentY(0.0F);
        jHeader.setOpaque(true);
        getContentPane().add(jHeader);
        jHeader.setBounds(30, 30, 230, 20);
    ...
    public void execute() throws CodeException {
        Ap_adjbatchlist apbatchlist=new Ap_adjbatchlist();

        int frombatchno=0;
        int tobatchno=0;

        if (jRadioButton1.isSelected()){
            if(apbatchlist.checkAPAdjustmentPosting()) {
                apbatchlist.runAPAdjustmentPosting(frombatchno,tobatchno);
