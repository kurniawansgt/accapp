 ...
 * @author wgata
 */
public class FrmAP_PostPaymentBatches extends javax.swing.JInternalFrame implements NavigatorFormInt {
    FrmMainFrame mf ;
    ...
    public FrmAP_PostPaymentBatches (FrmMainFrame mf) {
        this.mf = mf;
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("A/P Post Payment  Batches");
        ...
        jtxtstartbatchno.setFont(new java.awt.Font("Dialog", 0, 10));
        ...
        jtxttobatchno.setFont(new java.awt.Font("Dialog", 0, 10));
        ...
        jHeader.setText(" : : A/P Post Payment  Batches");
    ...
    public void execute() throws CodeException {
        Ap_paybatchlist apbatchlist=new Ap_paybatchlist();

        int frombatchno=0;
        int tobatchno=0;

        if (jRadioButton1.isSelected()){
            if(apbatchlist.checkAPPaymentPosting(frombatchno,tobatchno)) {
                apbatchlist.runAPPaymentPosting(frombatchno,tobatchno);
