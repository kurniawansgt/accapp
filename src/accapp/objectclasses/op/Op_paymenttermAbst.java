...
public abstract class Op_paymenttermAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Op_paymentterm";

    public static final String TABLE = "op_paymentterm";
    ...
    public static final String PROPERTY_CMPNYID = "cmpnyid";
     ...
     public static final String PRIMARYKEY = PROPERTY_TERMCODE;
    
    
    private long id_;
    private String termcode_;
    private String dscription_;
    private long duedays_;
    ...
    public Op_paymenttermAbst() throws CodeException {
        loadNew();
    }
    
    public Op_paymenttermAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Op_paymenttermAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Op_paymenttermAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Op_paymenttermAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Op_paymenttermAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           duedays_ = rs.getLong(PROPERTY_DUEDAYS); 
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Op_paymenttermAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Op_paymentterm obj = (Op_paymentterm)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Op_paymentterm " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from op_paymentterm ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Op_paymentterm " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    private void saveFields(ResultSet rs) throws CodeException {
        try {
            ...
            rs.updateLong(PROPERTY_DUEDAYS , duedays_ ); 
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        Op_paymentterm obj = (Op_paymentterm) jCob;
        id_ = obj.getID();
    ...
    public long getID() throws CodeException {
      ...
      public void setduedays(long param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         duedays_ = param; 
         _isDirty_ = true; 
      } 

      public long getduedays() throws CodeException {
         if (!_isLoaded_) { read();} 
         return duedays_; 
      } 
    ...
    public String toString(String param) throws CodeException {
        if (param.equals(PROPERTY_ID)) { return String.valueOf(id_) ;}
           ...
           else if (param.equals(PROPERTY_DUEDAYS)) return String.valueOf(getduedays()); 
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Op_paymentterm : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            DbBean db = DbBean.connect();
            ResultSet rs = db.movePrevious(TABLEPROCESS, PRIMARYKEY, termcode_+"");
            if (rs.next()) {
                load(rs);
            }
            db.close();
        } catch (SQLException ex) {
             throw new CodeException("Op_paymentterm : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            DbBean db = DbBean.connect();
            ResultSet rs = db.moveNext(TABLEPROCESS, PRIMARYKEY, termcode_+"");
            if (rs.next()) {
                load(rs);
            }
            db.close();
        } catch (SQLException ex) {
             throw new CodeException("Op_paymentterm : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Op_paymentterm : Cannot Move Last " + ex.getMessage());
       }
    }
