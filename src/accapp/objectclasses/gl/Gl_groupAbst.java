...
public abstract class Gl_groupAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Gl_group";

    public static final String TABLE = "gl_group";
    ...
    public static final String PROPERTY_ACCGRPDESC = "accgrpdesc";
    ...
    public static final String PROPERTY_CMPNYID = "cmpnyid";
     ...
     public static final String PRIMARYKEY = PROPERTY_ACCGRPCODE;
    
    
    private long id_;
    private String accgrpcode_;
    private String accgrpdesc_;
    ...
    public Gl_groupAbst() throws CodeException {
        loadNew();
    }
    
    public Gl_groupAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Gl_groupAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Gl_groupAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Gl_groupAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Gl_groupAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           accgrpdesc_ = rs.getString(PROPERTY_ACCGRPDESC); 
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Gl_groupAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Gl_group obj = (Gl_group)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Gl_group " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void checkNotNullFields() throws CodeException {
        Object o;
         ...
         o = getaccgrpcode(); 
        if (o == null) { 
            throw new CodeException ("Error Saving Application : accgrpcode can not be Empty"); 
        } 
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from gl_group ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Gl_group " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    private void saveFields(ResultSet rs) throws CodeException {
        try {
            ...
            rs.updateString(PROPERTY_ACCGRPDESC , accgrpdesc_ ); 
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        Gl_group obj = (Gl_group) jCob;
        id_ = obj.getID();

        
          accgrpcode_ = obj.getaccgrpcode();
          accgrpdesc_ = obj.getaccgrpdesc();
    ...
    public long getID() throws CodeException {
      ...
      public void setaccgrpdesc(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         accgrpdesc_ = param; 
         _isDirty_ = true; 
      } 

      public String getaccgrpdesc() throws CodeException {
         if (!_isLoaded_) { read();} 
         return accgrpdesc_; 
      } 
    ...
    public String toString(String param) throws CodeException {
        if (param.equals(PROPERTY_ID)) { return String.valueOf(id_) ;}
           ...
           else if (param.equals(PROPERTY_ACCGRPDESC)) return getaccgrpdesc(); 
    ...
    public void fromString(String param, String value) throws CodeException {
        if (param.equals(PROPERTY_ID)) {
           ...
           else if (param.equals(PROPERTY_ACCGRPDESC))  setaccgrpdesc(value); 
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Gl_group : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            DbBean db = DbBean.connect();
            ResultSet rs = db.movePrevious(TABLEPROCESS, PRIMARYKEY, accgrpcode_+"");
            if (rs.next()) {
                load(rs);
            }
            db.close();
        } catch (SQLException ex) {
             throw new CodeException("Gl_group : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            DbBean db = DbBean.connect();
            ResultSet rs = db.moveNext(TABLEPROCESS, PRIMARYKEY, accgrpcode_+"");
            if (rs.next()) {
                load(rs);
            }
            db.close();
        } catch (SQLException ex) {
             throw new CodeException("Gl_group : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Gl_group : Cannot Move Last " + ex.getMessage());
       }
    }
