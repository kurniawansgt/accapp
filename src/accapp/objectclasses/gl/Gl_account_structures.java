 ...
 *    -  Gl_account_structures objs = new Gl_account_structures(0); // All Data
 *    or 
 *    - Gl_account_structures obj = new Gl_account_structures(Gl_account_structure.PROPERTY_<field>, <value>);
 *      Sample :
 *      Gl_account_structures obj = new Gl_account_structures(Gl_account_structure.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Gl_account_structures brs = new Gl_account_structures(0);

            for (Iterator<Gl_account_structure> it = brs.iterator(); it.hasNext(); ) {
                
                Gl_account_structure br = (Gl_account_structure) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_account_structure());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Gl_account_structure br = (Gl_account_structure) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_account_structure());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Gl_account_structure br = (Gl_account_structure) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_account_structure());
            }
 ...
 * @author windu
 */
public class Gl_account_structures  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Gl_account_structures";
    public static final String SQLNAME = Gl_account_structure.TABLE;
    public static String DEFAULTSORT = Gl_account_structure.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Gl_account_structure.PROPERTY_ID;
    ...
    List<Object> list;
    private Gl_account_structure parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Gl_account_structure.PRIMARYKEY, Gl_account_structure.PRIMARYKEY, "200"}, 
        {Gl_account_structure.PRIMARYKEY, Gl_account_structure.PRIMARYKEY, "200"} 
    };
    ...
    public Gl_account_structures() throws CodeException {
        this (new Gl_account_structure(NULLID));
        _isLoaded_ = true;
    }
    
    public Gl_account_structures(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_account_structure(ID);
        ID_ = ID;
    }
    
    public Gl_account_structures(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_account_structure(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Gl_account_structures(Gl_account_structure parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Gl_account_structures(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Gl_account_structures(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void recordLoad(ResultSet rs) throws CodeException {
           ...
           try {
               while (rs.next()) {
                   list.add(new Gl_account_structure(rs));
               }
               _isLoaded_ = true;
               _isDirty_ = false;
           }catch (SQLException e) {
    ...
    public void add(Gl_account_structure obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Gl_account_structures obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Gl_account_structure) it.next());
        }        
    ...
    public Gl_account_structure getParent() {
        return parentObj_;
    }
    
    public void setParent(Gl_account_structure obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Gl_account_structure obj = (Gl_account_structure) it.next();
    ...
    public String getDefaultSort() {
        return Gl_account_structures.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Gl_account_structures.SQLNAME;
    }
