 ...
 *    -  Gl_ratetypes objs = new Gl_ratetypes(0); // All Data
 *    or 
 *    - Gl_ratetypes obj = new Gl_ratetypes(Gl_ratetype.PROPERTY_<field>, <value>);
 *      Sample :
 *      Gl_ratetypes obj = new Gl_ratetypes(Gl_ratetype.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Gl_ratetypes brs = new Gl_ratetypes(0);

            for (Iterator<Gl_ratetype> it = brs.iterator(); it.hasNext(); ) {
                
                Gl_ratetype br = (Gl_ratetype) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_ratetype());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Gl_ratetype br = (Gl_ratetype) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_ratetype());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Gl_ratetype br = (Gl_ratetype) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_ratetype());
            }
 ...
 * @author windu
 */
public class Gl_ratetypes  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Gl_ratetypes";
    public static final String SQLNAME = Gl_ratetype.TABLE;
    public static String DEFAULTSORT = Gl_ratetype.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Gl_ratetype.PROPERTY_ID;
    ...
    List<Object> list;
    private Gl_ratetype parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Gl_ratetype.PROPERTY_RATETYPE, Gl_ratetype.PROPERTY_RATETYPE, "200"},
        {Gl_ratetype.PROPERTY_DSCRIPTION, Gl_ratetype.PROPERTY_DSCRIPTION, "200"}
    };
    
    
    public String getCLASSNAME(){ return CLASSNAME; }
    
    public Gl_ratetypes() throws CodeException {
        this (new Gl_ratetype(NULLID));
        _isLoaded_ = true;
    }
    
    public Gl_ratetypes(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_ratetype(ID);
        ID_ = ID;
    }
    
    public Gl_ratetypes(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_ratetype(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Gl_ratetypes(Gl_ratetype parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Gl_ratetypes(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Gl_ratetypes(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void add(Gl_ratetype obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Gl_ratetypes obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Gl_ratetype) it.next());
        }        
    ...
    public Gl_ratetype getParent() {
        return parentObj_;
    }
    
    public void setParent(Gl_ratetype obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
                Gl_ratetype obj = (Gl_ratetype) it.next();
    ...
    public String getDefaultSort() {
        return Gl_ratetypes.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Gl_ratetypes.SQLNAME;
    }
