 ...
 *    -  Gl_import_data_msgs objs = new Gl_import_data_msgs(0); // All Data
 *    or 
 *    - Gl_import_data_msgs obj = new Gl_import_data_msgs(Gl_import_data_msg.PROPERTY_<field>, <value>);
 *      Sample :
 *      Gl_import_data_msgs obj = new Gl_import_data_msgs(Gl_import_data_msg.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Gl_import_data_msgs brs = new Gl_import_data_msgs(0);

            for (Iterator<Gl_import_data_msg> it = brs.iterator(); it.hasNext(); ) {
                
                Gl_import_data_msg br = (Gl_import_data_msg) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_import_data_msg());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Gl_import_data_msg br = (Gl_import_data_msg) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_import_data_msg());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Gl_import_data_msg br = (Gl_import_data_msg) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_import_data_msg());
            }
 ...
 * @author windu
 */
public class Gl_import_data_msgs  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Gl_import_data_msgs";
    public static final String SQLNAME = Gl_import_data_msg.TABLE;
    public static String DEFAULTSORT = Gl_import_data_msg.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Gl_import_data_msg.PROPERTY_ID;
    ...
    List<Object> list;
    private Gl_import_data_msg parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Gl_import_data_msg.PRIMARYKEY, Gl_import_data_msg.PRIMARYKEY, "200"}, 
        {Gl_import_data_msg.PRIMARYKEY, Gl_import_data_msg.PRIMARYKEY, "200"} 
    };
    ...
    public Gl_import_data_msgs() throws CodeException {
        this (new Gl_import_data_msg(NULLID));
        _isLoaded_ = true;
    }
    
    public Gl_import_data_msgs(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_import_data_msg(ID);
        ID_ = ID;
    }
    
    public Gl_import_data_msgs(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_import_data_msg(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Gl_import_data_msgs(Gl_import_data_msg parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Gl_import_data_msgs(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Gl_import_data_msgs(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void recordLoad(ResultSet rs) throws CodeException {
           ...
           try {
               while (rs.next()) {
                   list.add(new Gl_import_data_msg(rs));
               }
               _isLoaded_ = true;
               _isDirty_ = false;
           }catch (SQLException e) {
    ...
    public void add(Gl_import_data_msg obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Gl_import_data_msgs obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Gl_import_data_msg) it.next());
        }        
    ...
    public Gl_import_data_msg getParent() {
        return parentObj_;
    }
    
    public void setParent(Gl_import_data_msg obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Gl_import_data_msg obj = (Gl_import_data_msg) it.next();
    ...
    public String getDefaultSort() {
        return Gl_import_data_msgs.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Gl_import_data_msgs.SQLNAME;
    }
    ...
    public void searchData() throws CodeException {
        ...
        String query = " select * from gl_import_data_msg where importsts=0 and "
