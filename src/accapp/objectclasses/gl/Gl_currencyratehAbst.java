...
public abstract class Gl_currencyratehAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Gl_currencyrateh";

    public static final String TABLE = "gl_currencyrateh";
    ...
    public static final String PROPERTY_RATESRCE = "ratesrce";
    ...
    public Gl_currencyratehAbst() throws CodeException {
        loadNew();
    }
    
    public Gl_currencyratehAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Gl_currencyratehAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Gl_currencyratehAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Gl_currencyratehAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Gl_currencyratehAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           ratesrce_ = rs.getString(PROPERTY_RATESRCE); 
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Gl_currencyratehAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Gl_currencyrateh obj = (Gl_currencyrateh)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Gl_currencyrateh " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from gl_currencyrateh ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Gl_currencyrateh " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    private void saveFields(ResultSet rs) throws CodeException {
        try {
            ...
            rs.updateString(PROPERTY_RATESRCE , ratesrce_ ); 
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        Gl_currencyrateh obj = (Gl_currencyrateh) jCob;
        id_ = obj.getID();
    ...
    public long getID() throws CodeException {
      ...
      public void setratesrce(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         ratesrce_ = param; 
         _isDirty_ = true; 
      } 

      public String getratesrce() throws CodeException {
         if (!_isLoaded_) { read();} 
         return ratesrce_; 
      } 
    ...
    public String toString(String param) throws CodeException {
        if (param.equals(PROPERTY_ID)) { return String.valueOf(id_) ;}
           ...
           else if (param.equals(PROPERTY_RATESRCE)) return getratesrce(); 
    ...
    public void fromString(String param, String value) throws CodeException {
        if (param.equals(PROPERTY_ID)) {
           ...
           else if (param.equals(PROPERTY_RATESRCE))  setratesrce(value); 
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Gl_currencyrateh : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Gl_currencyrateh : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Gl_currencyrateh : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Gl_currencyrateh : Cannot Move Last " + ex.getMessage());
       }
    }
