...
public abstract class Gl_sourcelgr_descAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Gl_sourcelgr_desc";

    public static final String TABLE = "gl_sourcelgr_desc";
    ...
    public static final String PROPERTY_SRCELGRDESC = "srcelgrdesc";
    ...
    public Gl_sourcelgr_descAbst() throws CodeException {
        loadNew();
    }
    
    public Gl_sourcelgr_descAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Gl_sourcelgr_descAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Gl_sourcelgr_descAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Gl_sourcelgr_descAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Gl_sourcelgr_descAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           srcelgrdesc_ = rs.getString(PROPERTY_SRCELGRDESC); 
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Gl_sourcelgr_descAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Gl_sourcelgr_desc obj = (Gl_sourcelgr_desc)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Gl_sourcelgr_desc " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from gl_sourcelgr_desc ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Gl_sourcelgr_desc " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    private void saveFields(ResultSet rs) throws CodeException {
        try {
            ...
            rs.updateString(PROPERTY_SRCELGRDESC , srcelgrdesc_ ); 
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        Gl_sourcelgr_desc obj = (Gl_sourcelgr_desc) jCob;
        id_ = obj.getID();

        
          srcelgrcode_ = obj.getsrcelgrcode();
          srcelgrdesc_ = obj.getsrcelgrdesc();
    ...
    public long getID() throws CodeException {
      ...
      public void setsrcelgrdesc(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         srcelgrdesc_ = param; 
         _isDirty_ = true; 
      } 

      public String getsrcelgrdesc() throws CodeException {
         if (!_isLoaded_) { read();} 
         return srcelgrdesc_; 
      } 
    ...
    public String toString(String param) throws CodeException {
        if (param.equals(PROPERTY_ID)) { return String.valueOf(id_) ;}
           ...
           else if (param.equals(PROPERTY_SRCELGRDESC)) return getsrcelgrdesc(); 
    ...
    public void fromString(String param, String value) throws CodeException {
        if (param.equals(PROPERTY_ID)) {
           ...
           else if (param.equals(PROPERTY_SRCELGRDESC))  setsrcelgrdesc(value); 
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Gl_sourcelgr_desc : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Gl_sourcelgr_desc : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Gl_sourcelgr_desc : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Gl_sourcelgr_desc : Cannot Move Last " + ex.getMessage());
       }
    }
