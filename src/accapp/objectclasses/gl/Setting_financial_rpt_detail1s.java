 ...
 *    -  Setting_financial_rpt_detail1s objs = new Setting_financial_rpt_detail1s(0); // All Data
 *    or 
 *    - Setting_financial_rpt_detail1s obj = new Setting_financial_rpt_detail1s(Setting_financial_rpt_detail1.PROPERTY_<field>, <value>);
 *      Sample :
 *      Setting_financial_rpt_detail1s obj = new Setting_financial_rpt_detail1s(Setting_financial_rpt_detail1.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Setting_financial_rpt_detail1s brs = new Setting_financial_rpt_detail1s(0);

            for (Iterator<Setting_financial_rpt_detail1> it = brs.iterator(); it.hasNext(); ) {
                
                Setting_financial_rpt_detail1 br = (Setting_financial_rpt_detail1) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaSetting_financial_rpt_detail1());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Setting_financial_rpt_detail1 br = (Setting_financial_rpt_detail1) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaSetting_financial_rpt_detail1());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Setting_financial_rpt_detail1 br = (Setting_financial_rpt_detail1) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaSetting_financial_rpt_detail1());
            }
 ...
 * @author windu
 */
public class Setting_financial_rpt_detail1s  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Setting_financial_rpt_detail1s";
    public static final String SQLNAME = Setting_financial_rpt_detail1.TABLE;
    public static String DEFAULTSORT = Setting_financial_rpt_detail1.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Setting_financial_rpt_detail1.PROPERTY_ID;
    ...
    List<Object> list;
    private Setting_financial_rpt_detail1 parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Setting_financial_rpt_detail1.PRIMARYKEY, Setting_financial_rpt_detail1.PRIMARYKEY, "200"}, 
        {Setting_financial_rpt_detail1.PRIMARYKEY, Setting_financial_rpt_detail1.PRIMARYKEY, "200"} 
    };
    ...
    public Setting_financial_rpt_detail1s() throws CodeException {
        this (new Setting_financial_rpt_detail1(NULLID));
        _isLoaded_ = true;
    }
    
    public Setting_financial_rpt_detail1s(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Setting_financial_rpt_detail1(ID);
        ID_ = ID;
    }
    
    public Setting_financial_rpt_detail1s(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Setting_financial_rpt_detail1(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Setting_financial_rpt_detail1s(Setting_financial_rpt_detail1 parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Setting_financial_rpt_detail1s(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Setting_financial_rpt_detail1s(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void recordLoad(ResultSet rs) throws CodeException {
           ...
           try {
               while (rs.next()) {
                   list.add(new Setting_financial_rpt_detail1(rs));
               }
               _isLoaded_ = true;
               _isDirty_ = false;
           }catch (SQLException e) {
    ...
    public void add(Setting_financial_rpt_detail1 obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Setting_financial_rpt_detail1s obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Setting_financial_rpt_detail1) it.next());
        }        
    ...
    public Setting_financial_rpt_detail1 getParent() {
        return parentObj_;
    }
    
    public void setParent(Setting_financial_rpt_detail1 obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Setting_financial_rpt_detail1 obj = (Setting_financial_rpt_detail1) it.next();
    ...
    public String getDefaultSort() {
        return Setting_financial_rpt_detail1s.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Setting_financial_rpt_detail1s.SQLNAME;
    }

    public void loadby_rownumber(long docentry) throws CodeException {
        ResultSet rs = null;
        DbBean db = DbBean.connect();

        String query = " select * from setting_financial_rpt_detail1 where docentry="+docentry+" order by rowno";
