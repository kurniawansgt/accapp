 ...
 *    -  Gl_segmentcodes objs = new Gl_segmentcodes(0); // All Data
 *    or 
 *    - Gl_segmentcodes obj = new Gl_segmentcodes(Gl_segmentcode.PROPERTY_<field>, <value>);
 *      Sample :
 *      Gl_segmentcodes obj = new Gl_segmentcodes(Gl_segmentcode.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Gl_segmentcodes brs = new Gl_segmentcodes(0);

            for (Iterator<Gl_segmentcode> it = brs.iterator(); it.hasNext(); ) {
                
                Gl_segmentcode br = (Gl_segmentcode) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_segmentcode());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Gl_segmentcode br = (Gl_segmentcode) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_segmentcode());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Gl_segmentcode br = (Gl_segmentcode) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_segmentcode());
            }
 ...
 * @author windu
 */
public class Gl_segmentcodes  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Gl_segmentcodes";
    public static final String SQLNAME = Gl_segmentcode.TABLE;
    public static String DEFAULTSORT = Gl_segmentcode.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Gl_segmentcode.PROPERTY_ID;
    ...
    List<Object> list;
    private Gl_segmentcode parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Gl_segmentcode.PRIMARYKEY, Gl_segmentcode.PRIMARYKEY, "200"}, 
        {Gl_segmentcode.PRIMARYKEY, Gl_segmentcode.PRIMARYKEY, "200"} 
    };
    ...
    public Gl_segmentcodes() throws CodeException {
        this (new Gl_segmentcode(NULLID));
        _isLoaded_ = true;
    }
    
    public Gl_segmentcodes(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_segmentcode(ID);
        ID_ = ID;
    }
    
    public Gl_segmentcodes(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_segmentcode(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Gl_segmentcodes(Gl_segmentcode parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Gl_segmentcodes(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Gl_segmentcodes(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void recordLoad(ResultSet rs) throws CodeException {
           ...
           try {
               while (rs.next()) {
                   list.add(new Gl_segmentcode(rs));
               }
               _isLoaded_ = true;
               _isDirty_ = false;
           }catch (SQLException e) {
    ...
    public void add(Gl_segmentcode obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Gl_segmentcodes obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Gl_segmentcode) it.next());
        }        
    ...
    public Gl_segmentcode getParent() {
        return parentObj_;
    }
    
    public void setParent(Gl_segmentcode obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Gl_segmentcode obj = (Gl_segmentcode) it.next();
    ...
    public String getDefaultSort() {
        return Gl_segmentcodes.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Gl_segmentcodes.SQLNAME;
    }
