 ...
 *    -  Gl_optiondetail1s objs = new Gl_optiondetail1s(0); // All Data
 *    or 
 *    - Gl_optiondetail1s obj = new Gl_optiondetail1s(Gl_optiondetail1.PROPERTY_<field>, <value>);
 *      Sample :
 *      Gl_optiondetail1s obj = new Gl_optiondetail1s(Gl_optiondetail1.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Gl_optiondetail1s brs = new Gl_optiondetail1s(0);

            for (Iterator<Gl_optiondetail1> it = brs.iterator(); it.hasNext(); ) {
                
                Gl_optiondetail1 br = (Gl_optiondetail1) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_optiondetail1());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Gl_optiondetail1 br = (Gl_optiondetail1) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_optiondetail1());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Gl_optiondetail1 br = (Gl_optiondetail1) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_optiondetail1());
            }
 ...
 * @author windu
 */
public class Gl_optiondetail1s  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Gl_optiondetail1s";
    public static final String SQLNAME = Gl_optiondetail1.TABLE;
    public static String DEFAULTSORT = Gl_optiondetail1.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Gl_optiondetail1.PROPERTY_ID;
    ...
    List<Object> list;
    private Gl_optiondetail1 parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Gl_optiondetail1.PRIMARYKEY, Gl_optiondetail1.PRIMARYKEY, "200"}, 
        {Gl_optiondetail1.PRIMARYKEY, Gl_optiondetail1.PRIMARYKEY, "200"} 
    };
    ...
    public Gl_optiondetail1s() throws CodeException {
        this (new Gl_optiondetail1(NULLID));
        _isLoaded_ = true;
    }
    
    public Gl_optiondetail1s(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_optiondetail1(ID);
        ID_ = ID;
    }
    
    public Gl_optiondetail1s(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_optiondetail1(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Gl_optiondetail1s(Gl_optiondetail1 parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Gl_optiondetail1s(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Gl_optiondetail1s(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void recordLoad(ResultSet rs) throws CodeException {
           ...
           try {
               while (rs.next()) {
                   list.add(new Gl_optiondetail1(rs));
               }
               _isLoaded_ = true;
               _isDirty_ = false;
           }catch (SQLException e) {
    ...
    public void add(Gl_optiondetail1 obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Gl_optiondetail1s obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Gl_optiondetail1) it.next());
        }        
    ...
    public Gl_optiondetail1 getParent() {
        return parentObj_;
    }
    
    public void setParent(Gl_optiondetail1 obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Gl_optiondetail1 obj = (Gl_optiondetail1) it.next();
    ...
    public String getDefaultSort() {
        return Gl_optiondetail1s.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Gl_optiondetail1s.SQLNAME;
    }
