...
public abstract class Gl_sourcelgrAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Gl_sourcelgr";

    public static final String TABLE = "gl_sourcelgr";
    ...
    public static final String PROPERTY_SRCEDESC = "srcedesc";
    ...
    public static final String PROPERTY_CMPNYID = "cmpnyid";
     ...
     public static final String PRIMARYKEY = PROPERTY_SRCETYPECODE;
    
    
    private long id_;
    private String srcelgrcode_;
    private String srcetypecode_;
    private String srcedesc_;
    ...
    public Gl_sourcelgrAbst() throws CodeException {
        loadNew();
    }
    
    public Gl_sourcelgrAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Gl_sourcelgrAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Gl_sourcelgrAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Gl_sourcelgrAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Gl_sourcelgrAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           srcedesc_ = rs.getString(PROPERTY_SRCEDESC); 
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Gl_sourcelgrAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Gl_sourcelgr obj = (Gl_sourcelgr)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Gl_sourcelgr " + e.getMessage());
                } finally {
                    db.close();
                }
            }
 ...
 o = getsrcelgrcode(); 
        if (o == null) { 
            throw new CodeException ("Error Saving Application : srcelgrcode can not be Empty"); 
        } 
 
 o = getsrcetypecode(); 
        if (o == null) { 
            throw new CodeException ("Error Saving Application : srcetypecode can not be Empty"); 
        } 
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from gl_sourcelgr ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Gl_sourcelgr " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    private void saveFields(ResultSet rs) throws CodeException {
        try {
            ...
            rs.updateString(PROPERTY_SRCEDESC , srcedesc_ ); 
    ...
    public long getID() throws CodeException {
      ...
      public void setsrcedesc(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         srcedesc_ = param; 
         _isDirty_ = true; 
      } 

      public String getsrcedesc() throws CodeException {
         if (!_isLoaded_) { read();} 
         return srcedesc_; 
      } 
    ...
    public String toString(String param) throws CodeException {
        if (param.equals(PROPERTY_ID)) { return String.valueOf(id_) ;}
           ...
           else if (param.equals(PROPERTY_SRCEDESC)) return getsrcedesc(); 
    ...
    public void fromString(String param, String value) throws CodeException {
        if (param.equals(PROPERTY_ID)) {
           ...
           else if (param.equals(PROPERTY_SRCEDESC))  setsrcedesc(value); 
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Gl_sourcelgr : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            DbBean db = DbBean.connect();
            ResultSet rs = db.movePrevious(TABLEPROCESS, PRIMARYKEY, srcetypecode_+"");
            if (rs.next()) {
                load(rs);
            }
            db.close();
        } catch (SQLException ex) {
             throw new CodeException("Gl_sourcelgr : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            DbBean db = DbBean.connect();
            ResultSet rs = db.moveNext(TABLEPROCESS, PRIMARYKEY, srcetypecode_+"");
            if (rs.next()) {
                load(rs);
            }
            db.close();
        } catch (SQLException ex) {
             throw new CodeException("Gl_sourcelgr : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Gl_sourcelgr : Cannot Move Last " + ex.getMessage());
       }
    }
