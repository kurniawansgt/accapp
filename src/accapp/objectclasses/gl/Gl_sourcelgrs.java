 ...
 *    -  Gl_sourcelgrs objs = new Gl_sourcelgrs(0); // All Data
 *    or 
 *    - Gl_sourcelgrs obj = new Gl_sourcelgrs(Gl_sourcelgr.PROPERTY_<field>, <value>);
 *      Sample :
 *      Gl_sourcelgrs obj = new Gl_sourcelgrs(Gl_sourcelgr.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Gl_sourcelgrs brs = new Gl_sourcelgrs(0);

            for (Iterator<Gl_sourcelgr> it = brs.iterator(); it.hasNext(); ) {
                
                Gl_sourcelgr br = (Gl_sourcelgr) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_sourcelgr());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Gl_sourcelgr br = (Gl_sourcelgr) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_sourcelgr());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Gl_sourcelgr br = (Gl_sourcelgr) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_sourcelgr());
            }
 ...
 * @author windu
 */
public class Gl_sourcelgrs  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Gl_sourcelgrs";
    public static final String SQLNAME = Gl_sourcelgr.TABLE;
    public static String DEFAULTSORT = Gl_sourcelgr.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Gl_sourcelgr.PROPERTY_ID;
    ...
    List<Object> list;
    private Gl_sourcelgr parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Gl_sourcelgr.PROPERTY_SRCELGRCODE, Gl_sourcelgr.PROPERTY_SRCELGRCODE, "100"},
        {Gl_sourcelgr.PROPERTY_SRCETYPECODE, Gl_sourcelgr.PROPERTY_SRCETYPECODE, "100"},
        {Gl_sourcelgr.PROPERTY_SRCEDESC, Gl_sourcelgr.PROPERTY_SRCEDESC, "400"}
    };
    
    
    public String getCLASSNAME(){ return CLASSNAME; }
    
    public Gl_sourcelgrs() throws CodeException {
        this (new Gl_sourcelgr(NULLID));
        _isLoaded_ = true;
    }
    
    public Gl_sourcelgrs(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_sourcelgr(ID);
        ID_ = ID;
    }
    
    public Gl_sourcelgrs(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_sourcelgr(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Gl_sourcelgrs(Gl_sourcelgr parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Gl_sourcelgrs(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Gl_sourcelgrs(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void add(Gl_sourcelgr obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Gl_sourcelgrs obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Gl_sourcelgr) it.next());
        }        
    ...
    public Gl_sourcelgr getParent() {
        return parentObj_;
    }
    
    public void setParent(Gl_sourcelgr obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Gl_sourcelgr obj = (Gl_sourcelgr) it.next();
    ...
    public String getDefaultSort() {
        return Gl_sourcelgrs.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Gl_sourcelgrs.SQLNAME;
    }
