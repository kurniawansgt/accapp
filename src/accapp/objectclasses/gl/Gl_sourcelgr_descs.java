 ...
 *    -  Gl_sourcelgr_descs objs = new Gl_sourcelgr_descs(0); // All Data
 *    or 
 *    - Gl_sourcelgr_descs obj = new Gl_sourcelgr_descs(Gl_sourcelgr_desc.PROPERTY_<field>, <value>);
 *      Sample :
 *      Gl_sourcelgr_descs obj = new Gl_sourcelgr_descs(Gl_sourcelgr_desc.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Gl_sourcelgr_descs brs = new Gl_sourcelgr_descs(0);

            for (Iterator<Gl_sourcelgr_desc> it = brs.iterator(); it.hasNext(); ) {
                
                Gl_sourcelgr_desc br = (Gl_sourcelgr_desc) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_sourcelgr_desc());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Gl_sourcelgr_desc br = (Gl_sourcelgr_desc) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_sourcelgr_desc());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Gl_sourcelgr_desc br = (Gl_sourcelgr_desc) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_sourcelgr_desc());
            }
 ...
 * @author windu
 */
public class Gl_sourcelgr_descs  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Gl_sourcelgr_descs";
    public static final String SQLNAME = Gl_sourcelgr_desc.TABLE;
    public static String DEFAULTSORT = Gl_sourcelgr_desc.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Gl_sourcelgr_desc.PROPERTY_ID;
    ...
    List<Object> list;
    private Gl_sourcelgr_desc parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Gl_sourcelgr_desc.PROPERTY_SRCELGRCODE, Gl_sourcelgr_desc.PROPERTY_SRCELGRCODE, "200"},
        {Gl_sourcelgr_desc.PROPERTY_SRCELGRDESC, Gl_sourcelgr_desc.PROPERTY_SRCELGRDESC, "200"}
    };
    
    
    public String getCLASSNAME(){ return CLASSNAME; }
    
    public Gl_sourcelgr_descs() throws CodeException {
        this (new Gl_sourcelgr_desc(NULLID));
        _isLoaded_ = true;
    }
    
    public Gl_sourcelgr_descs(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_sourcelgr_desc(ID);
        ID_ = ID;
    }
    
    public Gl_sourcelgr_descs(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_sourcelgr_desc(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Gl_sourcelgr_descs(Gl_sourcelgr_desc parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Gl_sourcelgr_descs(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Gl_sourcelgr_descs(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void recordLoad(ResultSet rs) throws CodeException {
           ...
           try {
               while (rs.next()) {
                   list.add(new Gl_sourcelgr_desc(rs));
               }
               _isLoaded_ = true;
               _isDirty_ = false;
           }catch (SQLException e) {
    ...
    public void add(Gl_sourcelgr_desc obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Gl_sourcelgr_descs obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Gl_sourcelgr_desc) it.next());
        }        
    ...
    public Gl_sourcelgr_desc getParent() {
        return parentObj_;
    }
    
    public void setParent(Gl_sourcelgr_desc obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Gl_sourcelgr_desc obj = (Gl_sourcelgr_desc) it.next();
    ...
    public String getDefaultSort() {
        return Gl_sourcelgr_descs.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Gl_sourcelgr_descs.SQLNAME;
    }
