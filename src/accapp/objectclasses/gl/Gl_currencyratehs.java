 ...
 *    -  Gl_currencyratehs objs = new Gl_currencyratehs(0); // All Data
 *    or 
 *    - Gl_currencyratehs obj = new Gl_currencyratehs(Gl_currencyrateh.PROPERTY_<field>, <value>);
 *      Sample :
 *      Gl_currencyratehs obj = new Gl_currencyratehs(Gl_currencyrateh.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Gl_currencyratehs brs = new Gl_currencyratehs(0);

            for (Iterator<Gl_currencyrateh> it = brs.iterator(); it.hasNext(); ) {
                
                Gl_currencyrateh br = (Gl_currencyrateh) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_currencyrateh());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Gl_currencyrateh br = (Gl_currencyrateh) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_currencyrateh());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Gl_currencyrateh br = (Gl_currencyrateh) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_currencyrateh());
            }
 ...
 * @author windu
 */
public class Gl_currencyratehs  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Gl_currencyratehs";
    public static final String SQLNAME = Gl_currencyrateh.TABLE;
    public static String DEFAULTSORT = Gl_currencyrateh.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Gl_currencyrateh.PROPERTY_ID;
    ...
    List<Object> list;
    private Gl_currencyrateh parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Gl_currencyrateh.PROPERTY_HOMECUR, Gl_currencyrateh.PROPERTY_HOMECUR, "200"},
        {Gl_currencyrateh.PROPERTY_RATETYPE, Gl_currencyrateh.PROPERTY_RATETYPE, "100"},
        {Gl_currencyrateh.PROPERTY_DSCRIPTION, Gl_currencyrateh.PROPERTY_DSCRIPTION, "200"}
    };
    
    
    public String getCLASSNAME(){ return CLASSNAME; }
    
    public Gl_currencyratehs() throws CodeException {
        this (new Gl_currencyrateh(NULLID));
        _isLoaded_ = true;
    }
    
    public Gl_currencyratehs(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_currencyrateh(ID);
        ID_ = ID;
    }
    
    public Gl_currencyratehs(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_currencyrateh(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Gl_currencyratehs(Gl_currencyrateh parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Gl_currencyratehs(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Gl_currencyratehs(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void recordLoad(ResultSet rs) throws CodeException {
           ...
           try {
               while (rs.next()) {
                   list.add(new Gl_currencyrateh(rs));
               }
               _isLoaded_ = true;
               _isDirty_ = false;
           }catch (SQLException e) {
    ...
    public void add(Gl_currencyrateh obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Gl_currencyratehs obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Gl_currencyrateh) it.next());
        }        
    ...
    public Gl_currencyrateh getParent() {
        return parentObj_;
    }
    
    public void setParent(Gl_currencyrateh obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Gl_currencyrateh obj = (Gl_currencyrateh) it.next();
    ...
    public String getDefaultSort() {
        return Gl_currencyratehs.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Gl_currencyratehs.SQLNAME;
    }
