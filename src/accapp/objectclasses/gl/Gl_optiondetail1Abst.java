...
public abstract class Gl_optiondetail1Abst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Gl_optiondetail1";

    public static final String TABLE = "gl_optiondetail1";
    ...
    public Gl_optiondetail1Abst() throws CodeException {
        loadNew();
    }
    
    public Gl_optiondetail1Abst(long id) throws CodeException {
        loadID(id);

    }
    
    public Gl_optiondetail1Abst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Gl_optiondetail1Abst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Gl_optiondetail1Abst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Gl_optiondetail1Abst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           audituser_ = rs.getString(PROPERTY_AUDITUSER); 
            ...
            throw new CodeException ("Error Loading Gl_optiondetail1Abst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Gl_optiondetail1 obj = (Gl_optiondetail1)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Gl_optiondetail1 " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from gl_optiondetail1 ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Gl_optiondetail1 " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        Gl_optiondetail1 obj = (Gl_optiondetail1) jCob;
        id_ = obj.getID();
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Gl_optiondetail1 : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Gl_optiondetail1 : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Gl_optiondetail1 : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Gl_optiondetail1 : Cannot Move Last " + ex.getMessage());
       }
    }
