 ...
 *    -  Gl_jed_temps objs = new Gl_jed_temps(0); // All Data
 *    or 
 *    - Gl_jed_temps obj = new Gl_jed_temps(Gl_jed_temp.PROPERTY_<field>, <value>);
 *      Sample :
 *      Gl_jed_temps obj = new Gl_jed_temps(Gl_jed_temp.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Gl_jed_temps brs = new Gl_jed_temps(0);

            for (Iterator<Gl_jed_temp> it = brs.iterator(); it.hasNext(); ) {
                
                Gl_jed_temp br = (Gl_jed_temp) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_jed_temp());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Gl_jed_temp br = (Gl_jed_temp) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_jed_temp());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Gl_jed_temp br = (Gl_jed_temp) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_jed_temp());
            }
 ...
 * @author windu
 */
public class Gl_jed_temps  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Gl_jed_temps";
    public static final String SQLNAME = Gl_jed_temp.TABLE;
    public static String DEFAULTSORT = Gl_jed_temp.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Gl_jed_temp.PROPERTY_ID;
    ...
    List<Object> list;
    private Gl_jed_temp parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Gl_jed_temp.PRIMARYKEY, Gl_jed_temp.PRIMARYKEY, "200"}, 
        {Gl_jed_temp.PRIMARYKEY, Gl_jed_temp.PRIMARYKEY, "200"} 
    };
    ...
    public Gl_jed_temps() throws CodeException {
        this (new Gl_jed_temp(NULLID));
        _isLoaded_ = true;
    }
    
    public Gl_jed_temps(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_jed_temp(ID);
        ID_ = ID;
    }
    
    public Gl_jed_temps(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_jed_temp(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Gl_jed_temps(Gl_jed_temp parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Gl_jed_temps(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Gl_jed_temps(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void add(Gl_jed_temp obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Gl_jed_temps obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Gl_jed_temp) it.next());
        }        
    ...
    public Gl_jed_temp getParent() {
        return parentObj_;
    }
    
    public void setParent(Gl_jed_temp obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Gl_jed_temp obj = (Gl_jed_temp) it.next();
    ...
    public String getDefaultSort() {
        return Gl_jed_temps.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Gl_jed_temps.SQLNAME;
    }
