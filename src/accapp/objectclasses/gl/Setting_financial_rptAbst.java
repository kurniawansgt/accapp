...
public abstract class Setting_financial_rptAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Setting_financial_rpt";

    public static final String TABLE = "setting_financial_rpt";
    ...
    public static final String PROPERTY_REPORTDESC = "reportdesc";
    public static final String PROPERTY_CRATEDATE = "cratedate";
    ...
    public static final String PROPERTY_CMPNYID = "cmpnyid";
     ...
     public static final String PRIMARYKEY = PROPERTY_DOCENTRY;
    ...
    public Setting_financial_rptAbst() throws CodeException {
        loadNew();
    }
    
    public Setting_financial_rptAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Setting_financial_rptAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Setting_financial_rptAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Setting_financial_rptAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Setting_financial_rptAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           reportname_ = rs.getString(PROPERTY_REPORTNAME); 
           reportdesc_ = rs.getString(PROPERTY_REPORTDESC); 
           cratedate_ = rs.getString(PROPERTY_CRATEDATE); 
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Setting_financial_rptAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Setting_financial_rpt obj = (Setting_financial_rpt)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Setting_financial_rpt " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from setting_financial_rpt ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Setting_financial_rpt " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    private void saveFields(ResultSet rs) throws CodeException {
        try {
            ...
            rs.updateString(PROPERTY_REPORTNAME , reportname_ ); 
            rs.updateString(PROPERTY_REPORTDESC , reportdesc_ ); 
            rs.updateString(PROPERTY_CRATEDATE , cratedate_ ); 
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        Setting_financial_rpt obj = (Setting_financial_rpt) jCob;
        id_ = obj.getID();

        
          docentry_ = obj.getdocentry();
          reportname_ = obj.getreportname();
          reportdesc_ = obj.getreportdesc();
          cratedate_ = obj.getcratedate();
    ...
    public long getID() throws CodeException {
      ...
      public void setreportname(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         reportname_ = param; 
         _isDirty_ = true; 
      } 

      public String getreportname() throws CodeException {
         if (!_isLoaded_) { read();} 
         return reportname_; 
      } 

      public void setreportdesc(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         reportdesc_ = param; 
         _isDirty_ = true; 
      } 

      public String getreportdesc() throws CodeException {
         if (!_isLoaded_) { read();} 
         return reportdesc_; 
      } 

      public void setcratedate(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         cratedate_ = param; 
         _isDirty_ = true; 
      } 

      public String getcratedate() throws CodeException {
         if (!_isLoaded_) { read();} 
         return cratedate_; 
      } 
    ...
    public String toString(String param) throws CodeException {
        if (param.equals(PROPERTY_ID)) { return String.valueOf(id_) ;}
           ...
           else if (param.equals(PROPERTY_REPORTNAME)) return getreportname(); 
           else if (param.equals(PROPERTY_REPORTDESC)) return getreportdesc(); 
           else if (param.equals(PROPERTY_CRATEDATE)) return getcratedate(); 
    ...
    public void fromString(String param, String value) throws CodeException {
        if (param.equals(PROPERTY_ID)) {
           ...
           else if (param.equals(PROPERTY_REPORTNAME))  setreportname(value); 
           else if (param.equals(PROPERTY_REPORTDESC))  setreportdesc(value); 
           else if (param.equals(PROPERTY_CRATEDATE))  setcratedate(value); 
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Setting_financial_rpt : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            DbBean db = DbBean.connect();
            ResultSet rs = db.movePrevious(TABLEPROCESS, PRIMARYKEY, docentry_+"");
            if (rs.next()) {
                load(rs);
            }
            db.close();
        } catch (SQLException ex) {
             throw new CodeException("Setting_financial_rpt : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            DbBean db = DbBean.connect();
            ResultSet rs = db.moveNext(TABLEPROCESS, PRIMARYKEY, docentry_+"");
            if (rs.next()) {
                load(rs);
            }
            db.close();
        } catch (SQLException ex) {
             throw new CodeException("Setting_financial_rpt : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Setting_financial_rpt : Cannot Move Last " + ex.getMessage());
       }
    }
