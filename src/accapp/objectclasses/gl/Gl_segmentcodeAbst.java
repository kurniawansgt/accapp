...
public abstract class Gl_segmentcodeAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Gl_segmentcode";

    public static final String TABLE = "gl_segmentcode";
    ...
    public static final String PROPERTY_SEGVAL = "segval";
    public static final String PROPERTY_SEGVALDESC = "segvaldesc";
    ...
    public static final String PROPERTY_CMPNYID = "cmpnyid";
     ...
     public static final String PRIMARYKEY = PROPERTY_SEGVAL;
    
    
    private long id_;
    private String accsgmncode_;
    private String segval_;
    private String segvaldesc_;
    ...
    public Gl_segmentcodeAbst() throws CodeException {
        loadNew();
    }
    
    public Gl_segmentcodeAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Gl_segmentcodeAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Gl_segmentcodeAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Gl_segmentcodeAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Gl_segmentcodeAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           segval_ = rs.getString(PROPERTY_SEGVAL); 
           segvaldesc_ = rs.getString(PROPERTY_SEGVALDESC); 
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Gl_segmentcodeAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Gl_segmentcode obj = (Gl_segmentcode)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Gl_segmentcode " + e.getMessage());
                } finally {
                    db.close();
                }
            }
 ...
 o = getsegval(); 
        if (o == null) { 
            throw new CodeException ("Error Saving Application : segval can not be Empty"); 
        } 
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from gl_segmentcode ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Gl_segmentcode " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    private void saveFields(ResultSet rs) throws CodeException {
        try {
            ...
            rs.updateString(PROPERTY_SEGVAL , segval_ ); 
            rs.updateString(PROPERTY_SEGVALDESC , segvaldesc_ ); 
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        Gl_segmentcode obj = (Gl_segmentcode) jCob;
        id_ = obj.getID();

        
          accsgmncode_ = obj.getaccsgmncode();
          segval_ = obj.getsegval();
          segvaldesc_ = obj.getsegvaldesc();
    ...
    public long getID() throws CodeException {
      ...
      public void setsegval(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         segval_ = param; 
         _isDirty_ = true; 
      } 

      public String getsegval() throws CodeException {
         if (!_isLoaded_) { read();} 
         return segval_; 
      } 

      public void setsegvaldesc(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         segvaldesc_ = param; 
         _isDirty_ = true; 
      } 

      public String getsegvaldesc() throws CodeException {
         if (!_isLoaded_) { read();} 
         return segvaldesc_; 
      } 
    ...
    public String toString(String param) throws CodeException {
        if (param.equals(PROPERTY_ID)) { return String.valueOf(id_) ;}
           ...
           else if (param.equals(PROPERTY_SEGVAL)) return getsegval(); 
           else if (param.equals(PROPERTY_SEGVALDESC)) return getsegvaldesc(); 
    ...
    public void fromString(String param, String value) throws CodeException {
        if (param.equals(PROPERTY_ID)) {
           ...
           else if (param.equals(PROPERTY_SEGVAL))  setsegval(value); 
           else if (param.equals(PROPERTY_SEGVALDESC))  setsegvaldesc(value); 
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Gl_segmentcode : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            DbBean db = DbBean.connect();
            ResultSet rs = db.movePrevious(TABLEPROCESS, PRIMARYKEY, segval_+"");
            if (rs.next()) {
                load(rs);
            }
            db.close();
        } catch (SQLException ex) {
             throw new CodeException("Gl_segmentcode : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            DbBean db = DbBean.connect();
            ResultSet rs = db.moveNext(TABLEPROCESS, PRIMARYKEY, segval_+"");
            if (rs.next()) {
                load(rs);
            }
            db.close();
        } catch (SQLException ex) {
             throw new CodeException("Gl_segmentcode : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Gl_segmentcode : Cannot Move Last " + ex.getMessage());
       }
    }
