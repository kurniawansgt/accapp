 ...
 *    -  Gl_account_budgets objs = new Gl_account_budgets(0); // All Data
 *    or 
 *    - Gl_account_budgets obj = new Gl_account_budgets(Gl_account_budget.PROPERTY_<field>, <value>);
 *      Sample :
 *      Gl_account_budgets obj = new Gl_account_budgets(Gl_account_budget.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Gl_account_budgets brs = new Gl_account_budgets(0);

            for (Iterator<Gl_account_budget> it = brs.iterator(); it.hasNext(); ) {
                
                Gl_account_budget br = (Gl_account_budget) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_account_budget());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Gl_account_budget br = (Gl_account_budget) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_account_budget());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Gl_account_budget br = (Gl_account_budget) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_account_budget());
            }
 ...
 * @author windu
 */
public class Gl_account_budgets  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Gl_account_budgets";
    public static final String SQLNAME = Gl_account_budget.TABLE;
    public static String DEFAULTSORT = Gl_account_budget.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Gl_account_budget.PROPERTY_ID;
    ...
    List<Object> list;
    private Gl_account_budget parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Gl_account_budget.PRIMARYKEY, Gl_account_budget.PRIMARYKEY, "200"}, 
        {Gl_account_budget.PRIMARYKEY, Gl_account_budget.PRIMARYKEY, "200"} 
    };
    ...
    public Gl_account_budgets() throws CodeException {
        this (new Gl_account_budget(NULLID));
        _isLoaded_ = true;
    }
    
    public Gl_account_budgets(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_account_budget(ID);
        ID_ = ID;
    }
    
    public Gl_account_budgets(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_account_budget(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Gl_account_budgets(Gl_account_budget parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Gl_account_budgets(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Gl_account_budgets(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void recordLoad(ResultSet rs) throws CodeException {
           ...
           try {
               while (rs.next()) {
                   list.add(new Gl_account_budget(rs));
               }
               _isLoaded_ = true;
               _isDirty_ = false;
           }catch (SQLException e) {
    ...
    public void add(Gl_account_budget obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Gl_account_budgets obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Gl_account_budget) it.next());
        }        
    ...
    public Gl_account_budget getParent() {
        return parentObj_;
    }
    
    public void setParent(Gl_account_budget obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Gl_account_budget obj = (Gl_account_budget) it.next();
    ...
    public String getDefaultSort() {
        return Gl_account_budgets.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Gl_account_budgets.SQLNAME;
    }

    public void searchData(String acccode,Integer yop,String curnccode) throws CodeException {
        ResultSet rs = null;
        DbBean db = DbBean.connect();

        String query = " select * from gl_account_budget where acccode='"+acccode+"' and yop="+yop+" and curnccode='"+curnccode+"'";
