 ...
 *    -  Setting_financial_rpts objs = new Setting_financial_rpts(0); // All Data
 *    or 
 *    - Setting_financial_rpts obj = new Setting_financial_rpts(Setting_financial_rpt.PROPERTY_<field>, <value>);
 *      Sample :
 *      Setting_financial_rpts obj = new Setting_financial_rpts(Setting_financial_rpt.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Setting_financial_rpts brs = new Setting_financial_rpts(0);

            for (Iterator<Setting_financial_rpt> it = brs.iterator(); it.hasNext(); ) {
                
                Setting_financial_rpt br = (Setting_financial_rpt) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaSetting_financial_rpt());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Setting_financial_rpt br = (Setting_financial_rpt) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaSetting_financial_rpt());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Setting_financial_rpt br = (Setting_financial_rpt) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaSetting_financial_rpt());
            }
 ...
 * @author windu
 */
public class Setting_financial_rpts  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Setting_financial_rpts";
    public static final String SQLNAME = Setting_financial_rpt.TABLE;
    public static String DEFAULTSORT = Setting_financial_rpt.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Setting_financial_rpt.PROPERTY_ID;
    ...
    List<Object> list;
    private Setting_financial_rpt parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Setting_financial_rpt.PROPERTY_REPORTNAME, Setting_financial_rpt.PROPERTY_REPORTNAME, "200"},
        {Setting_financial_rpt.PROPERTY_REPORTDESC, Setting_financial_rpt.PROPERTY_REPORTDESC, "400"},
    };
    
    
    public String getCLASSNAME(){ return CLASSNAME; }
    
    public Setting_financial_rpts() throws CodeException {
        this (new Setting_financial_rpt(NULLID));
        _isLoaded_ = true;
    }
    
    public Setting_financial_rpts(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Setting_financial_rpt(ID);
        ID_ = ID;
    }
    
    public Setting_financial_rpts(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Setting_financial_rpt(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Setting_financial_rpts(Setting_financial_rpt parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Setting_financial_rpts(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Setting_financial_rpts(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void recordLoad(ResultSet rs) throws CodeException {
           ...
           try {
               while (rs.next()) {
                   list.add(new Setting_financial_rpt(rs));
               }
               _isLoaded_ = true;
               _isDirty_ = false;
           }catch (SQLException e) {
    ...
    public void add(Setting_financial_rpt obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Setting_financial_rpts obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Setting_financial_rpt) it.next());
        }        
    ...
    public Setting_financial_rpt getParent() {
        return parentObj_;
    }
    
    public void setParent(Setting_financial_rpt obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Setting_financial_rpt obj = (Setting_financial_rpt) it.next();
    ...
    public String getDefaultSort() {
        return Setting_financial_rpts.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Setting_financial_rpts.SQLNAME;
    }
