 ...
 *    -  Gl_jeds objs = new Gl_jeds(0); // All Data
 *    or 
 *    - Gl_jeds obj = new Gl_jeds(Gl_jed.PROPERTY_<field>, <value>);
 *      Sample :
 *      Gl_jeds obj = new Gl_jeds(Gl_jed.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Gl_jeds brs = new Gl_jeds(0);

            for (Iterator<Gl_jed> it = brs.iterator(); it.hasNext(); ) {
                
                Gl_jed br = (Gl_jed) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_jed());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Gl_jed br = (Gl_jed) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_jed());
            }
 ...
 * @author windu
 */
public class Gl_jeds  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Gl_jeds";
    public static final String SQLNAME = Gl_jed.TABLE;
    public static String DEFAULTSORT = Gl_jed.PROPERTY_JOURNALID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Gl_jed.PROPERTY_ID;
    ...
    private String[][] column = {
        {Gl_jed.PRIMARYKEY, Gl_jed.PRIMARYKEY, "200"}, 
        {Gl_jed.PRIMARYKEY, Gl_jed.PRIMARYKEY, "200"} 
    };
    ...
    public Gl_jeds() throws CodeException {
        this (new Gl_jed(NULLID));
        _isLoaded_ = true;
    }
    
    public Gl_jeds(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_jed(ID);
        ID_ = ID;
    }
    
    public Gl_jeds(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_jed(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Gl_jeds(Gl_jed parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Gl_jeds(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Gl_jeds(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void add(Gl_jed obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Gl_jeds obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
    ...
    public Gl_jed getParent() {
        return parentObj_;
    }
    
    public void setParent(Gl_jed obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public String getDefaultSort() {
        return Gl_jeds.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Gl_jeds.SQLNAME;
    }
    ...
    public void searchData(double btchentry, double journalid) throws CodeException {
        ...
        String query = " select * from gl_jed where btchentry = " + btchentry + "  and journalid = " + journalid;
