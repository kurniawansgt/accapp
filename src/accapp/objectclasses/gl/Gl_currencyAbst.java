...
public abstract class Gl_currencyAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Gl_currency";

    public static final String TABLE = "gl_currency";
    ...
    public static final String PROPERTY_CURNCDESC = "curncdesc";
    ...
    public Gl_currencyAbst() throws CodeException {
        loadNew();
    }
    
    public Gl_currencyAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Gl_currencyAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Gl_currencyAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Gl_currencyAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Gl_currencyAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           curncdesc_ = rs.getString(PROPERTY_CURNCDESC); 
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Gl_currencyAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Gl_currency obj = (Gl_currency)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Gl_currency " + e.getMessage());
                } finally {
                    db.close();
                }
            }
 ...
 o = getcurnccode(); 
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from gl_currency ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Gl_currency " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    private void saveFields(ResultSet rs) throws CodeException {
        try {
            ...
            rs.updateString(PROPERTY_CURNCDESC , curncdesc_ ); 
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        Gl_currency obj = (Gl_currency) jCob;
        id_ = obj.getID();

        
          curnccode_ = obj.getcurnccode();
          curncdesc_ = obj.getcurncdesc();
    ...
    public long getID() throws CodeException {
      ...
      public void setcurncdesc(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         curncdesc_ = param; 
         _isDirty_ = true; 
      } 
    ...
    public String toString(String param) throws CodeException {
        if (param.equals(PROPERTY_ID)) { return String.valueOf(id_) ;}
           ...
           else if (param.equals(PROPERTY_CURNCDESC)) return getcurncdesc(); 
    ...
    public void fromString(String param, String value) throws CodeException {
        if (param.equals(PROPERTY_ID)) {
           ...
           else if (param.equals(PROPERTY_CURNCDESC))  setcurncdesc(value); 
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Gl_currency : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Gl_currency : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Gl_currency : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Gl_currency : Cannot Move Last " + ex.getMessage());
       }
    }
