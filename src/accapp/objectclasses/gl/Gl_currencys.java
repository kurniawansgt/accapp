 ...
 *    -  Gl_currencys objs = new Gl_currencys(0); // All Data
 *    or 
 *    - Gl_currencys obj = new Gl_currencys(Gl_currency.PROPERTY_<field>, <value>);
 *      Sample :
 *      Gl_currencys obj = new Gl_currencys(Gl_currency.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            for (Iterator<Gl_currency> it = brs.iterator(); it.hasNext(); ) {
                
                Gl_currency br = (Gl_currency) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_currency());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Gl_currency br = (Gl_currency) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_currency());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Gl_currency br = (Gl_currency) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaGl_currency());
            }
 ...
 * @author windu
 */
public class Gl_currencys  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Gl_currencys";
    public static final String SQLNAME = Gl_currency.TABLE;
    public static String DEFAULTSORT = Gl_currency.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Gl_currency.PROPERTY_ID;
    ...
    List<Object> list;
    private Gl_currency parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Gl_currency.PRIMARYKEY, Gl_currency.PRIMARYKEY, "200"}, 
        {Gl_currency.PROPERTY_CURNCDESC, Gl_currency.PROPERTY_CURNCDESC, "200"}
    };
    
    
    public String getCLASSNAME(){ return CLASSNAME; }
    
    public Gl_currencys() throws CodeException {
        this (new Gl_currency(NULLID));
        _isLoaded_ = true;
    }
    
    public Gl_currencys(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_currency(ID);
        ID_ = ID;
    }
    
    public Gl_currencys(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Gl_currency(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Gl_currencys(Gl_currency parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Gl_currencys(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Gl_currencys(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void add(Gl_currency obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Gl_currencys obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Gl_currency) it.next());
        }        
    ...
    public Gl_currency getParent() {
        return parentObj_;
    }
    
    public void setParent(Gl_currency obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Gl_currency obj = (Gl_currency) it.next();
    ...
    public String getDefaultSort() {
        return Gl_currencys.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Gl_currencys.SQLNAME;
    }
