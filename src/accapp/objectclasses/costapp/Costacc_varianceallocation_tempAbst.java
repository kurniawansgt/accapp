...
public abstract class Costacc_varianceallocation_tempAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Costacc_varianceallocation_temp";

    public static final String TABLE = "bankjurnal.costacc_varianceallocation_temp";
    ...
    public Costacc_varianceallocation_tempAbst() throws CodeException {
        loadNew();
    }
    
    public Costacc_varianceallocation_tempAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Costacc_varianceallocation_tempAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Costacc_varianceallocation_tempAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Costacc_varianceallocation_tempAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Costacc_varianceallocation_tempAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           audituser_ = rs.getString(PROPERTY_AUDITUSER); 
            ...
            throw new CodeException ("Error Loading Costacc_varianceallocation_tempAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Costacc_varianceallocation_temp obj = (Costacc_varianceallocation_temp)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Costacc_varianceallocation_temp " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from costacc_varianceallocation_temp ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Costacc_varianceallocation_temp " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        Costacc_varianceallocation_temp obj = (Costacc_varianceallocation_temp) jCob;
        id_ = obj.getID();
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Costacc_varianceallocation_temp : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Costacc_varianceallocation_temp : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Costacc_varianceallocation_temp : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Costacc_varianceallocation_temp : Cannot Move Last " + ex.getMessage());
       }
    }
