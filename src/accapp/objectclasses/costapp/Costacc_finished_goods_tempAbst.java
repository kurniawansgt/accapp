...
public abstract class Costacc_finished_goods_tempAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Costacc_finished_goods_temp";

    public static final String TABLE = "bankjurnal.costacc_finished_goods_temp";
    ...
    public static final String PROPERTY_SALESPCNT = "salespcnt";
    ...
    public Costacc_finished_goods_tempAbst() throws CodeException {
        loadNew();
    }
    
    public Costacc_finished_goods_tempAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Costacc_finished_goods_tempAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Costacc_finished_goods_tempAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Costacc_finished_goods_tempAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Costacc_finished_goods_tempAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           sales_ = rs.getDouble(PROPERTY_SALES); 
           salespcnt_ = rs.getDouble(PROPERTY_SALESPCNT); 
           ...
           audituser_ = rs.getString(PROPERTY_AUDITUSER); 
            ...
            throw new CodeException ("Error Loading Costacc_finished_goods_tempAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Costacc_finished_goods_temp obj = (Costacc_finished_goods_temp)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Costacc_finished_goods_temp " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from costacc_finished_goods_temp ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Costacc_finished_goods_temp " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    private void saveFields(ResultSet rs) throws CodeException {
        try {
            ...
            rs.updateDouble(PROPERTY_SALES , sales_ ); 
            rs.updateDouble(PROPERTY_SALESPCNT , salespcnt_ ); 
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        Costacc_finished_goods_temp obj = (Costacc_finished_goods_temp) jCob;
        id_ = obj.getID();
    ...
    public long getID() throws CodeException {
      ...
      public void setsales(double param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         sales_ = param; 
         _isDirty_ = true; 
      } 

      public double getsales() throws CodeException {
         if (!_isLoaded_) { read();} 
         return sales_; 
      } 

      public void setsalespcnt(double param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         salespcnt_ = param; 
         _isDirty_ = true; 
      } 

      public double getsalespcnt() throws CodeException {
         if (!_isLoaded_) { read();} 
         return salespcnt_; 
      } 
    ...
    public String toString(String param) throws CodeException {
        if (param.equals(PROPERTY_ID)) { return String.valueOf(id_) ;}
           ...
           else if (param.equals(PROPERTY_SALES)) return decform.format(getsales()); 
           else if (param.equals(PROPERTY_SALESPCNT)) return decform.format(getsalespcnt()); 
    ...
    public void fromString(String param, String value) throws CodeException {
        if (param.equals(PROPERTY_ID)) {
           ...
           else if (param.equals(PROPERTY_SALESPCNT)) { 
                    double newVal; 
                    try { 
                          newVal = Double.parseDouble(value); 
                          setsalespcnt(newVal); 
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Costacc_finished_goods_temp : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Costacc_finished_goods_temp : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Costacc_finished_goods_temp : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Costacc_finished_goods_temp : Cannot Move Last " + ex.getMessage());
       }
    }
