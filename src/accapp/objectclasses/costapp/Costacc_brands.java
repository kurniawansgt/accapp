 ...
 *    -  Costacc_brands objs = new Costacc_brands(0); // All Data
 *    or 
 *    - Costacc_brands obj = new Costacc_brands(Costacc_brand.PROPERTY_<field>, <value>);
 *      Sample :
 *      Costacc_brands obj = new Costacc_brands(Costacc_brand.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Costacc_brands brs = new Costacc_brands(0);

            for (Iterator<Costacc_brand> it = brs.iterator(); it.hasNext(); ) {
                
                Costacc_brand br = (Costacc_brand) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaCostacc_brand());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Costacc_brand br = (Costacc_brand) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaCostacc_brand());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Costacc_brand br = (Costacc_brand) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaCostacc_brand());
            }
 ...
 * @author windu
 */
public class Costacc_brands  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Costacc_brands";
    public static final String SQLNAME = Costacc_brand.TABLE;
    public static String DEFAULTSORT = Costacc_brand.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Costacc_brand.PROPERTY_ID;
    ...
    List<Object> list;
    private Costacc_brand parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Costacc_brand.PRIMARYKEY, Costacc_brand.PRIMARYKEY, "200"}, 
        {Costacc_brand.PRIMARYKEY, Costacc_brand.PRIMARYKEY, "200"} 
    };
    ...
    public Costacc_brands() throws CodeException {
        this (new Costacc_brand(NULLID));
        _isLoaded_ = true;
    }
    
    public Costacc_brands(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Costacc_brand(ID);
        ID_ = ID;
    }
    
    public Costacc_brands(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Costacc_brand(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Costacc_brands(Costacc_brand parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Costacc_brands(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Costacc_brands(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void add(Costacc_brand obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Costacc_brands obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Costacc_brand) it.next());
        }        
    ...
    public Costacc_brand getParent() {
        return parentObj_;
    }
    
    public void setParent(Costacc_brand obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Costacc_brand obj = (Costacc_brand) it.next();
    ...
    public String getDefaultSort() {
        return Costacc_brands.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Costacc_brands.SQLNAME;
    }
