 ...
 *    -  Cb_pjhs objs = new Cb_pjhs(0); // All Data
 *    or 
 *    - Cb_pjhs obj = new Cb_pjhs(Cb_pjh.PROPERTY_<field>, <value>);
 *      Sample :
 *      Cb_pjhs obj = new Cb_pjhs(Cb_pjh.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Cb_pjhs brs = new Cb_pjhs(0);

            for (Iterator<Cb_pjh> it = brs.iterator(); it.hasNext(); ) {
                
                Cb_pjh br = (Cb_pjh) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaCb_pjh());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Cb_pjh br = (Cb_pjh) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaCb_pjh());
            }
 ...
 * @author windu
 */
public class Cb_pjhs  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Cb_pjhs";
    public static final String SQLNAME = Cb_pjh.TABLE;
    public static String DEFAULTSORT = Cb_pjh.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Cb_pjh.PROPERTY_ID;
    ...
    private String[][] column = {
        {Cb_pjh.PRIMARYKEY, Cb_pjh.PRIMARYKEY, "200"}, 
        {Cb_pjh.PRIMARYKEY, Cb_pjh.PRIMARYKEY, "200"} 
    };
    ...
    public Cb_pjhs() throws CodeException {
        this (new Cb_pjh(NULLID));
        _isLoaded_ = true;
    }
    
    public Cb_pjhs(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Cb_pjh(ID);
        ID_ = ID;
    }
    
    public Cb_pjhs(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Cb_pjh(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Cb_pjhs(Cb_pjh parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Cb_pjhs(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Cb_pjhs(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void add(Cb_pjh obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Cb_pjhs obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
    ...
    public Cb_pjh getParent() {
        return parentObj_;
    }
    
    public void setParent(Cb_pjh obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public String getDefaultSort() {
        return Cb_pjhs.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Cb_pjhs.SQLNAME;
    }
    ...
    public void searchData() throws CodeException {
        ...
        String query = " select b.* "
                ...
                + "inner join cb_pjh b on b.pseqno=a.postngseq "
                + "where a.batchsts='P' and a.postngseq<>0 "
                + "group by a.postngseq";
