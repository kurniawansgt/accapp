 ...
 *    -  Cb_optiondetail1s objs = new Cb_optiondetail1s(0); // All Data
 *    or 
 *    - Cb_optiondetail1s obj = new Cb_optiondetail1s(Cb_optiondetail1.PROPERTY_<field>, <value>);
 *      Sample :
 *      Cb_optiondetail1s obj = new Cb_optiondetail1s(Cb_optiondetail1.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Cb_optiondetail1s brs = new Cb_optiondetail1s(0);

            for (Iterator<Cb_optiondetail1> it = brs.iterator(); it.hasNext(); ) {
                
                Cb_optiondetail1 br = (Cb_optiondetail1) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaCb_optiondetail1());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Cb_optiondetail1 br = (Cb_optiondetail1) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaCb_optiondetail1());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Cb_optiondetail1 br = (Cb_optiondetail1) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaCb_optiondetail1());
            }
 ...
 * @author windu
 */
public class Cb_optiondetail1s  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Cb_optiondetail1s";
    public static final String SQLNAME = Cb_optiondetail1.TABLE;
    public static String DEFAULTSORT = Cb_optiondetail1.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Cb_optiondetail1.PROPERTY_ID;
    ...
    List<Object> list;
    private Cb_optiondetail1 parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Cb_optiondetail1.PRIMARYKEY, Cb_optiondetail1.PRIMARYKEY, "200"}, 
        {Cb_optiondetail1.PRIMARYKEY, Cb_optiondetail1.PRIMARYKEY, "200"} 
    };
    ...
    public Cb_optiondetail1s() throws CodeException {
        this (new Cb_optiondetail1(NULLID));
        _isLoaded_ = true;
    }
    
    public Cb_optiondetail1s(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Cb_optiondetail1(ID);
        ID_ = ID;
    }
    
    public Cb_optiondetail1s(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Cb_optiondetail1(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Cb_optiondetail1s(Cb_optiondetail1 parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Cb_optiondetail1s(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Cb_optiondetail1s(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void recordLoad(ResultSet rs) throws CodeException {
           ...
           try {
               while (rs.next()) {
                   list.add(new Cb_optiondetail1(rs));
               }
               _isLoaded_ = true;
               _isDirty_ = false;
           }catch (SQLException e) {
    ...
    public void add(Cb_optiondetail1 obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Cb_optiondetail1s obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Cb_optiondetail1) it.next());
        }        
    ...
    public Cb_optiondetail1 getParent() {
        return parentObj_;
    }
    
    public void setParent(Cb_optiondetail1 obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Cb_optiondetail1 obj = (Cb_optiondetail1) it.next();
    ...
    public String getDefaultSort() {
        return Cb_optiondetail1s.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Cb_optiondetail1s.SQLNAME;
    }
