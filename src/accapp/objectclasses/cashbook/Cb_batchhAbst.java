...
public abstract class Cb_batchhAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Cb_batchh";

    public static final String TABLE = "cb_batchh";
    ...
    public static final String PROPERTY_NO_PAYMENT_VOUCHER = "no_payment_voucher";
    ...
    private String no_payment_voucher_;
    ...
    public Cb_batchhAbst() throws CodeException {
        loadNew();
    }
    
    public Cb_batchhAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Cb_batchhAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Cb_batchhAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Cb_batchhAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Cb_batchhAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           no_payment_voucher_ = rs.getString(PROPERTY_NO_PAYMENT_VOUCHER);
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Cb_batchhAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Cb_batchh obj = (Cb_batchh)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Cb_batchh " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from cb_batchh ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Cb_batchh " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    private void saveFields(ResultSet rs) throws CodeException {
        try {
            ...
            rs.updateString(PROPERTY_NO_PAYMENT_VOUCHER, no_payment_voucher_);
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        ...
        id_ = obj.getID();
          ...
          no_payment_voucher_ = obj.getno_payment_voucher();
    ...
    public long getID() throws CodeException {
      ...
      public void setno_payment_voucher(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         no_payment_voucher_ = param; 
         _isDirty_ = true; 
      } 

      public String getno_payment_voucher() throws CodeException {
         if (!_isLoaded_) { read();} 
         return no_payment_voucher_; 
      }
    ...
    public String toString(String param) throws CodeException {
        if (param.equals(PROPERTY_ID)) { return String.valueOf(id_) ;}
           ...
           else if (param.equals(PROPERTY_NO_PAYMENT_VOUCHER)) return String.valueOf(getobjtype()); 
    ...
    public void fromString(String param, String value) throws CodeException {
        if (param.equals(PROPERTY_ID)) {
           ...
           else if (param.equals(PROPERTY_NO_PAYMENT_VOUCHER))  setno_payment_voucher(value);
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Cb_batchh : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Cb_batchh : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Cb_batchh : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Cb_batchh : Cannot Move Last " + ex.getMessage());
       }
    }
