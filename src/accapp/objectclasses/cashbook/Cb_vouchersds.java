 ...
 *    -  Cb_vouchersds objs = new Cb_vouchersds(0); // All Data
 *    or
 *    - Cb_vouchersds obj = new Cb_vouchersds(Cb_vouchersd.PROPERTY_<field>, <value>);
 *      Sample :
 *      Cb_vouchersds obj = new Cb_vouchersds(Cb_vouchersd.PROPERTY_ID, "1");
 ...
 * 2. Read Data
        try {
            ...
            Cb_vouchersds brs = new Cb_vouchersds(0);

            for (Iterator<Cb_vouchersd> it = brs.iterator(); it.hasNext(); ) {

                Cb_vouchersd br = (Cb_vouchersd) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaCb_vouchersd());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Cb_vouchersd br = (Cb_vouchersd) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaCb_vouchersd());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Cb_vouchersd br = (Cb_vouchersd) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaCb_vouchersd());
            }
 ...
 * @author windu
 */
public class Cb_vouchersds  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Cb_vouchersds";
    public static final String SQLNAME = Cb_vouchersd.TABLE;
    public static String DEFAULTSORT = Cb_vouchersd.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";

    public static final String FOREIGNKEY = Cb_vouchersd.PROPERTY_ID;
    ...
    List<Object> list;
    private Cb_vouchersd parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Cb_vouchersd.PRIMARYKEY, Cb_vouchersd.PRIMARYKEY, "200"},
        {Cb_vouchersd.PRIMARYKEY, Cb_vouchersd.PRIMARYKEY, "200"}
    };
    ...
    public Cb_vouchersds() throws CodeException {
        this (new Cb_vouchersd(NULLID));
        _isLoaded_ = true;
    }

    public Cb_vouchersds(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Cb_vouchersd(ID);
        ID_ = ID;
    }

    public Cb_vouchersds(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Cb_vouchersd(PrimaryKey);
        ID_ = parentObj_.getID();
    }

    public Cb_vouchersds(Cb_vouchersd parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Cb_vouchersds(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }

    public Cb_vouchersds(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void add(Cb_vouchersd obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Cb_vouchersds obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Cb_vouchersd) it.next());
        }
    ...
    public Cb_vouchersd getParent() {
        return parentObj_;
    }

    public void setParent(Cb_vouchersd obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Cb_vouchersd obj = (Cb_vouchersd) it.next();
    ...
    public String getDefaultSort() {
        return Cb_vouchersds.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Cb_vouchersds.SQLNAME;
    }
    ...
    public void searchData(double batchno, long entryno, long linenum) throws CodeException {
        ...
        String query = " select * from cb_vouchersd where batchno='" + batchno + "' and entryno='" + entryno +"' and detailno='"+linenum + "' ";
