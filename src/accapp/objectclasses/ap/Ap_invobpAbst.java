...
public abstract class Ap_invobpAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Ap_invobp";

    public static final String TABLE = "ap_invobp";
    ...
    public static final String PROPERTY_PAYMTNUM = "paymtnum";
    ...
    public static final String PROPERTY_VENDCODETO = "vendcodeto";
    ...
    public Ap_invobpAbst() throws CodeException {
        loadNew();
    }
    
    public Ap_invobpAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Ap_invobpAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Ap_invobpAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Ap_invobpAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Ap_invobpAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           paymtnum_ = rs.getString(PROPERTY_PAYMTNUM); 
           ...
           vendcodeto_ = rs.getString(PROPERTY_VENDCODETO); 
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Ap_invobpAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Ap_invobp obj = (Ap_invobp)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Ap_invobp " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from ap_invobp ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Ap_invobp " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    private void saveFields(ResultSet rs) throws CodeException {
        try {
            ...
            rs.updateString(PROPERTY_PAYMTNUM , paymtnum_ ); 
            ...
            rs.updateString(PROPERTY_VENDCODETO , vendcodeto_ ); 
    ...
    public long getID() throws CodeException {
      ...
      public void setpaymtnum(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         paymtnum_ = param; 
         _isDirty_ = true; 
      } 

      public String getpaymtnum() throws CodeException {
         if (!_isLoaded_) { read();} 
         return paymtnum_; 
      } 
      ...
      public void setvendcodeto(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         vendcodeto_ = param; 
         _isDirty_ = true; 
      } 

      public String getvendcodeto() throws CodeException {
         if (!_isLoaded_) { read();} 
         return vendcodeto_; 
      } 
    ...
    public String toString(String param) throws CodeException {
        if (param.equals(PROPERTY_ID)) { return String.valueOf(id_) ;}
           ...
           else if (param.equals(PROPERTY_PAYMTNUM)) return getpaymtnum(); 
           ...
           else if (param.equals(PROPERTY_VENDCODETO)) return getvendcodeto(); 
    ...
    public void fromString(String param, String value) throws CodeException {
        if (param.equals(PROPERTY_ID)) {
           ...
           else if (param.equals(PROPERTY_PAYMTNUM))  setpaymtnum(value); 
           ...
           else if (param.equals(PROPERTY_VENDCODETO))  setvendcodeto(value); 
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Ap_invobp : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ap_invobp : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ap_invobp : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ap_invobp : Cannot Move Last " + ex.getMessage());
       }
    }
