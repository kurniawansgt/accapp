 ...
 *    -  Ap_distsetds objs = new Ap_distsetds(0); // All Data
 *    or 
 *    - Ap_distsetds obj = new Ap_distsetds(Ap_distsetd.PROPERTY_<field>, <value>);
 *      Sample :
 *      Ap_distsetds obj = new Ap_distsetds(Ap_distsetd.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Ap_distsetds brs = new Ap_distsetds(0);

            for (Iterator<Ap_distsetd> it = brs.iterator(); it.hasNext(); ) {
                
                Ap_distsetd br = (Ap_distsetd) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAp_distsetd());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Ap_distsetd br = (Ap_distsetd) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAp_distsetd());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Ap_distsetd br = (Ap_distsetd) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAp_distsetd());
            }
 ...
 * @author windu
 */
public class Ap_distsetds  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Ap_distsetds";
    public static final String SQLNAME = Ap_distsetd.TABLE;
    public static String DEFAULTSORT = Ap_distsetd.PROPERTY_DISTCODE;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Ap_distsetd.PROPERTY_ID;
    ...
    List<Object> list;
    private Ap_distsetd parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Ap_distsetd.PRIMARYKEY, Ap_distsetd.PRIMARYKEY, "200"}, 
        {Ap_distsetd.PRIMARYKEY, Ap_distsetd.PRIMARYKEY, "200"} 
    };
    ...
    public Ap_distsetds() throws CodeException {
        this (new Ap_distsetd(NULLID));
        _isLoaded_ = true;
    }
    
    public Ap_distsetds(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ap_distsetd(ID);
        ID_ = ID;
    }
    
    public Ap_distsetds(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ap_distsetd(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Ap_distsetds(Ap_distsetd parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Ap_distsetds(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Ap_distsetds(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void add(Ap_distsetd obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Ap_distsetds obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Ap_distsetd) it.next());
        }        
    ...
    public Ap_distsetd getParent() {
        return parentObj_;
    }
    
    public void setParent(Ap_distsetd obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
                Ap_distsetd obj = (Ap_distsetd) it.next();
    ...
    public String getDefaultSort() {
        return Ap_distsetds.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Ap_distsetds.SQLNAME;
    }
