...
public abstract class Ap_payhAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Ap_payh";

    public static final String TABLE = "ap_payh";
    ...
    public static final String PROPERTY_NOREFF = "noreff";
    ...
    public static final String PROPERTY_PRNTCHECK = "prntcheck";
    ...
    public Ap_payhAbst() throws CodeException {
        loadNew();
    }
    
    public Ap_payhAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Ap_payhAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Ap_payhAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Ap_payhAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Ap_payhAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           noreff_ = rs.getString(PROPERTY_NOREFF);
           ...
           prntcheck_ = rs.getLong(PROPERTY_PRNTCHECK); 
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Ap_payhAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Ap_payh obj = (Ap_payh)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Ap_payh " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from ap_payh ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Ap_payh " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    private void saveFields(ResultSet rs) throws CodeException {
        try {
            ...
            rs.updateString(PROPERTY_NOREFF , noreff_ );
            ...
            rs.updateLong(PROPERTY_PRNTCHECK , prntcheck_ ); 
    ...
    public long getID() throws CodeException {
      ...
      public void setnoreff(String param) throws CodeException {
         if (!_isLoaded_) { read();}
         addrcode_ = param;
         _isDirty_ = true;
      }

      public String getnoreff() throws CodeException {
         if (!_isLoaded_) { read();}
         return noreff_;
      }
      ...
      public void setprntcheck(long param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         prntcheck_ = param; 
         _isDirty_ = true; 
      } 

      public long getprntcheck() throws CodeException {
         if (!_isLoaded_) { read();} 
         return prntcheck_; 
      } 
    ...
    public String toString(String param) throws CodeException {
        if (param.equals(PROPERTY_ID)) { return String.valueOf(id_) ;}
           ...
           else if (param.equals(PROPERTY_NOREFF)) return getnoreff();
           ...
           else if (param.equals(PROPERTY_PRNTCHECK)) return String.valueOf(getprntcheck()); 
    ...
    public void fromString(String param, String value) throws CodeException {
        if (param.equals(PROPERTY_ID)) {
           ...
           else if (param.equals(PROPERTY_NOREFF))  setnoreff(value);
           ...
           else if (param.equals(PROPERTY_PRNTCHECK)) { 
                    long newVal; 
                    try { 
                          newVal = Long.parseLong(value); 
                          setprntcheck(newVal); 
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Ap_payh : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ap_payh : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ap_payh : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ap_payh : Cannot Move Last " + ex.getMessage());
       }
    }
