...
public abstract class Ap_adjbatchlistAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Ap_adjbatchlist";

    public static final String TABLE = "ap_adjbatchlist";
    ...
    public Ap_adjbatchlistAbst() throws CodeException {
        loadNew();
    }
    
    public Ap_adjbatchlistAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Ap_adjbatchlistAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Ap_adjbatchlistAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Ap_adjbatchlistAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Ap_adjbatchlistAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Ap_adjbatchlistAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Ap_adjbatchlist obj = (Ap_adjbatchlist)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Ap_adjbatchlist " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from ap_adjbatchlist ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Ap_adjbatchlist " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        Ap_adjbatchlist obj = (Ap_adjbatchlist) jCob;
        id_ = obj.getID();
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Ap_adjbatchlist : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ap_adjbatchlist : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ap_adjbatchlist : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ap_adjbatchlist : Cannot Move Last " + ex.getMessage());
       }
    }
