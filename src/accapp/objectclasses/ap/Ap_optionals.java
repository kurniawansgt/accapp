 ...
 *    -  Ap_optionals objs = new Ap_optionals(0); // All Data
 *    or 
 *    - Ap_optionals obj = new Ap_optionals(Ap_optional.PROPERTY_<field>, <value>);
 *      Sample :
 *      Ap_optionals obj = new Ap_optionals(Ap_optional.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Ap_optionals brs = new Ap_optionals(0);

            for (Iterator<Ap_optional> it = brs.iterator(); it.hasNext(); ) {
                
                Ap_optional br = (Ap_optional) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAp_optional());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Ap_optional br = (Ap_optional) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAp_optional());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Ap_optional br = (Ap_optional) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAp_optional());
            }
 ...
 * @author windu
 */
public class Ap_optionals  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Ap_optionals";
    public static final String SQLNAME = Ap_optional.TABLE;
    public static String DEFAULTSORT = Ap_optional.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Ap_optional.PROPERTY_ID;
    ...
    List<Object> list;
    private Ap_optional parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Ap_optional.PRIMARYKEY, Ap_optional.PRIMARYKEY, "200"}, 
        {Ap_optional.PRIMARYKEY, Ap_optional.PRIMARYKEY, "200"} 
    };
    ...
    public Ap_optionals() throws CodeException {
        this (new Ap_optional(NULLID));
        _isLoaded_ = true;
    }
    
    public Ap_optionals(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ap_optional(ID);
        ID_ = ID;
    }
    
    public Ap_optionals(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ap_optional(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Ap_optionals(Ap_optional parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Ap_optionals(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Ap_optionals(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void add(Ap_optional obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Ap_optionals obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Ap_optional) it.next());
        }        
    ...
    public Ap_optional getParent() {
        return parentObj_;
    }
    
    public void setParent(Ap_optional obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Ap_optional obj = (Ap_optional) it.next();
    ...
    public String getDefaultSort() {
        return Ap_optionals.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Ap_optionals.SQLNAME;
    }
