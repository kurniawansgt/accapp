...
import static accapp.objectclasses.ar.Ar_invhAbst.PROPERTY_NOMATERIALRECEIVE;
...
public abstract class Ap_invhAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Ap_invh";

    public static final String TABLE = "ap_invh";
    ...
    public static final String PROPERTY_DOCTYPEAPPLTO = "doctypeapplto";
    ...
    public static final String PROPERTY_UNDISTAMT = "undistamt";
    public static final String PROPERTY_NETPAYAMT = "netpayamt";
    ...
    private double undistamt_;
    private double netpayamt_;
    ...
    public Ap_invhAbst() throws CodeException {
        loadNew();
    }
    
    public Ap_invhAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Ap_invhAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Ap_invhAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Ap_invhAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Ap_invhAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           doctypeapplto_ = rs.getString(PROPERTY_DOCTYPEAPPLTO); 
           ...
           undistamt_ = rs.getDouble(PROPERTY_UNDISTAMT); 
           netpayamt_ = rs.getDouble(PROPERTY_NETPAYAMT); 
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Ap_invhAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Ap_invh obj = (Ap_invh)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Ap_invh " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from ap_invh ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Ap_invh " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    private void saveFields(ResultSet rs) throws CodeException {
        try {
            ...
            rs.updateString(PROPERTY_DOCTYPEAPPLTO , doctypeapplto_ ); 
            ...
            rs.updateDouble(PROPERTY_UNDISTAMT , undistamt_ ); 
            rs.updateDouble(PROPERTY_NETPAYAMT , netpayamt_ ); 
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        ...
        id_ = obj.getID();
          ...
          doctypeapplto_ = obj.getdoctypeapplto();
          ...
          undistamt_ = obj.getundistamt();
          netpayamt_ = obj.getnetpayamt();
    ...
    public long getID() throws CodeException {
      ...
      public void setdoctypeapplto(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         doctypeapplto_ = param; 
         _isDirty_ = true; 
      } 

      public String getdoctypeapplto() throws CodeException {
         if (!_isLoaded_) { read();} 
         return doctypeapplto_; 
      } 
      ...
      public void setundistamt(double param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         undistamt_ = param; 
         _isDirty_ = true; 
      } 

      public double getundistamt() throws CodeException {
         if (!_isLoaded_) { read();} 
         return undistamt_; 
      } 

      public void setnetpayamt(double param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         netpayamt_ = param; 
         _isDirty_ = true; 
      } 

      public double getnetpayamt() throws CodeException {
         if (!_isLoaded_) { read();} 
         return netpayamt_; 
      } 
    ...
    public String toString(String param) throws CodeException {
        if (param.equals(PROPERTY_ID)) { return String.valueOf(id_) ;}
           ...
           else if (param.equals(PROPERTY_DOCTYPEAPPLTO)) return getdoctypeapplto(); 
           ...
           else if (param.equals(PROPERTY_UNDISTAMT)) return decform.format(getundistamt()); 
           else if (param.equals(PROPERTY_NETPAYAMT)) return decform.format(getnetpayamt()); 
    ...
    public void fromString(String param, String value) throws CodeException {
        if (param.equals(PROPERTY_ID)) {
           ...
           else if (param.equals(PROPERTY_DOCTYPEAPPLTO))  setdoctypeapplto(value); 
           ...
           else if (param.equals(PROPERTY_UNDISTAMT)) { 
                    double newVal; 
                    try { 
                          newVal = Double.parseDouble(value); 
                          setundistamt(newVal); 
           ...
           else if (param.equals(PROPERTY_NETPAYAMT)) { 
                    double newVal; 
                    try { 
                          newVal = Double.parseDouble(value); 
                          setnetpayamt(newVal); 
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Ap_invh : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ap_invh : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ap_invh : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ap_invh : Cannot Move Last " + ex.getMessage());
       }
    }
