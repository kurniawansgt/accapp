 ...
 *    -  Ap_invbatchlists objs = new Ap_invbatchlists(0); // All Data
 *    or 
 *    - Ap_invbatchlists obj = new Ap_invbatchlists(Ap_invbatchlist.PROPERTY_<field>, <value>);
 *      Sample :
 *      Ap_invbatchlists obj = new Ap_invbatchlists(Ap_invbatchlist.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Ap_invbatchlists brs = new Ap_invbatchlists(0);

            for (Iterator<Ap_invbatchlist> it = brs.iterator(); it.hasNext(); ) {
                
                Ap_invbatchlist br = (Ap_invbatchlist) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAp_invbatchlist());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Ap_invbatchlist br = (Ap_invbatchlist) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAp_invbatchlist());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Ap_invbatchlist br = (Ap_invbatchlist) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAp_invbatchlist());
            }
 ...
 * @author windu
 */
public class Ap_invbatchlists  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Ap_invbatchlists";
    public static final String SQLNAME = Ap_invbatchlist.TABLE;
    public static String DEFAULTSORT = Ap_invbatchlist.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Ap_invbatchlist.PROPERTY_ID;
    ...
    List<Object> list;
    private Ap_invbatchlist parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Ap_invbatchlist.PRIMARYKEY, Ap_invbatchlist.PRIMARYKEY, "200"}, 
        {Ap_invbatchlist.PROPERTY_BATCHDATE, Ap_invbatchlist.PROPERTY_BATCHDATE, "100"},
        {Ap_invbatchlist.PROPERTY_BATCHSTS, Ap_invbatchlist.PROPERTY_BATCHSTS, "100"},
        {Ap_invbatchlist.PROPERTY_BATCHDESC, Ap_invbatchlist.PROPERTY_BATCHDESC, "200"}
    };
    
    
    public String getCLASSNAME(){ return CLASSNAME; }
    
    public Ap_invbatchlists() throws CodeException {
        this (new Ap_invbatchlist(NULLID));
        _isLoaded_ = true;
    }
    
    public Ap_invbatchlists(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ap_invbatchlist(ID);
        ID_ = ID;
    }
    
    public Ap_invbatchlists(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ap_invbatchlist(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Ap_invbatchlists(Ap_invbatchlist parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Ap_invbatchlists(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Ap_invbatchlists(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void recordLoad(ResultSet rs) throws CodeException {
           ...
           try {
               while (rs.next()) {
                   list.add(new Ap_invbatchlist(rs));
               }
               _isLoaded_ = true;
               _isDirty_ = false;
           }catch (SQLException e) {
    ...
    public void add(Ap_invbatchlist obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Ap_invbatchlists obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Ap_invbatchlist) it.next());
        }        
    ...
    public Ap_invbatchlist getParent() {
        return parentObj_;
    }
    
    public void setParent(Ap_invbatchlist obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
                Ap_invbatchlist obj = (Ap_invbatchlist) it.next();
    ...
    public String getDefaultSort() {
        return Ap_invbatchlists.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Ap_invbatchlists.SQLNAME;
    }
    ...
    public void searchData(String batchno) throws CodeException {
        ...
        if (batchno.equalsIgnoreCase("")){
            query = " select * from ap_invbatchlist order by batchno";
        } else {
            query = " select * from ap_invbatchlist where batchno>='"+batchno+"' order by batchno";
        }
        try {
