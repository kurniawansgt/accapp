...
public abstract class Ap_distsetdAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Ap_distsetd";

    public static final String TABLE = "ap_distsetd";
    ...
    public Ap_distsetdAbst() throws CodeException {
        loadNew();
    }
    
    public Ap_distsetdAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Ap_distsetdAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Ap_distsetdAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Ap_distsetdAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Ap_distsetdAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Ap_distsetdAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Ap_distsetd obj = (Ap_distsetd)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Ap_distsetd " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from ap_distsetd ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Ap_distsetd " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        Ap_distsetd obj = (Ap_distsetd) jCob;
        id_ = obj.getID();
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Ap_distsetd : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ap_distsetd : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ap_distsetd : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ap_distsetd : Cannot Move Last " + ex.getMessage());
       }
    }
