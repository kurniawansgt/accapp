...
public abstract class Ap_invoblAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Ap_invobl";

    public static final String TABLE = "ap_invobl";
    ...
    public static final String PROPERTY_PAYMTNO = "paymtno";
    ...
    public Ap_invoblAbst() throws CodeException {
        loadNew();
    }
    
    public Ap_invoblAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Ap_invoblAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Ap_invoblAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Ap_invoblAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Ap_invoblAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           paymtno_ = rs.getString(PROPERTY_PAYMTNO); 
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Ap_invoblAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Ap_invobl obj = (Ap_invobl)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Ap_invobl " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from ap_invobl ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Ap_invobl " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    private void saveFields(ResultSet rs) throws CodeException {
        try {
            ...
            rs.updateString(PROPERTY_PAYMTNO , paymtno_ ); 
    ...
    public long getID() throws CodeException {
      ...
      public void setpaymtno(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         paymtno_ = param; 
         _isDirty_ = true; 
      } 

      public String getpaymtno() throws CodeException {
         if (!_isLoaded_) { read();} 
         return paymtno_; 
      } 
    ...
    public String toString(String param) throws CodeException {
        if (param.equals(PROPERTY_ID)) { return String.valueOf(id_) ;}
           ...
           else if (param.equals(PROPERTY_PAYMTNO)) return getpaymtno(); 
    ...
    public void fromString(String param, String value) throws CodeException {
        if (param.equals(PROPERTY_ID)) {
           ...
           else if (param.equals(PROPERTY_PAYMTNO))  setpaymtno(value); 
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Ap_invobl : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ap_invobl : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ap_invobl : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ap_invobl : Cannot Move Last " + ex.getMessage());
       }
    }
