 ...
 *    -  Ap_vendorstss objs = new Ap_vendorstss(0); // All Data
 *    or 
 *    - Ap_vendorstss obj = new Ap_vendorstss(Ap_vendorsts.PROPERTY_<field>, <value>);
 *      Sample :
 *      Ap_vendorstss obj = new Ap_vendorstss(Ap_vendorsts.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Ap_vendorstss brs = new Ap_vendorstss(0);

            for (Iterator<Ap_vendorsts> it = brs.iterator(); it.hasNext(); ) {
                
                Ap_vendorsts br = (Ap_vendorsts) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAp_vendorsts());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Ap_vendorsts br = (Ap_vendorsts) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAp_vendorsts());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Ap_vendorsts br = (Ap_vendorsts) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAp_vendorsts());
            }
 ...
 * @author windu
 */
public class Ap_vendorstss  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Ap_vendorstss";
    public static final String SQLNAME = Ap_vendorsts.TABLE;
    public static String DEFAULTSORT = Ap_vendorsts.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Ap_vendorsts.PROPERTY_ID;
    ...
    List<Object> list;
    private Ap_vendorsts parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Ap_vendorsts.PRIMARYKEY, Ap_vendorsts.PRIMARYKEY, "200"}, 
        {Ap_vendorsts.PRIMARYKEY, Ap_vendorsts.PRIMARYKEY, "200"} 
    };
    ...
    public Ap_vendorstss() throws CodeException {
        this (new Ap_vendorsts(NULLID));
        _isLoaded_ = true;
    }
    
    public Ap_vendorstss(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ap_vendorsts(ID);
        ID_ = ID;
    }
    
    public Ap_vendorstss(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ap_vendorsts(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Ap_vendorstss(Ap_vendorsts parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Ap_vendorstss(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Ap_vendorstss(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void add(Ap_vendorsts obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Ap_vendorstss obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Ap_vendorsts) it.next());
        }        
    ...
    public Ap_vendorsts getParent() {
        return parentObj_;
    }
    
    public void setParent(Ap_vendorsts obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
                Ap_vendorsts obj = (Ap_vendorsts) it.next();
    ...
    public String getDefaultSort() {
        return Ap_vendorstss.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Ap_vendorstss.SQLNAME;
    }
