 ...
 *    -  Ap_optionaldetail1s objs = new Ap_optionaldetail1s(0); // All Data
 *    or 
 *    - Ap_optionaldetail1s obj = new Ap_optionaldetail1s(Ap_optionaldetail1.PROPERTY_<field>, <value>);
 *      Sample :
 *      Ap_optionaldetail1s obj = new Ap_optionaldetail1s(Ap_optionaldetail1.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Ap_optionaldetail1s brs = new Ap_optionaldetail1s(0);

            for (Iterator<Ap_optionaldetail1> it = brs.iterator(); it.hasNext(); ) {
                
                Ap_optionaldetail1 br = (Ap_optionaldetail1) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAp_optionaldetail1());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Ap_optionaldetail1 br = (Ap_optionaldetail1) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAp_optionaldetail1());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Ap_optionaldetail1 br = (Ap_optionaldetail1) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAp_optionaldetail1());
            }
 ...
 * @author windu
 */
public class Ap_optionaldetail1s  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Ap_optionaldetail1s";
    public static final String SQLNAME = Ap_optionaldetail1.TABLE;
    public static String DEFAULTSORT = Ap_optionaldetail1.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Ap_optionaldetail1.PROPERTY_ID;
    ...
    List<Object> list;
    private Ap_optionaldetail1 parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Ap_optionaldetail1.PRIMARYKEY, Ap_optionaldetail1.PRIMARYKEY, "200"}, 
        {Ap_optionaldetail1.PRIMARYKEY, Ap_optionaldetail1.PRIMARYKEY, "200"} 
    };
    ...
    public Ap_optionaldetail1s() throws CodeException {
        this (new Ap_optionaldetail1(NULLID));
        _isLoaded_ = true;
    }
    
    public Ap_optionaldetail1s(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ap_optionaldetail1(ID);
        ID_ = ID;
    }
    
    public Ap_optionaldetail1s(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ap_optionaldetail1(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Ap_optionaldetail1s(Ap_optionaldetail1 parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Ap_optionaldetail1s(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Ap_optionaldetail1s(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void recordLoad(ResultSet rs) throws CodeException {
           ...
           try {
               while (rs.next()) {
                   list.add(new Ap_optionaldetail1(rs));
               }
               _isLoaded_ = true;
               _isDirty_ = false;
           }catch (SQLException e) {
    ...
    public void add(Ap_optionaldetail1 obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Ap_optionaldetail1s obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Ap_optionaldetail1) it.next());
        }        
    ...
    public Ap_optionaldetail1 getParent() {
        return parentObj_;
    }
    
    public void setParent(Ap_optionaldetail1 obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Ap_optionaldetail1 obj = (Ap_optionaldetail1) it.next();
    ...
    public String getDefaultSort() {
        return Ap_optionaldetail1s.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Ap_optionaldetail1s.SQLNAME;
    }
