 ...
 *    -  Ap_vendgrpstss objs = new Ap_vendgrpstss(0); // All Data
 *    or 
 *    - Ap_vendgrpstss obj = new Ap_vendgrpstss(Ap_vendgrpsts.PROPERTY_<field>, <value>);
 *      Sample :
 *      Ap_vendgrpstss obj = new Ap_vendgrpstss(Ap_vendgrpsts.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Ap_vendgrpstss brs = new Ap_vendgrpstss(0);

            for (Iterator<Ap_vendgrpsts> it = brs.iterator(); it.hasNext(); ) {
                
                Ap_vendgrpsts br = (Ap_vendgrpsts) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAp_vendgrpsts());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Ap_vendgrpsts br = (Ap_vendgrpsts) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAp_vendgrpsts());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Ap_vendgrpsts br = (Ap_vendgrpsts) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAp_vendgrpsts());
            }
 ...
 * @author windu
 */
public class Ap_vendgrpstss  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Ap_vendgrpstss";
    public static final String SQLNAME = Ap_vendgrpsts.TABLE;
    public static String DEFAULTSORT = Ap_vendgrpsts.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Ap_vendgrpsts.PROPERTY_ID;
    ...
    List<Object> list;
    private Ap_vendgrpsts parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Ap_vendgrpsts.PRIMARYKEY, Ap_vendgrpsts.PRIMARYKEY, "200"}, 
        {Ap_vendgrpsts.PRIMARYKEY, Ap_vendgrpsts.PRIMARYKEY, "200"} 
    };
    ...
    public Ap_vendgrpstss() throws CodeException {
        this (new Ap_vendgrpsts(NULLID));
        _isLoaded_ = true;
    }
    
    public Ap_vendgrpstss(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ap_vendgrpsts(ID);
        ID_ = ID;
    }
    
    public Ap_vendgrpstss(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ap_vendgrpsts(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Ap_vendgrpstss(Ap_vendgrpsts parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Ap_vendgrpstss(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Ap_vendgrpstss(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void add(Ap_vendgrpsts obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Ap_vendgrpstss obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Ap_vendgrpsts) it.next());
        }        
    ...
    public Ap_vendgrpsts getParent() {
        return parentObj_;
    }
    
    public void setParent(Ap_vendgrpsts obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
                Ap_vendgrpsts obj = (Ap_vendgrpsts) it.next();
    ...
    public String getDefaultSort() {
        return Ap_vendgrpstss.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Ap_vendgrpstss.SQLNAME;
    }
