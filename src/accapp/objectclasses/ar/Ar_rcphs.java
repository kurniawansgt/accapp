 ...
 *    -  Ar_rcphs objs = new Ar_rcphs(0); // All Data
 *    or 
 *    - Ar_rcphs obj = new Ar_rcphs(Ar_rcph.PROPERTY_<field>, <value>);
 *      Sample :
 *      Ar_rcphs obj = new Ar_rcphs(Ar_rcph.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Ar_rcphs brs = new Ar_rcphs(0);

            for (Iterator<Ar_rcph> it = brs.iterator(); it.hasNext(); ) {
                
                Ar_rcph br = (Ar_rcph) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAr_rcph());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Ar_rcph br = (Ar_rcph) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAr_rcph());
            }
 ...
 * @author windu
 */
public class Ar_rcphs  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Ar_rcphs";
    public static final String SQLNAME = Ar_rcph.TABLE;
    public static String DEFAULTSORT = Ar_rcph.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Ar_rcph.PROPERTY_ID;
    ...
    private String[][] column = {
        {Ar_rcph.PRIMARYKEY, Ar_rcph.PRIMARYKEY, "200"}, 
        {Ar_rcph.PRIMARYKEY, Ar_rcph.PRIMARYKEY, "200"} 
    };
    ...
    public Ar_rcphs() throws CodeException {
        this (new Ar_rcph(NULLID));
        _isLoaded_ = true;
    }
    
    public Ar_rcphs(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ar_rcph(ID);
        ID_ = ID;
    }
    
    public Ar_rcphs(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ar_rcph(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Ar_rcphs(Ar_rcph parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Ar_rcphs(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Ar_rcphs(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void add(Ar_rcph obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Ar_rcphs obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
    ...
    public Ar_rcph getParent() {
        return parentObj_;
    }
    
    public void setParent(Ar_rcph obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public String getDefaultSort() {
        return Ar_rcphs.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Ar_rcphs.SQLNAME;
    }
