...
public abstract class Ar_billcyclAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Ar_billcycl";

    public static final String TABLE = "ar_billcycl";
    ...
    public static final String PROPERTY_DSCRITION = "dscrition";
    public static final String PROPERTY_ACTIVE = "active";
    public static final String PROPERTY_DAYSCYCL = "dayscycl";
    ...
    public static final String PROPERTY_CMPNYID = "cmpnyid";
     ...
     public static final String PRIMARYKEY = PROPERTY_CYCLCODE;
    
    
    private long id_;
    private String cyclcode_;
    private String dscrition_;
    private long active_;
    private double dayscycl_;
    ...
    public Ar_billcyclAbst() throws CodeException {
        loadNew();
    }
    
    public Ar_billcyclAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Ar_billcyclAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Ar_billcyclAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Ar_billcyclAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Ar_billcyclAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           dscrition_ = rs.getString(PROPERTY_DSCRITION); 
           active_ = rs.getLong(PROPERTY_ACTIVE); 
           dayscycl_ = rs.getDouble(PROPERTY_DAYSCYCL); 
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Ar_billcyclAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Ar_billcycl obj = (Ar_billcycl)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Ar_billcycl " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void checkNotNullFields() throws CodeException {
        Object o;
         ...
         o = getcyclcode(); 
        if (o == null) { 
            throw new CodeException ("Error Saving Application : cyclcode can not be Empty"); 
        } 
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from ar_billcycl ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Ar_billcycl " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    private void saveFields(ResultSet rs) throws CodeException {
        try {
            ...
            rs.updateString(PROPERTY_DSCRITION , dscrition_ ); 
            rs.updateLong(PROPERTY_ACTIVE , active_ ); 
            rs.updateDouble(PROPERTY_DAYSCYCL , dayscycl_ ); 
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        Ar_billcycl obj = (Ar_billcycl) jCob;
        id_ = obj.getID();

        
          cyclcode_ = obj.getcyclcode();
          dscrition_ = obj.getdscrition();
          active_ = obj.getactive();
          dayscycl_ = obj.getdayscycl();
    ...
    public long getID() throws CodeException {
      ...
      public void setdscrition(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         dscrition_ = param; 
         _isDirty_ = true; 
      } 

      public String getdscrition() throws CodeException {
         if (!_isLoaded_) { read();} 
         return dscrition_; 
      } 
      ...
      public void setdayscycl(double param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         dayscycl_ = param; 
         _isDirty_ = true; 
      } 

      public double getdayscycl() throws CodeException {
         if (!_isLoaded_) { read();} 
         return dayscycl_; 
      } 
    ...
    public String toString(String param) throws CodeException {
        if (param.equals(PROPERTY_ID)) { return String.valueOf(id_) ;}
           ...
           else if (param.equals(PROPERTY_DSCRITION)) return getdscrition(); 
           else if (param.equals(PROPERTY_ACTIVE)) return String.valueOf(getactive()); 
           else if (param.equals(PROPERTY_DAYSCYCL)) return decform.format(getdayscycl()); 
    ...
    public void fromString(String param, String value) throws CodeException {
        if (param.equals(PROPERTY_ID)) {
           ...
           else if (param.equals(PROPERTY_DSCRITION))  setdscrition(value); 
           ...
           else if (param.equals(PROPERTY_DAYSCYCL)) { 
                    double newVal; 
                    try { 
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Ar_billcycl : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            DbBean db = DbBean.connect();
            ResultSet rs = db.movePrevious(TABLEPROCESS, PRIMARYKEY, cyclcode_+"");
            if (rs.next()) {
                load(rs);
            }
            db.close();
        } catch (SQLException ex) {
             throw new CodeException("Ar_billcycl : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            DbBean db = DbBean.connect();
            ResultSet rs = db.moveNext(TABLEPROCESS, PRIMARYKEY, cyclcode_+"");
            if (rs.next()) {
                load(rs);
            }
            db.close();
        } catch (SQLException ex) {
             throw new CodeException("Ar_billcycl : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ar_billcycl : Cannot Move Last " + ex.getMessage());
       }
    }
