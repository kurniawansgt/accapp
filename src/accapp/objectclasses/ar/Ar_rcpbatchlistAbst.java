...
public abstract class Ar_rcpbatchlistAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Ar_rcpbatchlist";

    public static final String TABLE = "ar_rcpbatchlist";
    ...
    public static final String PROPERTY_TOTRCPAMT = "totrcpamt";
    public static final String PROPERTY_RCPENTRCNT = "rcpentrcnt";
    ...
    private double totrcpamt_;
    private long rcpentrcnt_;
    ...
    public Ar_rcpbatchlistAbst() throws CodeException {
        loadNew();
    }
    
    public Ar_rcpbatchlistAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Ar_rcpbatchlistAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Ar_rcpbatchlistAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Ar_rcpbatchlistAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Ar_rcpbatchlistAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           totrcpamt_ = rs.getDouble(PROPERTY_TOTRCPAMT); 
           rcpentrcnt_ = rs.getLong(PROPERTY_RCPENTRCNT); 
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Ar_rcpbatchlistAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Ar_rcpbatchlist obj = (Ar_rcpbatchlist)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Ar_rcpbatchlist " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from ar_rcpbatchlist ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Ar_rcpbatchlist " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    private void saveFields(ResultSet rs) throws CodeException {
        try {
            ...
            rs.updateDouble(PROPERTY_TOTRCPAMT , totrcpamt_ ); 
            rs.updateLong(PROPERTY_RCPENTRCNT , rcpentrcnt_ ); 
            ...
            rs.updateDouble(PROPERTY_POSTNGSEQ , glpostngseq_ );
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        Ar_rcpbatchlist obj = (Ar_rcpbatchlist) jCob;
        id_ = obj.getID();
          ...
          totrcpamt_ = obj.gettotrcpamt();
          rcpentrcnt_ = obj.getrcpentrcnt();
    ...
    public long getID() throws CodeException {
      ...
      public void settotrcpamt(double param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         totrcpamt_ = param; 
         _isDirty_ = true; 
      } 

      public double gettotrcpamt() throws CodeException {
         if (!_isLoaded_) { read();} 
         return totrcpamt_; 
      } 

      public void setrcpentrcnt(long param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         rcpentrcnt_ = param; 
         _isDirty_ = true; 
      } 

      public long getrcpentrcnt() throws CodeException {
         if (!_isLoaded_) { read();} 
         return rcpentrcnt_; 
      } 
    ...
    public String toString(String param) throws CodeException {
        if (param.equals(PROPERTY_ID)) { return String.valueOf(id_) ;}
           ...
           else if (param.equals(PROPERTY_TOTRCPAMT)) return decform.format(gettotrcpamt()); 
           else if (param.equals(PROPERTY_RCPENTRCNT)) return String.valueOf(getrcpentrcnt()); 
    ...
    public void fromString(String param, String value) throws CodeException {
        if (param.equals(PROPERTY_ID)) {
           ...
           else if (param.equals(PROPERTY_TOTRCPAMT)) { 
                    double newVal; 
                    try { 
           ...
           else if (param.equals(PROPERTY_RCPENTRCNT)) { 
                    long newVal; 
                    try { 
                          newVal = Long.parseLong(value); 
                          setrcpentrcnt(newVal); 
                    } catch (NumberFormatException nfe){ 
                      throw new CodeException("Unrecognised Number format: "+nfe.getMessage(),nfe); 
                    }
           }
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Ar_rcpbatchlist : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ar_rcpbatchlist : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ar_rcpbatchlist : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ar_rcpbatchlist : Cannot Move Last " + ex.getMessage());
       }
    }
