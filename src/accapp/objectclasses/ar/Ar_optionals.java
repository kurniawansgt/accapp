 ...
 *    -  Ar_optionals objs = new Ar_optionals(0); // All Data
 *    or 
 *    - Ar_optionals obj = new Ar_optionals(Ar_optional.PROPERTY_<field>, <value>);
 *      Sample :
 *      Ar_optionals obj = new Ar_optionals(Ar_optional.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Ar_optionals brs = new Ar_optionals(0);

            for (Iterator<Ar_optional> it = brs.iterator(); it.hasNext(); ) {
                
                Ar_optional br = (Ar_optional) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAr_optional());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Ar_optional br = (Ar_optional) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAr_optional());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Ar_optional br = (Ar_optional) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAr_optional());
            }
 ...
 * @author windu
 */
public class Ar_optionals  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Ar_optionals";
    public static final String SQLNAME = Ar_optional.TABLE;
    public static String DEFAULTSORT = Ar_optional.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Ar_optional.PROPERTY_ID;
    ...
    List<Object> list;
    private Ar_optional parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Ar_optional.PRIMARYKEY, Ar_optional.PRIMARYKEY, "200"}, 
        {Ar_optional.PRIMARYKEY, Ar_optional.PRIMARYKEY, "200"} 
    };
    ...
    public Ar_optionals() throws CodeException {
        this (new Ar_optional(NULLID));
        _isLoaded_ = true;
    }
    
    public Ar_optionals(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ar_optional(ID);
        ID_ = ID;
    }
    
    public Ar_optionals(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ar_optional(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Ar_optionals(Ar_optional parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Ar_optionals(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Ar_optionals(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void add(Ar_optional obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Ar_optionals obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Ar_optional) it.next());
        }        
    ...
    public Ar_optional getParent() {
        return parentObj_;
    }
    
    public void setParent(Ar_optional obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Ar_optional obj = (Ar_optional) it.next();
    ...
    public String getDefaultSort() {
        return Ar_optionals.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Ar_optionals.SQLNAME;
    }
