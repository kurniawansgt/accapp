...
public abstract class Ar_accsetAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Ar_accset";

    public static final String TABLE = "ar_accset";
    ...
    public static final String PROPERTY_ARACCCODE = "aracccode";
    ...
    public static final String PROPERTY_WROFACCCODE = "wrofacccode";
    ...
    public Ar_accsetAbst() throws CodeException {
        loadNew();
    }
    
    public Ar_accsetAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Ar_accsetAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Ar_accsetAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Ar_accsetAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Ar_accsetAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Ar_accsetAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Ar_accset obj = (Ar_accset)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Ar_accset " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from ar_accset ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Ar_accset " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    public long getID() throws CodeException {
      ...
      public void setaracccode(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         aracccode_ = param; 
         _isDirty_ = true; 
      } 

      public String getaracccode() throws CodeException {
         if (!_isLoaded_) { read();} 
         return aracccode_; 
      } 
      ...
      public void setwrofacccode(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         wrofacccode_ = param; 
         _isDirty_ = true; 
      } 

      public String getwrofacccode() throws CodeException {
         if (!_isLoaded_) { read();} 
         return wrofacccode_; 
      } 
    ...
    public String toString(String param) throws CodeException {
        if (param.equals(PROPERTY_ID)) { return String.valueOf(id_) ;}
           ...
           else if (param.equals(PROPERTY_ARACCCODE)) return getaracccode(); 
           ...
           else if (param.equals(PROPERTY_WROFACCCODE)) return getwrofacccode(); 
    ...
    public void fromString(String param, String value) throws CodeException {
        if (param.equals(PROPERTY_ID)) {
           ...
           else if (param.equals(PROPERTY_ARACCCODE))  setaracccode(value); 
           ...
           else if (param.equals(PROPERTY_WROFACCCODE))  setwrofacccode(value); 
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Ar_accset : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ar_accset : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ar_accset : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ar_accset : Cannot Move Last " + ex.getMessage());
       }
    }
