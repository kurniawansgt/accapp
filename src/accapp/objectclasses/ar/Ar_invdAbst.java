...
public abstract class Ar_invdAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Ar_invd";

    public static final String TABLE = "ar_invd";
    ...
    public static final String PROPERTY_ACCREVCODE = "accrevcode";
    public static final String PROPERTY_ACCREVDSCRIPTION = "accrevdscription";
    public static final String PROPERTY_ACCINVCODE = "accinvcode";
    ...
    private String accrevcode_;
    private String accrevdscription_;
    private String accinvcode_;
    ...
    public Ar_invdAbst() throws CodeException {
        loadNew();
    }
    
    public Ar_invdAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Ar_invdAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Ar_invdAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Ar_invdAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Ar_invdAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           accrevcode_ = rs.getString(PROPERTY_ACCREVCODE); 
           accrevdscription_ = rs.getString(PROPERTY_ACCREVDSCRIPTION); 
           accinvcode_ = rs.getString(PROPERTY_ACCINVCODE); 
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Ar_invdAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Ar_invd obj = (Ar_invd)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Ar_invd " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from ar_invd ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Ar_invd " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    private void saveFields(ResultSet rs) throws CodeException {
        try {
            ...
            rs.updateString(PROPERTY_ACCREVCODE , accrevcode_ ); 
            rs.updateString(PROPERTY_ACCREVDSCRIPTION , accrevdscription_ ); 
            rs.updateString(PROPERTY_ACCINVCODE , accinvcode_ ); 
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        ...
        id_ = obj.getID();
          ...
          accrevcode_ = obj.getaccrevcode();
          accrevdscription_ = obj.getaccrevdscription();
          accinvcode_ = obj.getaccinvcode();
    ...
    public long getID() throws CodeException {
      ...
      public String getaccrevcode() throws CodeException {
         if (!_isLoaded_) { read();} 
         return accrevcode_; 
      } 

      public void setaccrevdscription(String param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         accrevdscription_ = param; 
         _isDirty_ = true; 
      } 

      public String getaccrevdscription() throws CodeException {
         if (!_isLoaded_) { read();} 
         return accrevdscription_; 
      } 
      ...
      public String getaccinvcode() throws CodeException {
         if (!_isLoaded_) { read();} 
         return accinvcode_; 
      } 
    ...
    public String toString(String param) throws CodeException {
        if (param.equals(PROPERTY_ID)) { return String.valueOf(id_) ;}
           ...
           else if (param.equals(PROPERTY_ACCREVCODE)) return getaccrevcode(); 
           else if (param.equals(PROPERTY_ACCREVDSCRIPTION)) return getaccrevdscription(); 
           else if (param.equals(PROPERTY_ACCINVCODE)) return getaccinvcode(); 
    ...
    public void fromString(String param, String value) throws CodeException {
        if (param.equals(PROPERTY_ID)) {
           ...
           else if (param.equals(PROPERTY_ACCREVCODE))  setaccrevcode(value); 
           else if (param.equals(PROPERTY_ACCREVDSCRIPTION))  setaccrevdscription(value); 
           else if (param.equals(PROPERTY_ACCINVCODE))  setaccinvcode(value); 
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Ar_invd : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ar_invd : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ar_invd : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ar_invd : Cannot Move Last " + ex.getMessage());
       }
    }
