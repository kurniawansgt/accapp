...
public abstract class Ar_customerstsAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Ar_customersts";

    public static final String TABLE = "ar_customersts";
    ...
    public Ar_customerstsAbst() throws CodeException {
        loadNew();
    }
    
    public Ar_customerstsAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Ar_customerstsAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Ar_customerstsAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Ar_customerstsAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Ar_customerstsAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Ar_customerstsAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Ar_customersts obj = (Ar_customersts)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Ar_customersts " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from ar_customersts ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Ar_customersts " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        Ar_customersts obj = (Ar_customersts) jCob;
        id_ = obj.getID();
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Ar_customersts : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ar_customersts : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ar_customersts : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ar_customersts : Cannot Move Last " + ex.getMessage());
       }
    }
