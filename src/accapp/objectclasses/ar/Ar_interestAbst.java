...
public abstract class Ar_interestAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Ar_interest";

    public static final String TABLE = "ar_interest";
    ...
    public static final String PROPERTY_DUEDAYS = "duedays";
    ...
    public static final String PROPERTY_CMPNYID = "cmpnyid";
     ...
     public static final String PRIMARYKEY = PROPERTY_INTRSCHRCODE;
    ...
    public Ar_interestAbst() throws CodeException {
        loadNew();
    }
    
    public Ar_interestAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Ar_interestAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Ar_interestAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Ar_interestAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Ar_interestAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           duedays_ = rs.getDouble(PROPERTY_DUEDAYS); 
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Ar_interestAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Ar_interest obj = (Ar_interest)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Ar_interest " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void checkNotNullFields() throws CodeException {
        Object o;
         ...
         o = getintrschrcode(); 
        if (o == null) { 
            throw new CodeException ("Error Saving Application : intrschrcode can not be Empty"); 
        } 
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from ar_interest ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Ar_interest " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    private void saveFields(ResultSet rs) throws CodeException {
        try {
            ...
            rs.updateDouble(PROPERTY_DUEDAYS , duedays_ ); 
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        Ar_interest obj = (Ar_interest) jCob;
        id_ = obj.getID();
    ...
    public long getID() throws CodeException {
      ...
      public void setduedays(double param) throws CodeException { 
         if (!_isLoaded_) { read();} 
         duedays_ = param; 
         _isDirty_ = true; 
      } 

      public double getduedays() throws CodeException {
         if (!_isLoaded_) { read();} 
         return duedays_; 
      } 
    ...
    public String toString(String param) throws CodeException {
        if (param.equals(PROPERTY_ID)) { return String.valueOf(id_) ;}
           ...
           else if (param.equals(PROPERTY_DUEDAYS)) return decform.format(getduedays()); 
    ...
    public void fromString(String param, String value) throws CodeException {
        if (param.equals(PROPERTY_ID)) {
           ...
           else if (param.equals(PROPERTY_DUEDAYS)) { 
                    double newVal; 
                    try { 
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Ar_interest : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            DbBean db = DbBean.connect();
            ResultSet rs = db.movePrevious(TABLEPROCESS, PRIMARYKEY, intrschrcode_+"");
            if (rs.next()) {
                load(rs);
            }
            db.close();
        } catch (SQLException ex) {
             throw new CodeException("Ar_interest : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            DbBean db = DbBean.connect();
            ResultSet rs = db.moveNext(TABLEPROCESS, PRIMARYKEY, intrschrcode_+"");
            if (rs.next()) {
                load(rs);
            }
            db.close();
        } catch (SQLException ex) {
             throw new CodeException("Ar_interest : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ar_interest : Cannot Move Last " + ex.getMessage());
       }
    }
