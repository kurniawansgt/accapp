 ...
 *    -  Ar_optiionaldetail1s objs = new Ar_optiionaldetail1s(0); // All Data
 *    or 
 *    - Ar_optiionaldetail1s obj = new Ar_optiionaldetail1s(Ar_optiionaldetail1.PROPERTY_<field>, <value>);
 *      Sample :
 *      Ar_optiionaldetail1s obj = new Ar_optiionaldetail1s(Ar_optiionaldetail1.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Ar_optiionaldetail1s brs = new Ar_optiionaldetail1s(0);

            for (Iterator<Ar_optiionaldetail1> it = brs.iterator(); it.hasNext(); ) {
                
                Ar_optiionaldetail1 br = (Ar_optiionaldetail1) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAr_optiionaldetail1());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Ar_optiionaldetail1 br = (Ar_optiionaldetail1) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAr_optiionaldetail1());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Ar_optiionaldetail1 br = (Ar_optiionaldetail1) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAr_optiionaldetail1());
            }
 ...
 * @author windu
 */
public class Ar_optiionaldetail1s  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Ar_optiionaldetail1s";
    public static final String SQLNAME = Ar_optiionaldetail1.TABLE;
    public static String DEFAULTSORT = Ar_optiionaldetail1.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Ar_optiionaldetail1.PROPERTY_ID;
    ...
    List<Object> list;
    private Ar_optiionaldetail1 parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Ar_optiionaldetail1.PRIMARYKEY, Ar_optiionaldetail1.PRIMARYKEY, "200"}, 
        {Ar_optiionaldetail1.PROPERTY_DSCRIPTION, Ar_optiionaldetail1.PROPERTY_DSCRIPTION, "200"}
    };
    
    
    public String getCLASSNAME(){ return CLASSNAME; }
    
    public Ar_optiionaldetail1s() throws CodeException {
        this (new Ar_optiionaldetail1(NULLID));
        _isLoaded_ = true;
    }
    
    public Ar_optiionaldetail1s(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ar_optiionaldetail1(ID);
        ID_ = ID;
    }
    
    public Ar_optiionaldetail1s(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ar_optiionaldetail1(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Ar_optiionaldetail1s(Ar_optiionaldetail1 parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Ar_optiionaldetail1s(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Ar_optiionaldetail1s(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void recordLoad(ResultSet rs) throws CodeException {
           ...
           try {
               while (rs.next()) {
                   list.add(new Ar_optiionaldetail1(rs));
               }
               _isLoaded_ = true;
               _isDirty_ = false;
           }catch (SQLException e) {
    ...
    public void add(Ar_optiionaldetail1 obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Ar_optiionaldetail1s obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Ar_optiionaldetail1) it.next());
        }        
    ...
    public Ar_optiionaldetail1 getParent() {
        return parentObj_;
    }
    
    public void setParent(Ar_optiionaldetail1 obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Ar_optiionaldetail1 obj = (Ar_optiionaldetail1) it.next();
    ...
    public String getDefaultSort() {
        return Ar_optiionaldetail1s.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Ar_optiionaldetail1s.SQLNAME;
    }
