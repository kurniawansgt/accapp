...
public abstract class Ar_distcodeAbst implements CodeObjectInt, NavigatorObjectInt {
    
    public static final long NULLID = 0;
    public static final String CLASSNAME="Ar_distcode";

    public static final String TABLE = "ar_distcode";
    ...
    public static final String PROPERTY_CMPNYID = "cmpnyid";
     ...
     public static final String PRIMARYKEY = PROPERTY_DISTCODE;
    ...
    public Ar_distcodeAbst() throws CodeException {
        loadNew();
    }
    
    public Ar_distcodeAbst(long id) throws CodeException {
        loadID(id);

    }
    
    public Ar_distcodeAbst(String val)  throws CodeException {
        loadString(val);
    }
    
    public Ar_distcodeAbst (String key, String val)  throws CodeException {
        loadString(key,val);
    }
    
    public Ar_distcodeAbst(ResultSet rs) throws CodeException {
        loadRs(rs);
    }
    ...
    public void loadString(String val)  throws CodeException {
     ...
     public void loadString (String key, String val)  throws CodeException {
        ...
        try{
            ...
            throw new CodeException ("Error Create Ar_distcodeAbst for Key : " + key + " val : " + val);
        } finally {
            db.close();
        }        
    }
    ...
    private void load(ResultSet rs) throws CodeException {
        try {
           ...
           cmpnyid_ = rs.getString(PROPERTY_CMPNYID); 
            ...
            throw new CodeException ("Error Loading Ar_distcodeAbst " + e.getMessage());
        }
    }
    ...
    public void read() throws CodeException {
       if (getID() != NULLID) {
            Ar_distcode obj = (Ar_distcode)cache.get(getID());
            if (obj!=null) {
                copy(obj);
            }else{
                DbBean db = DbBean.connect();        
                ...
                try{
                    ...
                    throw new CodeException("Error Reading Ar_distcode " + e.getMessage());
                } finally {
                    db.close();
                }
            }
    ...
    public void checkNotNullFields() throws CodeException {
        Object o;
         ...
         o = getdistcode(); 
        if (o == null) { 
            throw new CodeException ("Error Saving Application : distcode can not be Empty"); 
        } 
    ...
    public void saveNew() throws CodeException {
        ...
        try {
           ...
           saveFields(rs);
           rs.insertRow();
           rs = db.retrieveSQL("SELECT max(id) from ar_distcode ");
           rs.next();
           id_ = rs.getLong(1);
           ...
           _isDirty_ = false;
            ...
            throw new CodeException("Error Save New Ar_distcode " + e.getMessage());
        }finally{
            db.close();
        }
    }
    ...
    public void copy(CodeObjectInt jCob) throws CodeException {
        Ar_distcode obj = (Ar_distcode) jCob;
        id_ = obj.getID();
    ...
    public void moveFirst() throws CodeException {
        try {
            ...
            throw new CodeException("Ar_distcode : Cannot Move First" + ex.getMessage());
        }
    }
    ...
    public void movePrevious() throws CodeException {
        try {
            DbBean db = DbBean.connect();
            ResultSet rs = db.movePrevious(TABLEPROCESS, PRIMARYKEY, distcode_+"");
            if (rs.next()) {
                load(rs);
            }
            db.close();
        } catch (SQLException ex) {
             throw new CodeException("Ar_distcode : Cannot Move Previous" + ex.getMessage());
        }
    }
    ...
    public void moveNext() throws CodeException {
        try {
            DbBean db = DbBean.connect();
            ResultSet rs = db.moveNext(TABLEPROCESS, PRIMARYKEY, distcode_+"");
            if (rs.next()) {
                load(rs);
            }
            db.close();
        } catch (SQLException ex) {
             throw new CodeException("Ar_distcode : Cannot Move Next " + ex.getMessage());
       }
    }
    ...
    public void moveLast() throws CodeException {
        try {
            ...
            db.close();
             ...
             throw new CodeException("Ar_distcode : Cannot Move Last " + ex.getMessage());
       }
    }
