 ...
 *    -  Ar_custnatstss objs = new Ar_custnatstss(0); // All Data
 *    or 
 *    - Ar_custnatstss obj = new Ar_custnatstss(Ar_custnatsts.PROPERTY_<field>, <value>);
 *      Sample :
 *      Ar_custnatstss obj = new Ar_custnatstss(Ar_custnatsts.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Ar_custnatstss brs = new Ar_custnatstss(0);

            for (Iterator<Ar_custnatsts> it = brs.iterator(); it.hasNext(); ) {
                
                Ar_custnatsts br = (Ar_custnatsts) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAr_custnatsts());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Ar_custnatsts br = (Ar_custnatsts) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAr_custnatsts());
            }
       ...
       try {
            ...
            for (Object Obj : list) {
                Ar_custnatsts br = (Ar_custnatsts) obj;
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAr_custnatsts());
            }
 ...
 * @author windu
 */
public class Ar_custnatstss  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Ar_custnatstss";
    public static final String SQLNAME = Ar_custnatsts.TABLE;
    public static String DEFAULTSORT = Ar_custnatsts.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Ar_custnatsts.PROPERTY_ID;
    ...
    List<Object> list;
    private Ar_custnatsts parentObj_;
    private long ID_;
    ...
    private String[][] column = {
        {Ar_custnatsts.PRIMARYKEY, Ar_custnatsts.PRIMARYKEY, "200"}, 
        {Ar_custnatsts.PRIMARYKEY, Ar_custnatsts.PRIMARYKEY, "200"} 
    };
    ...
    public Ar_custnatstss() throws CodeException {
        this (new Ar_custnatsts(NULLID));
        _isLoaded_ = true;
    }
    
    public Ar_custnatstss(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ar_custnatsts(ID);
        ID_ = ID;
    }
    
    public Ar_custnatstss(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ar_custnatsts(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Ar_custnatstss(Ar_custnatsts parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Ar_custnatstss(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Ar_custnatstss(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void add(Ar_custnatsts obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Ar_custnatstss obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        for (Iterator<Object> it = list.iterator(); it.hasNext(); ) {
            add((Ar_custnatsts) it.next());
        }        
    ...
    public Ar_custnatsts getParent() {
        return parentObj_;
    }
    
    public void setParent(Ar_custnatsts obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public void fromString(String key, String val) throws CodeException {
        for (Iterator<Object> it = iterator(); it.hasNext(); ) {
                Ar_custnatsts obj = (Ar_custnatsts) it.next();
    ...
    public String getDefaultSort() {
        return Ar_custnatstss.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Ar_custnatstss.SQLNAME;
    }
