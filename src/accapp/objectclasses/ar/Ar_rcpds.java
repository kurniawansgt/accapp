 ...
 *    -  Ar_rcpds objs = new Ar_rcpds(0); // All Data
 *    or 
 *    - Ar_rcpds obj = new Ar_rcpds(Ar_rcpd.PROPERTY_<field>, <value>);
 *      Sample :
 *      Ar_rcpds obj = new Ar_rcpds(Ar_rcpd.PROPERTY_ID, "1");
 ...
 * 2. Read Data 
        try {
            ...
            Ar_rcpds brs = new Ar_rcpds(0);

            for (Iterator<Ar_rcpd> it = brs.iterator(); it.hasNext(); ) {
                
                Ar_rcpd br = (Ar_rcpd) it.next();
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAr_rcpd());
       ...
       or
        try {
            ...
            for (int i = 0; i < brs.size(); i++) {
                Ar_rcpd br = (Ar_rcpd) brs.list.get(i);
                System.out.println( "ID " + br.getID());
                System.out.println( "ID " + br.getNamaAr_rcpd());
            }
 ...
 * @author windu
 */
public class Ar_rcpds  implements CodeCollectionInt, NavigatorBrowseDataInt{

    public static final long NULLID = 0;
    public static final String CLASSNAME = "Ar_rcpds";
    public static final String SQLNAME = Ar_rcpd.TABLE;
    public static String DEFAULTSORT = Ar_rcpd.PROPERTY_ID;

    public static String SORTASC = "ASC";
    public static String SORTDESC = "DESC";
    
    public static final String FOREIGNKEY = Ar_rcpd.PROPERTY_ID;
    ...
    private String[][] column = {
        {Ar_rcpd.PRIMARYKEY, Ar_rcpd.PRIMARYKEY, "200"}, 
        {Ar_rcpd.PRIMARYKEY, Ar_rcpd.PRIMARYKEY, "200"} 
    };
    ...
    public Ar_rcpds() throws CodeException {
        this (new Ar_rcpd(NULLID));
        _isLoaded_ = true;
    }
    
    public Ar_rcpds(long ID) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ar_rcpd(ID);
        ID_ = ID;
    }
    
    public Ar_rcpds(String PrimaryKey) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = new Ar_rcpd(PrimaryKey);
        ID_ = parentObj_.getID();
    }
    
    public Ar_rcpds(Ar_rcpd parent) throws CodeException {
        ClassRegister.instance().register(CLASSNAME);
        parentObj_ = parent;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
    ...
    public Ar_rcpds(String key, String val) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    }
    
    public Ar_rcpds(String key, String val, int searchMethod) {
        ClassRegister.instance().register(CLASSNAME);
        key_ = key;
        val_ = val;
    ...
    public void add(Ar_rcpd obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
        list.add(obj);
    ...
    public void add(Ar_rcpds obj) throws CodeException {
        if (!_isLoaded_) {
            dbRead();
        }
    ...
    public Ar_rcpd getParent() {
        return parentObj_;
    }
    
    public void setParent(Ar_rcpd obj) throws CodeException{
        parentObj_ = obj;
        ID_ = parentObj_.getID();
        if (ID_ == NULLID) {
            _isLoaded_ = true;
    ...
    public String getDefaultSort() {
        return Ar_rcpds.DEFAULTSORT;
    }

    public String getSQLNAME(){
        return Ar_rcpds.SQLNAME;
    }
    ...
    public void searchData(double batchno, double docentry) throws CodeException {
        ...
        String query = " select * from ar_rcpd where batchno = " + batchno + "  and docentry = " + docentry;
